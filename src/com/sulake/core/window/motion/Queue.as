package com.sulake.core.window.motion
{
    ...
    public class Queue extends Motion 
    {
        ...
        private var _queue:Vector.<Motion> = new Vector.<Motion>();
        ...
        override friend function tick(_arg_1:int):void
        {
            ...
            {
                _motion.friend::stop();
                _local_2 = _queue.indexOf(_motion);

                if (_local_2 < (_queue.length - 1))
                {
                    _motion = _queue[(_local_2 + 1)];
