package com.sulake.core.window.graphics.renderer
{
    ...
    public class SkinLayout extends ChildEntityArray implements ISkinLayout 
    {
        ...
        {
            var _local_3:SkinLayoutEntity = (getChildByName(name) as SkinLayoutEntity);
            ...
            region.x = _local_3.region.x;
            region.y = _local_3.region.y;
            region.width = _local_3.region.width;
            region.height = _local_3.region.height;
        }
