package com.sulake.core.window.graphics
{
    ...
    public class SkinContainer implements ISkinContainer 
    {
        ...
        {
            _skinRendererTable = new Dictionary();
            _defaultAttrTable = new Dictionary();
            _windowLayoutTable = new Dictionary();
            _intentTable = new Dictionary();
        ...
        {
            _skinRendererTable = null;
            _defaultAttrTable = null;
            _windowLayoutTable = null;
            _intentTable = null;
            _disposed = true;
        }
        ...
        {
            if (_skinRendererTable[_arg_1] == null)
            {
                _skinRendererTable[_arg_1] = new Array(100);
            };

            _skinRendererTable[_arg_1][_arg_2] = _arg_4;

            if (_defaultAttrTable[_arg_1] == null)
            {
                _defaultAttrTable[_arg_1] = new Array(100);
            };

            _defaultAttrTable[_arg_1][_arg_2] = _arg_6;

            if (_windowLayoutTable[_arg_1] == null)
            {
                _windowLayoutTable[_arg_1] = new Array(100);
            };

            _windowLayoutTable[_arg_1][_arg_2] = _arg_5;

            if (_intentTable[_arg_1] == null)
            {
                _intentTable[_arg_1] = new Array(100);
            };

            _intentTable[_arg_1][_arg_2] = (((!(_arg_3 == null)) && (_arg_3.length > 0)) ? _arg_3 : _arg_2.toString());
        }

        public function getSkinRendererByTypeAndStyle(_arg_1:uint, _arg_2:uint):ISkinRenderer
        {
            var _local_3:ISkinRenderer;
            var _local_4:Array = _skinRendererTable[_arg_1];
        ...
        {
            var _local_3:Array = _windowLayoutTable[_arg_1];
        ...
        {
            var _local_3:Array = _intentTable[_arg_1];
