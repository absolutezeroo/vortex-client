package com.sulake.core.window.components
{
    ...
    public class FrameController extends ContainerController implements IFrameWindow 
    {
        ...
        {
            return ((_title) ? _title : _title = ILabelWindow(findChildByTag("_TITLE")));
        }
        ...
        public function get margins():IMargins
        {
            if (!_margins)
            {
                _margins = new TextMargins(content.left, content.top, content.right, content.bottom, marginsCallback);
            };
        ...
        {
            return (((!(content == null)) && (_ready)) ? content.iterator : new ContainerIterator(this));
        }
        ...
        override public function get properties():Array
        {
            ...
            var _local_2:Boolean = (!(_margins == null));
