package com.sulake.core.window.utils
{
    ...
    public class MouseEventProcessor implements IEventProcessor, IDisposable 
    {
        ...
        public function process(state:EventProcessorState, eventQueue:IEventQueue):void
        {
            ...
            _SafeStr_1193 = state.desktop;
            _SafeStr_1194 = (state._SafeStr_643 as WindowController);
            _SafeStr_1195 = (state.lastClickTarget as WindowController);
            _SafeStr_1196 = state.renderer;
            ...
            while (true)
            {
                _local_8 = (eventQueue.next() as MouseEvent);
            ...
            state.desktop = _SafeStr_1193;
            state._SafeStr_643 = _SafeStr_1194;
            state.lastClickTarget = _SafeStr_1195;
            state.renderer = _SafeStr_1196;
