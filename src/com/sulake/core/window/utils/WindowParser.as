package com.sulake.core.window.utils
{
    ...
    public class WindowParser implements IWindowParser
    {
        ...
        public function parseAndConstruct(xml:XML, window:IWindow, variableList:Map):IWindow
        {
            ...
            if (xml.localName() == "layout")
            {
                ...
                if (_local_9.length() > 0)
                {
                    ...
                    if (_local_7.length() > 0)
                    {
                        ...
                        XMLVariableParser.parseVariableList(_local_7, variableList);
                    };
                };

                _local_4 = xml.child("filters").children();
                ...
                if (_local_4.length() > 0)
                {
                    ...
                    window.filters = _local_11;
                };

                _local_12 = xml.child("window");
                ...
                switch (_local_6)
                {
                    ...
                    default:
                        ...
                        {
                            _local_13 = parseSingleWindowEntity(_local_12[_local_8], WindowController(window), variableList);
                            _local_8++;
                        };
            ...
            return ((xml != null) ? parseSingleWindowEntity(xml, WindowController(window), variableList) : null);
        }
        ...
        private function parseSingleWindowEntity(xml:XML, window:WindowController, variableList:Map):IWindow
        {
            ...
            var _local_28:uint = ((window != null) ? window.style : 0);
            var _local_25:String = "";
            var _local_20:uint;
            var _local_13:String = "";
            var _local_14:int;
            _local_9 = _SafeStr_1206[xml.localName()];
            _local_27 = unescape(String(parseAttribute(xml, "name", variableList, "")));
            _local_28 = uint(parseAttribute(xml, "style", variableList, _local_28));
            _local_25 = String(parseAttribute(xml, "dynamic_style", variableList, ""));
            _local_20 = uint(parseAttribute(xml, "params", variableList, _local_20));
            _local_13 = unescape(String(parseAttribute(xml, "tags", variableList, _local_13)));
            _local_10 = new Rectangle();
            _local_10.x = Number(parseAttribute(xml, "x", variableList, "0"));
            _local_10.y = Number(parseAttribute(xml, "y", variableList, "0"));
            _local_10.width = Number(parseAttribute(xml, "width", variableList, "0"));
            _local_10.height = Number(parseAttribute(xml, "height", variableList, "0"));
            _local_16 = (parseAttribute(xml, "visible", variableList, _local_16.toString()) == "true");
            _local_14 = int(parseAttribute(xml, "id", variableList, _local_14.toString()));

            if (xml.child("params").length() > 0)
            {
                _local_21 = xml.child("params").children();
                ...
                while (_local_18 < _local_17)
                {
                    ...
                    _local_12 = (parseAttribute(_local_24, "name", variableList, "") as String);
            ...
            _local_7 = ((_local_20 & 0x80000000) ? ((window) ? window.caption : "") : "");
            _local_7 = unescape(String(parseAttribute(xml, "caption", variableList, _local_7)));
            ...
            _local_29 = (_context.create(_local_27, null, _local_9, _local_28, _local_20, _local_10, null, ((window is IIterable) ? null : window), _local_14, parseProperties(xml.child("variables")[0]), _local_25, _local_22) as WindowController);

            if (hasAttribute(xml, "width_min"))
            {
                _local_29.limits.minWidth = int(parseAttribute(xml, "width_min", variableList, _local_29.limits.minWidth));
            };

            if (hasAttribute(xml, "width_max"))
            {
                _local_29.limits.maxWidth = int(parseAttribute(xml, "width_max", variableList, _local_29.limits.maxWidth));
            };

            if (hasAttribute(xml, "height_min"))
            {
                _local_29.limits.minHeight = int(parseAttribute(xml, "height_min", variableList, _local_29.limits.minHeight));
            };

            if (hasAttribute(xml, "height_max"))
            {
                _local_29.limits.maxHeight = int(parseAttribute(xml, "height_max", variableList, _local_29.limits.maxHeight));
            };

            _local_29.limits.limit();
            _local_26 = (parseAttribute(xml, "background", variableList, _local_29.background.toString()) == "true");
            _local_6 = Number(parseAttribute(xml, "blend", variableList, _local_29.blend.toString()));
            _local_4 = (parseAttribute(xml, "clipping", variableList, _local_29.clipping.toString()) == "true");
            _local_5 = String(parseAttribute(xml, "color", variableList, _local_29.color.toString()));
            _local_8 = uint(parseAttribute(xml, "treshold", variableList, _local_29.mouseThreshold.toString()));
            ...
            _local_21 = xml.child("filters").children();
            _local_17 = _local_21.length();
            ...
            if (_local_29 != null)
            {
                if (window != null)
                {
                    if ((window is IIterable))
                    {
                        ...
                        try
                        {
                            _local_11 = IIterable(window).iterator;
                        }
                        ...
                        {
                            window.addChild(_local_29);
                        };
                    };
                };
            };

            _local_21 = xml.child("children");
            ...
            if (_local_21.length() > 0)
            {
                ...
                while (_local_18 < _local_17)
                {
                    parseAndConstruct(_local_21[_local_18], _local_29, variableList);
                    _local_18++;
                };
            };
