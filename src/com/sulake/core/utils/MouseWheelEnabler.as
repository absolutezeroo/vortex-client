package com.sulake.core.utils
{
    ...
    public class MouseWheelEnabler
    {
        ...
        private static function registerListenerForMouseMove(stage:Stage):void
        {
            ...
            stage.addEventListener("mouseMove", function (stage:MouseEvent):void
            {
                currentItem = InteractiveObject(stage.target);
                browserMouseEvent = MouseEvent(stage);
            });
        }
        ...
        public static function handleExternalMouseEvent(rawValues:Number, parsedValues:Number):void
        {
            var _local_4:Number;
