package com.sulake.core.assets.loaders
{
    ...
    public class BitmapFileLoader extends _SafeStr_16 implements IAssetLoader
    {
        ...
        public function BitmapFileLoader(type:String, urlRequest:URLRequest=null, cacheKey:String=null, cacheRevision:String=null, buffer:ByteArray=null, id:int=-1)
        {
            ...
            else
            {
                ...
                {
                    _SafeStr_779.load(urlRequest, _SafeStr_781);
                };
            };
        }
