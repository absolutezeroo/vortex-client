package com.sulake.core.assets
{
    ...
    public class BitmapDataAsset implements ILazyAsset 
    {
        ...
        public function setUnknownContent(unknownContent:Object):void
        {
            ...
            if (_bitmap)
            {
                if (_bitmap == (unknownContent as BitmapData))
                {
                    return;
                };
        ...
        {
            var _local_2:Loader = (event.currentTarget.loader as Loader);
        ...
        public function setFromOtherAsset(asset:IAsset):void
        {
            ...
            {
                _bitmap = BitmapDataAsset(asset)._bitmap;
                _offset = BitmapDataAsset(asset)._offset;
            }
        ...
        public function setParamsDesc(xml:XMLList):void
        {
            ...
            for each (var _local_2:XML in xml)
            {
