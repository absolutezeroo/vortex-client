package com.sulake.core.runtime
{
    ...
    internal class Profiler extends Component implements IProfiler 
    {
        ...
        private var _profilersByReceiver:Dictionary = new Dictionary(true);
        ...
        override public function dispose():void
        {
            ...
            if (!disposed)
            {
                for (_local_1 in _profilersByReceiver)
                {
                    IDisposable(_profilersByReceiver[_local_1]).dispose();
                    delete _profilersByReceiver[_local_1];
                };
        ...
        public function get numProfilerAgents():uint
        {
            ...
            for (var _local_2:Object in _profilersByReceiver)
            {
        ...
        public function getProfilerAgentsInArray():Array
        {
            ...
            for (var _local_3:Object in _profilersByReceiver)
            {
                _local_2 = (_local_3 as IUpdateReceiver);

                if (IDisposable(_local_3).disposed)
                {
                    IDisposable(_profilersByReceiver[_local_3]).dispose();
                    delete _profilersByReceiver[_local_3];
                }

                else
                {
                    _local_1.push(_profilersByReceiver[_local_3]);
                };
            };
        ...
        {
            var _local_2:ProfilerAgent = _profilersByReceiver[_arg_1];
