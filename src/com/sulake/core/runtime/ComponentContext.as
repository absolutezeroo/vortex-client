package com.sulake.core.runtime
{
        ...
        public class ComponentContext extends Component implements IContext 
    {
        ...
        final public function prepareComponent(resource:Class, flags:uint=0, domain:ApplicationDomain=null):IUnknown
        {
            ...
            try
            {
                _local_16 = (resource as Object).manifest;
            ...
            while (_local_14 < _local_12.length())
            {
                ...
                if (_local_17.length() > 0)
                {
                    ...
                    _local_24.loadFromResource(_local_20, resource);
                };

                _local_8 = (domain.getDefinition(_local_4) as Class);
                ...
                _local_21 = ((_local_24 == null) ? new _local_8(this, flags) : new _local_8(this, flags, _local_24));
                ...
                if (_local_21 != null)
                {
                    ...
                    while (_local_15 < _local_13.length())
                    {
                        ...
                        _local_9 = (domain.getDefinition(_local_7) as Class);
        ...
        final protected function announceInterfaceAvailability(iid:IID, component:Component):void
        {
            ...
            var _local_4:uint;
            var _local_5:ComponentInterfaceQueue = getQueueForInterface(iid);
            ...
            while (_local_4 < _local_3)
            {
                _local_6 = component.queueInterface(iid);
                ...
                {
                    (_local_5.receivers.pop()(iid, _local_6));
                };
        ...
        private function unlockEventHandler(event:LockEvent):void
        {
            var _local_2:InterfaceStruct;
            var _local_4:Array;
            var _local_3:Component = (event.unknown as Component);
        ...
        override public function toXMLString(tabCount:uint=0):String
        {
            ...
            while (_local_11 < _SafeStr_843.length)
            {
                ...
                if (_local_4 != this)
                {
                    _local_2 = (_local_2 + _local_4.toXMLString((tabCount + 1)));
                };
