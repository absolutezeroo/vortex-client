package com.sulake.habbo.friendbar.landingview.widget
{
    ...
    public class UserListWidget implements ILandingViewWidget 
    {
        ...
        private var _avatarOffsetsY:Array = [0, 10, 5, 0, 5, 10, 0, 10, 5, 10];
        private var _avatarContainerWidths:Array = [];
        private var _avatarDirections:Array = [2, 4, 2, 2, 4, 2, 2, 2, 4, 2];
        ...
        private function createAvatarContainer(_arg_1:int):IWindowContainer
        {
            ...
            if (_avatarContainerWidths.length > _arg_1)
            {
                _local_3.width = _avatarContainerWidths[_arg_1];
            };
        ...
        private function setupVariation(_arg_1:IWindowContainer, _arg_2:int):void
        {
            ...
            _arg_1.y = (_arg_1.y + (_avatarOffsetsY[_arg_2] + 70));

            if (_avatarOffsetsY[_arg_2] < 0)
            {
                _arg_1.height = (_arg_1.height + -(_avatarOffsetsY[_arg_2]));
            };

            _local_4.direction = _avatarDirections[_arg_2];
            _arg_1.findChildByName("extra_link_region").y = (_arg_1.findChildByName("extra_link_region").y - _avatarOffsetsY[_arg_2]);
        }
