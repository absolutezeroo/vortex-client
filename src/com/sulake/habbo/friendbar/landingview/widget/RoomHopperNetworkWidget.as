package com.sulake.habbo.friendbar.landingview.widget
{
    ...
    public class RoomHopperNetworkWidget implements ILandingViewWidget, ISettingsAwareWidget 
    {
        ...
        {
            _landingView = _arg_1;
            _textElements.push("title");
            _textElements.push("header");
            _textElements.push("info");
        }
        ...
        public function initialize():void
        {
            ...
            _targetNetworkId = _landingView.getInteger("landing.view.roomhopper.network.id", 0);
        ...
        private function onRoomForwardButton(_arg_1:WindowEvent, _arg_2:IWindow):void
        {
            ...
            {
                _landingView.navigator.goToRoomNetwork(_targetNetworkId, false);
            };
        }
