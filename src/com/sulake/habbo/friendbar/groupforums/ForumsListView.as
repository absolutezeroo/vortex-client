package com.sulake.habbo.friendbar.groupforums
{
    ...
    public class ForumsListView 
    {
        ...
        {
            _mainView = _arg_1;
            _controller = _mainView.controller;
            _list = _arg_2;
            _listItem = (_controller.windowManager.buildFromXML(XML(new HabboFriendBarCom.groupforum_forum_list_item_xml())) as IWindowContainer);
            _forums = _arg_3;
        }
        ...
        public function update():void
        {
            ...
            while (_local_3 < _forums.length)
            {
                ...
                _local_2 = (_listItem.clone() as IWindowContainer);
        ...
        private function updateListItem(_arg_1:IWindowContainer, _arg_2:ForumData, _arg_3:int):void
        {
            ...
            _local_9.caption = _controller.localizationManager.getLocalizationWithParams("groupforum.view.forum_details", "", "rating", _arg_2.leaderboardScore, "last_author_id", _arg_2.lastMessageAuthorId, "last_author_name", _arg_2.lastMessageAuthorName, "update_time", _mainView.getAsDaysHoursMinutes(_arg_2.lastMessageTimeAsSecondsAgo));
            ...
            _local_8.bold = (_local_6 > 0);
            _local_8.text = _controller.localizationManager.getLocalizationWithParams("groupforum.view.thread_details1", "", "total_messages", _arg_2.totalMessages, "new_messages", _local_6);
            _local_8 = (_local_5.findChildByName("messages2") as ITextWindow);
            _local_8.bold = (_local_6 > 0);
            _local_8.text = _controller.localizationManager.getLocalizationWithParams("groupforum.view.thread_details2", "", "total_messages", _arg_2.totalMessages, "new_messages", _local_6);
        ...
        public function updateItemWidths():void
        {
            ...
            while (_local_1 < _list.numListItems)
            {
                _list.getListItemAt(_local_1).width = (_list.scrollableWindow.width - 2);
                _local_1++;
            };
        }
        ...
        {
            _controller.openGroupForum(_arg_1.target.id);
        }
