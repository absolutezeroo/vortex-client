package com.sulake.habbo.friendbar.talent
{
    ...
    public class TalentPromoCtrl implements IDisposable 
    {
        ...
        public function dispose():void
        {
            ...
            {
                _manager.toolbar.extensionView.detachExtension("talent_promo");
            };
        ...
        public function initialize():void
        {
            ...
            _manager.communicationManager.addHabboConnectionMessageEvent(new TalentLevelUpMessageEvent(onTalentLevelUp));
            _manager.communicationManager.addHabboConnectionMessageEvent(new TalentTrackLevelMessageEvent(onTalentTrackLevel));
            _manager.communicationManager.addHabboConnectionMessageEvent(new UserObjectEvent(onUserObject));
        }

        private function onUserObject(_arg_1:UserObjectEvent):void
        {
            _manager.send(new GetTalentTrackLevelMessageComposer(promotedTalentTrack));
        }
        ...
        private function onTalentTrackLevel(_arg_1:TalentTrackLevelMessageEvent):void
        {
            ...
            {
                _maxLevel = _local_2.maxLevel;
                _level = _local_2.level;
                refresh();
            };
        }
        ...
        private function refresh():void
        {
            ...
            if (toolbarAttachAllowed())
            {
                _manager.toolbar.extensionView.attachExtension("talent_promo", _window, 7);
            };
        }
        ...
        private function prepareWindow():void
        {
            ...
            _window = IWindowContainer(_manager.getXmlWindow("track_promo"));
        ...
        private function onCheckProgress(_arg_1:WindowEvent, _arg_2:IWindow=null):void
        {
            ...
            {
                _manager.tracking.trackTalentTrackOpen(promotedTalentTrack, "talentpromo");
                _manager.send(new GetTalentTrackMessageComposer(promotedTalentTrack));
            };
        }

        private function toolbarAttachAllowed():Boolean
        {
            return ((((!(_manager == null)) && (!(_manager.toolbar == null))) && (!(_manager.toolbar.extensionView == null))) && (enabled));
        }
        ...
        {
            return (_manager.getProperty("talentpromo.track"));
        }
