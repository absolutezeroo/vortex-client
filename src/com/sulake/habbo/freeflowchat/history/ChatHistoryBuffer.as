package com.sulake.habbo.freeflowchat.history
{
    ...
    public class ChatHistoryBuffer implements IDisposable 
    {
        ...
        public function insertChat(_arg_1:ChatItem):void
        {
            ...
            try
            {
                _local_2 = _component.chatBubbleFactory.getHistoryLineEntry(_arg_1);
            }
            ...
            if (_component.chatHistoryScrollView.isActive)
            {
                _component.chatHistoryScrollView.addHistoryEntry(_entries[(_entries.length - 1)]);
            };
        }

        public function insertRoomChange(_arg_1:GuestRoomData):void
        {
            var _local_2:IChatHistoryEntryBitmap = _component.chatBubbleFactory.getHistoryRoomChangeEntry(_arg_1);
            _entries.push(_local_2);
            checkBufferOverflowAndSpliceTop(_local_2);
        }
        ...
        private function checkBufferOverflowAndSpliceTop(_arg_1:IChatHistoryEntryBitmap):void
        {
            ...
            {
                _component.chatHistoryScrollView.scrollUpAndSpliceTopItem(((_arg_1.bitmap.height - _arg_1.overlap.y) - 8));
                _entries.splice(0, 1);
            };
        }
