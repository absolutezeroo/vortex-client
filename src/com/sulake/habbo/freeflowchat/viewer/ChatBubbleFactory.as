package com.sulake.habbo.freeflowchat.viewer
{
    ...
    public class ChatBubbleFactory implements IGetImageListener, IAvatarImageListener 
    {
        ...
        private var _chatBubblePool:Vector.<PooledChatBubble> = new Vector.<PooledChatBubble>(0);
        private var _accountId:int;

        public function ChatBubbleFactory(_arg_1:HabboFreeFlowChat)
        {
            _component = _arg_1;
            _chatStyleLibrary = new ChatStyleLibrary(_component.assets);
            _accountId = _component.sessionDataManager.userId;
        }

        public function dispose():void
        {
            discardOldBitmaps();
            _imagesWaitingForDispose = [];
        ...
        public function getNewChatBubble(_arg_1:ChatItem, _arg_2:Boolean=false):PooledChatBubble
        {
            ...
            var _local_4:IUserData = _component.roomSessionManager.getSession(_arg_1.roomId).userDataManager.getUserDataByIndex(_arg_1.userId);
            ...
            else
            {
                if (_local_4 != null)
                {
                    ...
                    if (!_local_5)
                    {
                        ...
                        {
                            case 2:
                                _local_16 = _component.roomEngine.getRoomObject(_arg_1.roomId, _local_4.roomObjectId, 100);
                                _local_6 = null;
            ...
            {
                _arg_1.text = ((_component.localizations) ? _component.localizations.getLocalizationWithParams("widgets.chatbubble.respect", "", "username", _local_12) : "");
            }
            ...
            else
            {
                ...
                {
                    _arg_1.text = ((_component.localizations) ? _component.localizations.getLocalizationWithParams("widget.chatbubble.petrespect", "", "petname", _local_12) : "");
                }
                ...
                else
                {
                    ...
                    {
                        _arg_1.text = ((_component.localizations) ? _component.localizations.getLocalizationWithParams("widget.chatbubble.pettreat", "", "petname", _local_12) : "");
                    };
                };
            };
            ...
            if (_arg_1.chatType == 5)
            {
                ...
                _local_13 = _component.localizations.getLocalization(("handitem" + _arg_1.extraParam), ("handitem" + _arg_1.extraParam));
                _component.localizations.registerParameter(_local_10, "username", _local_12);
                _component.localizations.registerParameter(_local_10, "handitem", _local_13);
                _arg_1.text = _component.localizations.getLocalizationRaw(_local_10).value;
            };
            ...
            if (_arg_1.chatType == 10)
            {
                ...
                _component.localizations.registerParameter(_local_8, "hours", _local_3);
                _component.localizations.registerParameter(_local_8, "minutes", _local_7);
                _component.localizations.registerParameter(_local_8, "seconds", _local_15);
            ...
            {
                _local_17 = new PooledChatBubble(_component);
            };
            ...
            _local_17.recreate(_local_12, ((_arg_1.forcedColor) ? _arg_1.forcedColor : _local_18), _component.roomChatBorderLimited);
        ...
        public function getNewEmptySpace(_arg_1:int):PooledChatBubble
        {
            ...
            if (_chatBubblePool.length > 0)
            {
                _local_4 = _chatBubblePool.pop();
            }

            else
            {
                _local_4 = new PooledChatBubble(_component);
            };
        ...
        public function getHistoryLineEntry(_arg_1:ChatItem):IChatHistoryEntryBitmap
        {
            ...
            var _local_2:String;
            var _local_19:ChatStyle = ChatStyle(_chatStyleLibrary.getStyle(_arg_1.style));
            var _local_3:IUserData = _component.roomSessionManager.getSession(_arg_1.roomId).userDataManager.getUserDataByIndex(_arg_1.userId);
            var _local_12:String = "";
            var _local_18:uint;
            var _local_4:BitmapData = _local_19.iconImage;
            var _local_5:Boolean = (!((_local_3 == null) || (_local_3.webID == _accountId)));
            ...
            else
            {
                if (_local_3 != null)
                {
                    ...
                    if (!_local_4)
                    {
                        ...
                        {
                            case 2:
                                _local_15 = _component.roomEngine.getRoomObject(_arg_1.roomId, _local_3.roomObjectId, 100);
                                _local_6 = null;
            ...
            {
                _local_10 = "widget.chatbubble.handitem";
                _local_13 = _component.localizations.getLocalizationWithParams(("handitem" + _arg_1.extraParam), ("handitem" + _arg_1.extraParam));
                _arg_1.text = _component.localizations.getLocalizationWithParams(_local_10, "", "username", _local_12, "handitem", _local_13);
                _local_5 = false;
            };
            ...
            if (_arg_1.chatType == 10)
            {
                ...
                _component.localizations.registerParameter(_local_8, "hours", _local_2);
                _component.localizations.registerParameter(_local_8, "minutes", _local_7);
            ...
            var _local_16:ChatBubble = new ChatBubble(_arg_1, _local_19, _local_4, _local_12, ((_arg_1.forcedColor) ? _arg_1.forcedColor : _local_18), _component, 1);
        ...
        {
            return (new ChatHistoryRoomChangeEntry(_arg_1, _component));
        }

        public function recycle(_arg_1:PooledChatBubble):void
        {
            _chatBubblePool.push(_arg_1);
        }
        ...
        public function getUserImage(_arg_1:String):BitmapData
        {
            ...
            var _local_3:Boolean = _component.getBoolean("zoom.enabled");
            var _local_2:BitmapData = (_avatarImageCache.getValue(_arg_1) as BitmapData);

            if (_local_2 == null)
            {
                _local_5 = _component.avatarRenderManager.createAvatarImage(_arg_1, ((_local_3) ? "h" : "sh"), null, this);
        ...
        private function getPetImage(_arg_1:String, _arg_2:int, _arg_3:Boolean, _arg_4:int=64, _arg_5:String=null):BitmapData
        {
            ...
            if (_local_10 == null)
            {
                ...
                _local_9 = _component.roomEngine.getPetImage(_local_8, _local_6.paletteId, _local_6.color, new Vector3d((_arg_2 * 45)), _arg_4, this, _local_11, _local_7, _local_6.customParts, _arg_5);
        ...
        private function petImageReady(_arg_1:String):void
        {
            ...
            if (_petImageCache)
            {
                ...
                if (_local_2 != null)
                {
                    _imagesWaitingForDispose.push(_local_2);
                };
            };

            if (_imagesWaitingForDispose.length > 30)
            {
                discardOldBitmaps();
            };
        }
        ...
        {
            for each (var _local_1:BitmapData in _imagesWaitingForDispose)
            {
                if (_local_1 != null)
                {
                    _local_1.dispose();
