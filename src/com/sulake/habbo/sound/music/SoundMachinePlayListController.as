package com.sulake.habbo.sound.music
{
    ...
    public class SoundMachinePlayListController implements IPlayListController 
    {
        ...
        public function SoundMachinePlayListController(_arg_1:HabboSoundManagerFlash10, _arg_2:HabboMusicController, _arg_3:IEventDispatcher, _arg_4:IEventDispatcher, _arg_5:IConnection)
        {
            ...
            _events.addEventListener("SIR_TRAX_SONG_INFO_RECEIVED", onSongInfoReceivedEvent);
        ...
        public function checkSongPlayState(_arg_1:int):void
        {
            ...
            if (_nowPlayingSongId == _arg_1)
            {
                ...
                if (_local_2 != null)
                {
                    _musicController.addSongInfoRequest(_local_2.id);
                };
            };
        }
        ...
        private function onSongInfoReceivedEvent(_arg_1:SongInfoReceivedEvent):void
        {
            ...
            while (_local_4 < _playListEntries.length)
            {
                _local_2 = _playListEntries[_local_4];
                ...
                if (_local_2.id == _arg_1.id)
                {
                    ...
                    if (_local_3 != null)
                    {
                        _playListEntries[_local_4] = _local_3;
                    };
        ...
        private function playCurrentSongAndNotify(_arg_1:int):void
        {
            ...
            if (_musicController.playSong(_arg_1, 0, _local_3, 0, 0, 0))
            {
        ...
        private function getNextEntry():SongDataEntry
        {
            ...
            while (_local_2 < _playListEntries.length)
            {
                _local_1 = _playListEntries[_local_2];
            ...
            if (_local_3 >= _playListEntries.length)
            {
                _local_3 = 0;
            };

            return (_playListEntries[_local_3]);
        }

        public function getEntry(_arg_1:int):ISongInfo
        {
            if ((((_playListEntries == null) || (_arg_1 < 0)) || (_arg_1 >= _playListEntries.length)))
            {
                return (null);
            };

            return (_playListEntries[_arg_1]);
        }
        ...
        public function getEntryWithId(_arg_1:int):ISongInfo
        {
            ...
            while (_local_3 < _playListEntries.length)
            {
                _local_2 = _playListEntries[_local_3];
        ...
        private function onPlayListMessage(_arg_1:IMessageEvent):void
        {
            ...
            {
                _local_2 = _playListEntries[_local_7];
        ...
        private function onPlayListSongAddedMessage(_arg_1:IMessageEvent):void
        {
            ...
            _playListEntries.push(_local_2);
            _events.dispatchEvent(new PlayListStatusEvent("PLUE_PLAY_LIST_UPDATED"));
