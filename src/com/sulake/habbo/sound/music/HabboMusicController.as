package com.sulake.habbo.sound.music
{
    ...
    public class HabboMusicController implements IHabboMusicController, IDisposable 
    {
        ...
        private var _availableSongs:Map = new Map();
        private var _requestedSongs:Map = new Map();
        ...
        private var _songDiskInventory:Map = new Map();
        ...
        public function HabboMusicController(_arg_1:HabboSoundManagerFlash10, _arg_2:IEventDispatcher, _arg_3:IEventDispatcher, _arg_4:IConnection)
        {
            ...
            _songRequestTimer = new Timer(1000);
            _songRequestTimer.start();
            _songRequestTimer.addEventListener("timer", sendNextSongRequestMessage);
            _events.addEventListener("SCE_TRAX_SONG_COMPLETE", onSongFinishedPlayingEvent);
            _local_5 = 0;

            while (_local_5 < 4)
            {
                _songRequestsPerPriority[_local_5] = null;
                _songRequestCountsPerPriority[_local_5] = 0;
                _local_5++;
            };
        }
        ...
        protected function onSongFinishedPlayingEvent(_arg_1:SoundCompleteEvent):void
        {
            ...
            if (getSongIdPlayingAtPriority(_priorityPlaying) == _arg_1.id)
            {
                if (((getTopRequestPriority() == _priorityPlaying) && (getSongRequestCountAtPriority(_priorityPlaying) == _requestNumberPlaying)))
                {
                    resetSongStartRequest(_priorityPlaying);
                };

                _local_2 = _priorityPlaying;
        ...
        public function dispose():void
        {
            ...
            if (!_disposed)
            {
                ...
                if (_availableSongs)
                {
                    ...
                    while (_local_3 < _availableSongs.length)
                    {
                        _local_1 = (_availableSongs.getWithIndex(_local_3) as SongDataEntry);
                    ...
                    _availableSongs.dispose();
                    _availableSongs = null;
                };

                if (_requestedSongs != null)
                {
                    _requestedSongs.dispose();
                    _requestedSongs = null;
                };

                _songRequestTimer.stop();
                _songRequestTimer = null;
                ...
                if (_songDiskInventory != null)
                {
                    _songDiskInventory.dispose();
                    _songDiskInventory = null;
                };
        ...
        private function addSongStartRequest(_arg_1:int, _arg_2:int, _arg_3:Number, _arg_4:Number, _arg_5:Number, _arg_6:Number):Boolean
        {
            ...
            _songRequestsPerPriority[_arg_1] = _local_7;

            var _local_8:int = _arg_1;
            var _local_9:int = (_songRequestCountsPerPriority[_local_8] + 1);
            _songRequestCountsPerPriority[_local_8] = _local_9;
            return (true);
        }

        private function getSongStartRequest(_arg_1:int):SongStartRequestData
        {
            return (_songRequestsPerPriority[_arg_1]);
        }
        ...
        private function getSongIdRequestedAtPriority(_arg_1:int):int
        {
            ...
            if (_songRequestsPerPriority[_arg_1] == null)
            {
                return (-1);
            };

            var _local_2:SongStartRequestData = _songRequestsPerPriority[_arg_1];
        ...
        private function getSongRequestCountAtPriority(_arg_1:int):int
        {
            ...
            return (_songRequestCountsPerPriority[_arg_1]);
        }

        private function getTopRequestPriority():int
        {
            var _local_1:int;
            _local_1 = (_songRequestsPerPriority.length - 1);

            while (_local_1 >= 0)
            {
                if (_songRequestsPerPriority[_local_1] != null)
                {
                    return (_local_1);
                };
        ...
        private function resetSongStartRequest(_arg_1:int):void
        {
            if (((_arg_1 >= 0) && (_arg_1 < 4)))
            {
                _songRequestsPerPriority[_arg_1] = null;
            };
        }
        ...
        private function reRequestSongAtPriority(_arg_1:int):void
        {
            ...
            var _local_3:Number = (_songRequestCountsPerPriority[_local_2] + 1);
            _songRequestCountsPerPriority[_local_2] = _local_3;
        }
        ...
        {
            var _local_2:Boolean = (_arg_1 == _priorityPlaying);
            ...
            else
            {
                ...
                if (_local_3)
                {
                    reRequestSongAtPriority(_priorityPlaying);
                };
            };
        }
        ...
        private function stopSongAtPriority(_arg_1:int):Boolean
        {
            ...
            if (((_arg_1 == _priorityPlaying) && (_priorityPlaying >= 0)))
            {
        ...
        private function getSongDataEntry(_arg_1:int):SongDataEntry
        {
            ...
            {
                _local_2 = (_availableSongs.getValue(_arg_1) as SongDataEntry);
            };
        ...
        {
            if (_requestedSongs.getValue(_arg_1) == null)
            {
                _requestedSongs.add(_arg_1, _arg_2);
                _songRequestList.push(_arg_1);
            };
        }
        ...
        {
            return (_songDiskInventory.length);
        }

        public function getSongDiskInventoryDiskId(_arg_1:int):int
        {
            if (((_arg_1 >= 0) && (_arg_1 < _songDiskInventory.length)))
            {
                return (_songDiskInventory.getKey(_arg_1));
            };
        ...
        public function getSongDiskInventorySongId(_arg_1:int):int
        {
            if (((_arg_1 >= 0) && (_arg_1 < _songDiskInventory.length)))
            {
                return (_songDiskInventory.getWithIndex(_arg_1));
            };
        ...
        {
            if (_arg_1 != _priorityPlaying)
            {
                return (-1);
            };

            return (_songIdPlaying);
        }
        ...
        public function samplesUnloaded(_arg_1:Array):void
        {
            ...
            while (_local_5 < _availableSongs.length)
            {
                _local_3 = (_availableSongs.getWithIndex(_local_5) as SongDataEntry);
                _local_4 = (_local_3.soundObject as TraxSequencer);

                if ((((!(_local_3.id == _songIdPlaying)) && (!(_local_4 == null))) && (_local_4.ready)))
                {
        ...
        public function get samplesIdsInUse():Array
        {
            ...
            while (_local_5 < _songRequestsPerPriority.length)
            {
                if (_songRequestsPerPriority[_local_5] != null)
                {
                    _local_3 = _songRequestsPerPriority[_local_5];
                    _local_2 = _availableSongs.getValue(_local_3.songId);
        ...
        private function sendNextSongRequestMessage(_arg_1:TimerEvent):void
        {
            ...
            _connection.send(new GetSongInfoMessageComposer(_songRequestList));
            Logger.log(("Requested song info's : " + _songRequestList));
            _songRequestList = [];
        }
        ...
        private function onSongInfoMessage(_arg_1:IMessageEvent):void
        {
            ...
            while (_local_8 < _local_7.length)
            {
                ...
                if (_local_10)
                {
                    ...
                    _availableSongs.add(_local_9.id, _local_12);
                    ...
                    while (_diskInventoryMissingData.indexOf(_local_9.id) != -1)
                    {
                        _diskInventoryMissingData.splice(_diskInventoryMissingData.indexOf(_local_9.id), 1);

                        if (_diskInventoryMissingData.length == 0)
                        {
        ...
        private function playSongObject(_arg_1:int, _arg_2:int):Boolean
        {
            ...
            if (stopSongAtPriority(_priorityPlaying))
            {
                _local_6 = true;
            };
            ...
            _priorityPlaying = _arg_1;
            _requestNumberPlaying = getSongRequestCountAtPriority(_arg_1);
            _songIdPlaying = _arg_2;

            if (_priorityPlaying <= 0)
            {
        ...
        private function notifySongPlaying(_arg_1:SongDataEntry):void
        {
            ...
            if (((_arg_1.length >= _local_2) && ((!(_previousNotifiedSongId == _arg_1.id)) || (_local_3 > (_previousNotificationTime + _local_2)))))
            {
                _soundManager.notifyPlayedSong(_arg_1.name, _arg_1.creator);
                _previousNotifiedSongId = _arg_1.id;
        ...
        private function areSamplesRequested(_arg_1:int):Boolean
        {
            ...
            return (_requestedSongs.getValue(_arg_1));
        }
        ...
        private function onSongDiskInventoryMessage(_arg_1:IMessageEvent):void
        {
            ...
            while (_local_4 < _local_2.songDiskCount)
            {
                ...
                _songDiskInventory.add(_local_5, _local_6);

                if (_availableSongs.getValue(_local_6) == null)
                {
                    _diskInventoryMissingData.push(_local_6);
        ...
        {
            disposeRoomPlaylist();
            _roomItemPlaylist = (new SoundMachinePlayListController(_soundManager, this, _events, _roomEvents, _connection) as IPlayListController);
        }
        ...
        {
            disposeRoomPlaylist();
            _roomItemPlaylist = (new JukeboxPlayListController(_soundManager, this, _events, _connection) as IPlayListController);
