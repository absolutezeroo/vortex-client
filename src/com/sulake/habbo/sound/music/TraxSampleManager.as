package com.sulake.habbo.sound.music
{
    ...
    public class TraxSampleManager implements IDisposable 
    {
        ...
        private var _byteBuffer:ByteArray = new ByteArray();
        ...
        public function loadSample(_arg_1:int):void
        {
            ...
            _loadingSamples.add(_local_3, _arg_1);
        }
        ...
        private function processLoadedSample(_arg_1:Sound):void
        {
            ...
            if (_loadingSamples.getValue(_arg_1) != null)
            {
                _local_3 = _loadingSamples.remove(_arg_1);

                if (_traxSamples.getValue(_local_3) == null)
                {
                    _byteBuffer.clear();
                    _local_4 = _arg_1.length;
                    _arg_1.extract(_byteBuffer, (_local_4 * 44.1));
                    _local_2 = new TraxSample(_byteBuffer, _local_3, "sample_44khz", "sample_16bit");
        ...
        private function processLoadedSamples():void
        {
            ...
            if (_loadedSamples.length > 0)
            {
                ...
                while ((((_local_1 - _local_3) < 60) && (_loadedSamples.length > 0)))
                {
                    _local_2 = _loadedSamples.splice(0, 1)[0];
