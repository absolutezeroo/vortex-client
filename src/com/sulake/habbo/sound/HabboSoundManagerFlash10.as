package com.sulake.habbo.sound
{
    ...
    public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager, IUpdateReceiver 
    {
        ...
        private var _loadingSongQueue:Map = new Map();
        ...
        override public function dispose():void
        {
            ...
            if (_traxSampleManager)
            {
                _traxSampleManager.dispose();
                _traxSampleManager = null;
            };
        ...
        {
            var _local_4:Sound;
            var _local_3:IHabboSound = _genericSamples.getValue(_arg_1);
            ...
            if (_local_3 == null)
            {
                ...
                if (_local_4 != null)
                {
                    ...
                    _genericSamples.add(_arg_1, IHabboSound(_local_3));
                };
            };
        ...
        {
            var _local_2:IHabboSound = _genericSamples.getValue(_arg_1);
        ...
        private function addTraxSongForDownload(_arg_1:int, _arg_2:String):IHabboSound
        {
            ...
            if (!_local_3.ready)
            {
                _loadingSongQueue.add(_arg_1, _local_3);
            };
        ...
        private function createTraxInstance(_arg_1:int, _arg_2:String, _arg_3:Boolean=true):TraxSequencer
        {
            ...
            var _local_4:TraxSequencer = new TraxSequencer(_arg_1, _local_5, _traxSampleManager.traxSamples, events);
        ...
        private function validateSampleAvailability(_arg_1:TraxSequencer, _arg_2:Boolean):void
        {
            ...
            {
                if (_traxSampleManager.traxSamples.getValue(_local_5[_local_4]) == null)
                {
                    if (_arg_2)
                    {
                        _traxSampleManager.loadSample(_local_5[_local_4]);
                    };
        ...
        private function init():void
        {
            ...
            _traxSampleManager = new TraxSampleManager(this, onSampleLoadError);
        ...
        private function loadNextSong():void
        {
            ...
            if (((_loadingSong == null) && (_loadingSongQueue.length > 0)))
            {
                _local_2 = _loadingSongQueue.getKey(0);
                _local_1 = _loadingSongQueue.remove(_local_2);
        ...
        {
            if (_traxSampleManager != null)
            {
                _traxSampleManager.update(_arg_1);
            };
