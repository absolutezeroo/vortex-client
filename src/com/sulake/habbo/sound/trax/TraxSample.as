package com.sulake.habbo.sound.trax
{
    ...
    public class TraxSample implements IDisposable 
    {
        ...
        public function TraxSample(_arg_1:ByteArray, _arg_2:int, _arg_3:String="sample_44khz", _arg_4:String="sample_16bit")
        {
            ...
            var _local_15:int = (_samplesPerValue * _sampleRepeats);
            ...
            var _local_9:int;
            var _local_7:int = int((_local_14 / _sampleRepeats));
            _local_8 = 0;
            ...
            while (_local_8 < _local_7)
            {
                ...
                while (_local_10 <= _sampleRepeats)
                {
                ...
                if ((_local_8 % _samplesPerValue) == (_samplesPerValue - 1))
                {
                    _sampleData[int((_local_8 / _samplesPerValue))] = _local_9;
                    _local_9 = 0;
                };
        ...
        {
            return ((_sampleData.length * _samplesPerValue) * _sampleRepeats);
        }

        public function get usageCount():int
        {
            return (_usageList.length);
        }
        ...
        public function setSample(_arg_1:Vector.<int>, _arg_2:int, _arg_3:int, _arg_4:int):int
        {
            ...
            var _local_5:int = (_samplesPerValue * _sampleRepeats);
        ...
        public function setUsageFromSong(_arg_1:int, _arg_2:uint):void
        {
            ...
            if (_usageList.indexOf(_arg_1) == -1)
            {
                _usageList.push(_arg_1);
            };
        ...
        public function isUsedFromSong(_arg_1:int):Boolean
        {
            ...
            return (!(_usageList.indexOf(_arg_1) == -1));
        }
