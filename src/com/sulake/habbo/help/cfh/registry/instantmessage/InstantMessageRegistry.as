    ...
    public class InstantMessageRegistry 
    {
        ...
        public function addItem(_arg_1:int, _arg_2:String, _arg_3:String):void
        {
            ...
            if (_registry.hasKey(_arg_1))
            {
                ...
                _local_5.push(new InstantMessageRegistryItem(_nextIndex++, _arg_1, _arg_2, _arg_3));
            ...
            else
            {
                ...
                _local_4.push(new InstantMessageRegistryItem(_nextIndex++, _arg_1, _arg_2, _arg_3));
                _registry.add(_arg_1, _local_4);
            };

            _purgeCounter++;

            if ((_purgeCounter % 3) == 0)
            {
                purgeRegistry();
            };
        }
