package com.sulake.habbo.help.cfh.registry.instantmessage
{
    ...
    public class InstantMessageEventHandler implements IDisposable 
    {
        ...
        {
            _component = _arg_1;
            _component.addMessageEvent(new NewConsoleMessageEvent(onInstantMessage));
            _component.addMessageEvent(new RoomInviteEvent(onRoomInvite));
        }
        ...
        public function onInstantMessage(_arg_1:NewConsoleMessageEvent):void
        {
            ...
            if (((_local_2.senderId < 0) && (!(_local_2.extraData == null))))
            {
                ...
                _component.instantMessageRegistry.addItem(_local_2.senderId, ((_local_4 + ":") + _local_3), _local_2.messageText);
            }

            else
            {
                _component.instantMessageRegistry.addItem(_local_2.senderId, "", _local_2.messageText);
            };
        }
