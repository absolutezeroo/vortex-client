package com.sulake.habbo.help.guidehelp
{
    public class GuideSessionData 
    {
        ...
        {
            return ((_role == 2) && ((((_activeWindow == "user_create") || (_activeWindow == "user_pending")) || (_activeWindow == "user_ongoing")) || (_activeWindow == "user_feedback")));
        }

        public function isActiveGuideSession():Boolean
        {
            return ((_role == 1) && (((_activeWindow == "guide_accept") || (_activeWindow == "guide_ongoing")) || (_activeWindow == "guide_closed")));
        }
