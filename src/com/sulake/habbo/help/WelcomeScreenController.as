package com.sulake.habbo.help
{
    ...
    public class WelcomeScreenController implements IUpdateReceiver 
    {
        ...
        private var _targetLoc:Point = new Point(72, 10);
        ...
        public function showWelcomeScreen(_arg_1:String, _arg_2:String, _arg_3:int, _arg_4:String):void
        {
            ...
            _targetIconId = _arg_1;
            _alignment = _arg_3;
            _clickActionId = _arg_4;
        ...
        {
            var _local_1:Rectangle = _habboHelp.toolbar.getIconLocation(_targetIconId);
            ...
            {
                _targetLoc.x = (_local_1.x - _window.width);
            ...
            if (_local_1 != null)
            {
                _targetLoc.y = ((_local_1.y + (_local_1.height / 2)) - (_window.height / 2));
            }
        ...
        {
            if (_clickActionId != null)
            {
                _habboHelp.toolbar.toggleWindowVisibility(_clickActionId);
            };
        ...
        public function update(_arg_1:uint):void
        {
            ...
            var _local_2:Number = Point.distance(_window.position, _targetLoc);

            if (_local_2 > 5)
            {
                _local_3 = Point.interpolate(_window.position, _targetLoc, 0.5);
        ...
        public function onHabboToolbarEvent(_arg_1:HabboToolbarEvent):void
        {
            ...
            switch (_arg_1.type)
            {
                case "HTE_RESIZED":
                    ...
                    if (_habboHelp != null)
                    {
                        _local_2 = _habboHelp.toolbar.getIconLocation(_targetIconId);
                    };

                    if (_local_2 != null)
                    {
                        _targetLoc.y = ((_local_2.y + (_local_2.height / 2)) - (_window.height / 2));
                        _window.y = _targetLoc.y;
                    };
