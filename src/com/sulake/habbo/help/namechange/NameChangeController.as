package com.sulake.habbo.help.namechange
{
    ...
    public class NameChangeController implements INameChangeUI, IDisposable
    {
        ...
        {
            if (((_nameChangeView == null) || (_nameChangeView.disposed)))
            {
                _nameChangeView = new NameChangeView(this);
            };

            _nameChangeView.showMainView();
            prepareForTutorial();
        }
        ...
        {
            if (_nameChangeView != null)
            {
                _nameChangeView.dispose();
                _nameChangeView = null;
            };
        ...
        private function onChangeUserNameResult(_arg_1:ChangeUserNameResultMessageEvent):void
        {
            ...
            else
            {
                if (_nameChangeView)
                {
                    _nameChangeView.setNameNotAvailableView(_local_2.resultCode, _local_2.name, _local_2.nameSuggestions);
                };
            };
        }
        ...
        private function onCheckUserNameResult(_arg_1:CheckUserNameResultMessageEvent):void
        {
            ...
            if (_local_2.resultCode == ChangeUserNameResultMessageEvent._SafeStr_505)
            {
                _nameChangeView.checkedName = _local_2.name;
            }
