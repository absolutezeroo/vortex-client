    ...
    public class HabboHelp extends Component implements IHabboHelp, ILinkEventTracker
    {
        ...
        public function getXmlWindow(name:String, layer:uint=1):IWindow
        {
            ...
            try
            {
                ...
                _local_4 = _windowManager.buildFromXML(XML(_local_3.content), layer);
            }

            catch(e:Error)
            {
                ErrorReportStorage.addDebugData("HabboNavigator", (((((("Failed to build window " + name) + "_xml, ") + _local_5) + ", ") + _windowManager) + "!"));
                throw (e);
            };
