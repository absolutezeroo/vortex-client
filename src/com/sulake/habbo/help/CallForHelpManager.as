package com.sulake.habbo.help
{
    ...
    public class CallForHelpManager implements IDisposable
    {
        ...
        public function showEmergencyHelpRequest(_arg_1:int):void
        {
            ...
            if (_local_2 != null)
            {
                _local_3 = _local_2.getSelectableByName(("" + _incomingTopic));
        ...
        {
            closeWindow();
            _chatReportController.show(_habboHelp.ownUserId, _reportedUserId, _reportType);
        }
            ...
            if (_arg_1.type == "WME_CLICK")
            {
                switch (_arg_2.name)
                {
                    case "submit_button":
                        ...
                        if (_chatReportController.collectSelectedEntries(_reportType, -1).length == 0)
                        {
        ...
        {
            if ((((_reportType == 7) || (_reportType == 8)) || (_reportType == 4)))
            {
                return (false);
            };

            return (((_reportedUserId <= 0) || (_habboHelp.chatRegistry.getItemsByUser(_reportedUserId).length > 0)) || (_reportType == 3));
        }
        ...
        private function saveEmergencyHelpRequestData(_arg_1:Boolean=true):Boolean
        {
            ...
            _message = IIlluminaInputWidget(IWidgetWindow(_window.findChildByName("help_message")).widget).message;
            ...
            if (_message.length < _habboHelp.getInteger("help.cfh.length.minimum", 15))
            {
            ...
            if (((_reportType == 8) || (_reportType == 7)))
            {
                return (true);
            };

            if ((((_reportedUserId <= 0) && ((!(_reportType == 8)) && (_reportType == 7))) || ((_reportType == 4) && (!(_habboHelp.getBoolean("room.report.enabled"))))))
            {
                _habboHelp.windowManager.alert("${generic.alert.title}", "${guide.bully.request.usermissing}", 0, null);
                return (false);
            };
        ...
        private function submitCallForHelp():void
        {
            ...
            switch (_reportType)
            {
                ...
                case 4:
                    ...
                    _habboHelp.sendMessage(new CallForHelpMessageComposer(_message, _topicIndex, _reportedUserId, _local_1, _chatReportController.collectSelectedEntries(_reportType, -1)));
                    break;
                case 3:
                    _habboHelp.sendMessage(new CallForHelpFromIMMessageComposer(_message, _topicIndex, _reportedUserId, _chatReportController.collectSelectedEntries(3, -1)));
                    break;
                case 7:
                    _habboHelp.sendMessage(new CallForHelpFromForumThreadMessageComposer(_reportedGroupId, _reportedThreadId, _topicIndex, _message));
                    break;
                case 8:
                    _habboHelp.sendMessage(new CallForHelpFromForumMessageMessageComposer(_reportedGroupId, _reportedThreadId, _reportedMessageId, _topicIndex, _message));
                default:
            };
