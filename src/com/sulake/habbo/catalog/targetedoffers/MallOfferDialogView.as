package com.sulake.habbo.catalog.targetedoffers
{
    ...
    public class MallOfferDialogView 
    {
        ...
        public function MallOfferDialogView(_arg_1:OfferController, _arg_2:HabboMallOffer)
        {
            ...
            _controller = _arg_1;
            _offer = _arg_2;
            _window = IWindowContainer(_controller.catalog.windowManager.buildFromXML(XML(_controller.catalog.assets.getAssetByName("targeted_offer_habbomall_xml").content)));
            ...
            {
                _local_3 = (_controller.catalog as ICoreConfiguration).getProperty("image.library.url");
            ...
            if (_arg_1.type == "WME_DOWN")
            {
                switch (_arg_2.name)
                {
                    case "header_button_close":
                        _controller.onHabboMallOfferClosed(_offer);
                        return;
                    case "btn_buy":
                        _controller.onHabboMallOfferOpened(_offer);
                        return;
                };
            };
        }
        ...
        {
            return (_controller.catalog.localization.getLocalization(_arg_1, ((_arg_2) || (_arg_1))));
        }
