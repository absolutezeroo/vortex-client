package com.sulake.habbo.catalog.targetedoffers
{
    ...
    public class OfferController implements IProductDataListener 
    {
        ...
        public function dispose():void
        {
            ...
            if (_externalInterfaceHelper)
            {
                _externalInterfaceHelper.dispose();
                _externalInterfaceHelper = null;
            };
        }
        ...
        {
            _externalInterfaceHelper = new MallOfferExternalInterfaceHelper(this);
        }
        ...
        public function maximizeMallOffer(_arg_1:HabboMallOffer):void
        {
            ...
            destroyView();
            _mallOfferDialog = new MallOfferDialogView(this, _arg_1);
        ...
        public function destroyView():void
        {
            ...
            if (_mallOfferDialog)
            {
                _mallOfferDialog.dispose();
                _mallOfferDialog = null;
            };
