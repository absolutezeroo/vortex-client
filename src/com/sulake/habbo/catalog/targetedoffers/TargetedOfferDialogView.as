package com.sulake.habbo.catalog.targetedoffers
{
    ...
    public class TargetedOfferDialogView extends OfferView 
    {
        ...
        public function buildWindow(_arg_1:String):void
        {
            ...
            var _local_6:Map = _SafeStr_1284.catalog.utils.getPriceMap(_offer, _quantity);
        ...
        public function updateButtonStates():void
        {
            ...
            var _local_1:Boolean = _offer.checkPurseBalance(_SafeStr_1284.catalog.getPurse(), _quantity);
        ...
        private function updatePriceText():void
        {
            ...
            if (_local_2)
            {
                _local_2.text = ((_quantity * _offer.priceInCredits) + "");
            };
            ...
            if (_local_1)
            {
                _local_1.text = ((_quantity * _offer.priceInActivityPoints) + "");
            };
        }
            ...
            if (_arg_1.type == "WME_DOWN")
            {
                switch (_arg_2.name)
                {
                    ...
                    case "btn_buy":
                        ...
                        _SafeStr_1284.showConfirmation(_offer, _quantity);
                        return;
                };
            };
        }
        ...
        {
            return ((_quantity >= 1) && (_quantity <= _offer.purchaseLimit));
        }
        ...
        private function onQuantityInputEvent(_arg_1:WindowKeyboardEvent):void
        {
            ...
            {
                _arg_1.target.caption = _quantity.toString();
                return;
            };
