package com.sulake.habbo.catalog.purse
{
    ...
    public class PurseEvent extends Event 
    {
        ...
        public function PurseEvent(_arg_1:String, balance:int, activityPointType:int, _arg_4:Boolean=false, _arg_5:Boolean=false)
        {
            super(_arg_1, _arg_4, _arg_5);
            _balance = balance;
            _activityPointType = activityPointType;
        }
