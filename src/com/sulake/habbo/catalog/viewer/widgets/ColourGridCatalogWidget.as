package com.sulake.habbo.catalog.viewer.widgets
{
    ...
    public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget 
    {
        ...
        private function onAvailableColours(_arg_1:CatalogWidgetColoursEvent):void
        {
            ...
            _colourChooserColour = (_local_3.content as BitmapData);
        ...
        private function populateColourGrid():void
        {
            ...
            for each (var _local_13:Array in _colours)
            {
                if (_local_13.length > 0)
                {
                    ...
                    if (_local_12 != null)
                    {
                        _local_12.bitmap = new BitmapData(_colourChooserColour.width, _colourChooserColour.height, true, 0);
                        _local_9 = 0xFF;
                        _local_2 = 0xFF;
                        _local_1 = 0xFF;
                        _local_5 = null;
                        ...
                        _local_5 = _colourChooserColour.clone();
                        ...
                        if (_local_13.length > 1)
                        {
                            ...
                            _local_3 = _colourChooserColour.clone();
