package com.sulake.habbo.catalog.viewer.widgets
{
    ...
    public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener 
    {
        ...
        override public function init():Boolean
        {
            ...
            _previewImage = (window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow);
        ...
        private function onWidgetsInitialized(_arg_1:CatalogWidgetEvent):void
        {
            ...
            var _local_2:Map = _trophyOffers.getWithIndex(_selectIndex);

            if (_local_2 != null)
            {
                _local_3 = _local_2.getValue(_selectType);
        ...
        private function onSelectProduct(_arg_1:SelectProductEvent):void
        {
            ...
            _priceWidget = _catalog.utils.showPriceOnProduct(_local_2, _window, _priceWidget, _previewImage, 0, false, 0);
        }
        ...
        private function onColourIndex(_arg_1:CatalogWidgetColourIndexEvent):void
        {
            ...
            _priceWidget = _catalog.utils.showPriceOnProduct(_local_3, _window, _priceWidget, _previewImage, 0, false, 0);
        }
        ...
        private function onClickNext(_arg_1:WindowMouseEvent):void
        {
            ...
            if (_selectIndex >= _trophyOffers.length)
            {
                _selectIndex = 0;
            };
        ...
        private function onClickPrev(_arg_1:WindowMouseEvent):void
        {
            ...
            if (_selectIndex < 0)
            {
                _selectIndex = (_trophyOffers.length - 1);
            };
        ...
        private function setPreviewImage(_arg_1:BitmapData, _arg_2:Boolean):void
        {
            ...
            if (((!(window.disposed)) && (!(_previewImage == null))))
            {
                if (_arg_1 == null)
                {
                ...
                if (_previewImage.bitmap == null)
                {
                    _previewImage.bitmap = new BitmapData(_previewImage.width, _previewImage.height, true, 0xFFFFFF);
                };

                _previewImage.bitmap.fillRect(_previewImage.bitmap.rect, 0xFFFFFF);
                _local_3 = new Point(((_previewImage.width - _arg_1.width) / 2), ((_previewImage.height - _arg_1.height) / 2));
                _previewImage.bitmap.copyPixels(_arg_1, _arg_1.rect, _local_3, null, null, true);
