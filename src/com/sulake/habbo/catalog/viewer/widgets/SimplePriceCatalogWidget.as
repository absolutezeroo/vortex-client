package com.sulake.habbo.catalog.viewer.widgets
{
    ...
    public class SimplePriceCatalogWidget extends CatalogWidget implements ICatalogWidget 
    {
        ...
        {
            _priceWidget = _catalog.utils.showPriceOnProduct(_arg_1.offer, (_window as IWindowContainer), _priceWidget, _window.findChildByName("fake_productimage"), 0, true, 0);
        }
