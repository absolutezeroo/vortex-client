package com.sulake.habbo.catalog.viewer.widgets
{
    ...
    public class FeaturedItemsCatalogWidget extends CatalogWidget implements ICatalogWidget 
    {
        ...
        override public function init():Boolean
        {
            ...
            _itemListWindow = (window.findChildByName("itemlist_featured") as IItemListWindow);
            _template = (_itemListWindow.getListItemByName("featured_item_template") as IWindowContainer);
            _itemListWindow.removeListItems();
            ...
            {
                _itemListWindow.addListItem(createItemFromTemplate(_catalog.frontPageItems[_local_2]));
                _local_2++;
            };
        ...
        {
            return (populateItem(_arg_1, (_template.clone() as IWindowContainer)));
        }
        ...
        private function eventProc(_arg_1:WindowEvent, _arg_2:IWindow):void
        {
            ...
            {
                _local_4 = _itemListWindow.getListItemIndex(_arg_2.parent);
