package com.sulake.habbo.catalog.viewer.widgets
{
    ...
    public class PurchaseCatalogWidget extends CatalogWidget implements ICatalogWidget
    {
        ...
        private function onToggleWidget(_arg_1:CatalogWidgetToggleEvent):void
        {
            ...
            {
                _enabled = _arg_1.enabled;
                window.visible = _enabled;
            };
        }
        ...
        {
            return (!((_extraParamRequired) && (_additionalParameters == "")));
        }
        ...
        private function onSetParameter(_arg_1:SetExtraPurchaseParameterEvent):void
        {
            ...
            enableBuyButton(extraParamRequirementsMet);
            enableGiftButton(((((!(_offer == null)) && (_offer.giftable)) && (extraParamRequirementsMet)) && (_quantity == 1)));
        }
        ...
        private function onPurchase(_arg_1:WindowMouseEvent, _arg_2:Boolean=false):void
        {
            ...
            if (_purchaseCallback == null)
            {
                if (_offer != null)
                {
                    ...
                    _catalog.showPurchaseConfirmation(_offer, page.pageId, _additionalParameters, _quantity, _previewStuffData, null, true, null);
                };
            }
        ...
        {
            _extraParamRequired = true;
            enableBuyButton(extraParamRequirementsMet);
            enableGiftButton((((!(_offer == null)) && (extraParamRequirementsMet)) && (_quantity == 1)));
        }
