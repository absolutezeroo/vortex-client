package com.sulake.habbo.catalog.viewer.widgets
{
    ...
    public class RoomAdsCatalogWidget extends CatalogWidget implements ICatalogWidget
    {
        ...
        override public function init():Boolean
        {
            ...
            {
                _messageListener = new RoomAdPurchaseInfoEvent(onPurchaseInfoEvent);
                _local_4.addMessageEvent(_messageListener);
            };
        ...
        private function populateEventCategories():void
        {
            ...
            _categoryMenu = (window.findChildByName("categories_list") as IDropMenuWindow);
            ...
            _categoryMenu.populate(_local_2);
            _categoryMenu.selection = 0;
            _categoryMenu.addEventListener("WE_SELECTED", onEventCategoryMenuEvent);
        }
        ...
        private function setExtendData():void
        {
            ...
            if (((!(_local_2 == null)) && (_local_2.extended)))
            {
                ...
                _categoryMenu.selection = (_local_2.categoryId - 1);
            };
        }
        ...
        private function onEventCategoryMenuEvent(_arg_1:WindowEvent):void
        {
            var _local_3:int;
            var _local_5:int = -1;
            var _local_6:int = _categoryMenu.selection;
        ...
        private function selectedOffer():IPurchasableOffer
        {
            ...
            if (((!(_local_1 == null)) && (_local_1)))
            {
                ...
                while (_local_3 < _local_1.length)
                {
                    ...
                    if ((((_local_2.clubLevel == 2) && (_isVip)) || ((!(_local_2.clubLevel == 2)) && (!(_isVip)))))
                    {
                        return (_local_2);
                    };
        ...
        override public function dispose():void
        {
            ...
            if (_catalog != null)
            {
                ...
                if (_messageListener != null)
                {
                    _local_1.removeMessageEvent(_messageListener);
