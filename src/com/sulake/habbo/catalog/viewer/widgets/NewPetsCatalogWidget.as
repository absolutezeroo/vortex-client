    ...
    public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
    {
        ...
        private function initializePaletteSelection():void
        {
            ...
            if (_availablePalettes != null)
            {
                ...
                while (((_local_2 < 20) && (_local_2 < _availablePalettes.length)))
                {
                    _local_1 = _availablePalettes[_local_2];
                    _local_3 = _catalog.roomEngine.getPetColor(_selectedTypeIndex, _local_1.paletteId);
        ...
        private function selectedPalette(_arg_1:int):void
        {
            if (((!(_availablePalettes == null)) && (_availablePalettes.length > 0)))
            {
                if (((_arg_1 < 0) || (_arg_1 > _availablePalettes.length)))
                {
                    _arg_1 = 0;
                };

                _selectedPaletteIndex = _arg_1;
                updateImage();
            };
        }
        ...
        private function getPetLocalization():String
        {
            ...
            if (((!(page == null)) && (!(page.viewer == null))))
            {
                ...
                {
                    _local_1 = (_availablePalettes[_selectedPaletteIndex] as SellablePetPaletteData);
                    return (_catalog.localization.getLocalization(getRaceLocalizationKey(_selectedTypeIndex, _local_1.breedId), getRaceLocalizationKey(_selectedTypeIndex, _local_1.breedId)));
                };
            };

            _local_1 = _availablePalettes[_selectedPaletteIndex];
            return (getRaceLocalizationKey(_selectedTypeIndex, _local_1.breedId));
        }
        ...
        private function onPurchase(_arg_1:WindowEvent):void
        {
            ...
            var _local_2:String = _inputField.caption;
        ...
        private function getPetImage():BitmapData
        {
            ...
            if (((_local_10 == null) || (_selectedPaletteIndex < 0)))
            {
                return (null);
            };

            var _local_6:int = _selectedTypeIndex;
            var _local_3:SellablePetPaletteData = _availablePalettes[_selectedPaletteIndex];
        ...
        private function updateImage():void
        {
            ...
            _priceWidget = _catalog.utils.showPriceOnProduct(_local_1, _window, _priceWidget, _local_4, -6, false, 6);
        ...
        private function getPurchaseParameters():String
        {
            ...
            var data:SellablePetPaletteData = _availablePalettes[_selectedPaletteIndex];
        ...
        private function setPreviewImage(_arg_1:BitmapData, _arg_2:Boolean):void
        {
            ...
            if (!window.disposed)
            {
                ...
                if (_local_6 != null)
                {
                    ...
                    if (_SafeStr_1583.indexOf(_selectedTypeIndex) == -1)
                    {
                        _local_5 = 2;
                    };
