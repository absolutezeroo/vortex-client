package com.sulake.habbo.catalog.viewer.widgets
{
    ...
    public class MarketPlaceOwnItemsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization 
    {
        ...
        override public function init():Boolean
        {
            ...
            _itemTemplates.add(1, _local_1.removeListItem(_local_1.getListItemByName("ongoing_item")));
            _itemTemplates.add(2, _local_1.removeListItem(_local_1.getListItemByName("sold_item")));
            _itemTemplates.add(3, _local_1.removeListItem(_local_1.getListItemByName("expired_item")));
        ...
        private function updateList(_arg_1:Map):void
        {
            ...
            while (_local_21 < _local_5.length)
            {
                ...
                _local_24 = _itemTemplates.getValue(_local_17.status);
