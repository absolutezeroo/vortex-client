package com.sulake.habbo.catalog.purchase
{
    ...
    public class PurchaseConfirmationDialog implements IAvatarImageListener, IGetImageListener 
    {
        ...
        public function showOffer(_arg_1:IHabboCatalog, _arg_2:IRoomEngine, _arg_3:IPurchasableOffer, _arg_4:int, _arg_5:String, _arg_6:int, _arg_7:IStuffData, _arg_8:Array, _arg_9:String, _arg_10:BitmapData):void
        {
            ...
            _pageId = _arg_4;
            _extraParameter = _arg_5;
            _stuffData = _arg_7;
            _friends = _arg_8;
            _userName = _arg_9;
            _quantity = _arg_6;
            _bundleDiscountEnabled = ((_catalog.bundleDiscountEnabled) ? _arg_3.bundlePurchaseAllowed : false);
        ...
        public function dispose():void
        {
            ...
            if (_suggestionsListItem != null)
            {
                _suggestionsListItem.dispose();
                _suggestionsListItem = null;
            };
        }
        ...
        private function showConfirmationDialog(_arg_1:IPurchasableOffer, _arg_2:BitmapData):void
        {
            ...
            _catalog.utils.showPriceInContainer(_local_15, _arg_1, _quantity);
            ...
            if (_local_4 != null)
            {
                if (((_catalog.multiplePurchaseEnabled) && (_quantity > 1)))
                {
                    _local_4.text = ("X " + _quantity);
                }
            ...
            {
                _local_8 = _catalog.utils.getDiscountItemsCount(_quantity);
            ...
            if (_local_9 != null)
            {
                ...
                if (((!(_local_10)) && (_arg_1.product)))
                {
                    ...
                    if (_arg_2 == null)
                    {
                        ...
                        {
                            case "s":
                                _local_6 = _local_16.getFurnitureImage(_local_5, new Vector3d(90, 0, 0), 64, this, 0, _local_7, -1, -1, _stuffData);
                                break;
                            case "i":
        ...
        private function updateGiftDialogLabels():void
        {
            ...
            if (_local_2 != null)
            {
                _local_7 = ((_local_3) ? "catalog.gift_wrapping_new.box.default" : ("catalog.gift_wrapping_new.box." + _boxTypes[_boxIndex]));
            ...
            if (_local_4 != null)
            {
                _local_7 = ("catalog.gift_wrapping_new.ribbon." + _ribbonIndex);
                _local_1 = _localization.getLocalizationRaw(_local_7);
                _local_6 = _local_7;
        ...
        public function showGiftDialog():void
        {
            ...
            if (_local_7.defaultStuffTypes.length > 0)
            {
                ...
                _defaultStuffType = _local_7.defaultStuffTypes[_local_3];
            };

            _stuffTypes = _local_7.stuffTypes;
            _boxTypes = _boxTypes.concat(_local_7.boxTypes);
            _boxTypes.push(_defaultStuffType);
            _ribbonTypes = _local_7.ribbonTypes;
            _selectedTypeId = _stuffTypes[0];
            _ribbonIndex = _ribbonTypes[0];
            _boxIndex = _catalog.getInteger("catalog.purchase.gift_wrapping.default_box_index", 0);

            if (((_boxIndex < 0) || (_boxIndex > (_boxTypes.length - 1))))
            {
                _boxIndex = 0;
            };
        ...
        {
            return (_boxTypes[_boxIndex] == _defaultStuffType);
        }
        ...
        private function updatePreview():void
        {
            if (_ribbonIndex < 0)
            {
                _ribbonIndex = (_ribbonTypes.length - 1);
            };

            if (_ribbonIndex > (_ribbonTypes.length - 1))
            {
                _ribbonIndex = 0;
            };
            ...
            if (_boxIndex < 0)
            {
                _boxIndex = (_boxTypes.length - 1);
            };

            if (_boxIndex > (_boxTypes.length - 1))
            {
                _boxIndex = 0;
            };

            var _local_5:int = _boxTypes[_boxIndex];
            ...
            var _local_2:int = ((_local_5 * 1000) + _ribbonTypes[_ribbonIndex]);
        ...
        private function initColorGrid():void
        {
            ...
            for each (var _local_4:int in _stuffTypes)
            {
        ...
        private function giveGift():void
        {
            ...
            var _local_7:int = ((_local_9) ? _defaultStuffType : _selectedTypeId);
            var _local_5:int = ((_local_9) ? 0 : _boxTypes[_boxIndex]);
            var _local_6:int = ((_local_9) ? 0 : _ribbonTypes[_ribbonIndex]);
            var _local_2:Boolean = isShowPurchaserName();
            _catalog.purchaseProductAsGift(_pageId, _offerId, _extraParameter, _local_4, _local_8, _local_7, _local_5, _local_6, _local_2);
        }
        ...
        private function onBuyButtonClick(_arg_1:WindowEvent):void
        {
            ...
            {
                _catalog.purchaseGameTokensOffer(_extraParameter);
            }

            else
            {
                _catalog.purchaseProduct(_pageId, _offerId, _extraParameter, _quantity);
        ...
        private function onNameInputChange(_arg_1:WindowEvent):void
        {
            ...
            for each (var _local_4:String in _friends)
            {
            ...
            switch (_local_4.keyCode)
            {
                ...
                case 40:
                    ...
                    if (_local_2 != null)
                    {
                        ...
                        {
                            if (((_suggestionContainer == null) || (!(_suggestionContainer.visible))))
                            {
        ...
        private function showAllFriendSuggestions():Boolean
        {
            ...
            if (((!(_friends == null)) && (_friends.length > 0)))
            {
                ...
                for each (var _local_1:String in _friends)
                {
        ...
        private function selectHighlighted():void
        {
            ...
            var _local_3:IItemListWindow = (_suggestionContainer.findChildByName("suggestion_list") as IItemListWindow);
        ...
        private function showSuggestions(_arg_1:Boolean):void
        {
            ...
            _suggestionContainer.visible = _arg_1;
        ...
        private function updateSuggestions(_arg_1:Array):void
        {
            ...
            if (_suggestionContainer == null)
            {
                _suggestionContainer = (_window.findChildByName("suggestion_container") as IWindowContainer);
            };

            if (_suggestionsListItem == null)
            {
                _suggestionsListItem = (_catalog.utils.createWindow("suggestion_list_item_new") as IWindowContainer);
            };

            if (((_suggestionContainer == null) || (_suggestionsListItem == null)))
            {
                return;
            };

            var _local_9:IItemListWindow = (_suggestionContainer.findChildByName("suggestion_list") as IItemListWindow);
            ...
            {
                _local_5 = (_suggestionsListItem.clone() as IWindowContainer);
        ...
        {
            _selectedTypeId = _arg_1.target.id;
            updateColorGrid();
            updatePreview();
        }
        ...
        private function updateColorGrid():void
        {
            ...
            while (_local_4 < _local_3.numGridItems)
            {
                ...
                if (_local_1 != null)
                {
                    ...
                    if (_local_2 != null)
                    {
                        _local_2.visible = (_local_1.id == _selectedTypeId);
                    };
                };
