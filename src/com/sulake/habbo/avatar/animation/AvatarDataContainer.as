package com.sulake.habbo.avatar.animation
{
    ...
    public class AvatarDataContainer implements IAvatarDataContainer 
    {
        ...
        public function AvatarDataContainer(_arg_1:XML)
        {
            ...
            _colorTransform = new ColorTransform(_redMultiplier, _greenMultiplier, _blueMultiplier, _alphaMultiplier);
            _colorMap = generatePaletteMapForGrayscale(_backGround, _foreGround);
        }
        ...
        {
            return (_colorMap.getValue("reds") as Array);
        }

        public function get greens():Array
        {
            return (_colorMap.getValue("greens") as Array);
        }

        public function get blues():Array
        {
            return (_colorMap.getValue("blues") as Array);
        }

        public function get alphas():Array
        {
            return (_colorMap.getValue("alphas") as Array);
        }
