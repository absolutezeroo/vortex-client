package com.sulake.habbo.avatar
{
    ...
    "callback":onConfigurationComplete
        ...
        public function createAvatarImage(figure:String, _arg_2:String, gender:String=null, _arg_4:IAvatarImageListener=null, _arg_5:IAvatarEffectListener=null):IAvatarImage
        {
            var _local_6:PlaceholderAvatarImage;
            var _local_7:AvatarFigureContainer = new AvatarFigureContainer(figure);
            ...
            if (gender)
            {
                validateAvatarFigure(_local_7, gender);
            };
