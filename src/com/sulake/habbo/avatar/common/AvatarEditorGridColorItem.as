package com.sulake.habbo.avatar.common
{
    ...
    public class AvatarEditorGridColorItem 
    {
        ...
        public function AvatarEditorGridColorItem(_arg_1:IWindowContainer, _arg_2:IAvatarEditorCategoryModel, _arg_3:IPartColor, _arg_4:Boolean=false)
        {
            ...
            _border = (_view.findChildByTag("BORDER") as IStaticBitmapWrapperWindow);
            setupColor();
            updateThumbData();
        ...
        {
            _border.assetUri = ((_isSelected) ? "avatar_editor_editor_clr_13x21_3" : "avatar_editor_editor_clr_13x21_1");
        }

        private function onMouseOver(_arg_1:WindowMouseEvent):void
        {
            _border.assetUri = "avatar_editor_editor_clr_13x21_3";
        }

        private function setupColor():void
        {
            var _local_1:BitmapDataAsset = (_model.controller.manager.windowManager.assets.getAssetByName("avatar_editor_editor_clr_13x21_2") as BitmapDataAsset);
