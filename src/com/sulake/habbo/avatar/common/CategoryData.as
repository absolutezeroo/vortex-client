package com.sulake.habbo.avatar.common
{
    ...
    public class CategoryData 
    {
        ...
        public function dispose():void
        {
            ...
            if (_palettes)
            {
                for each (var _local_3:Array in (_palettes as Array))
                {
                    if (_local_3)
                    {
        ...
        public function selectColorIds(_arg_1:Array):void
        {
            ...
            _paletteIndexes = new Array(_arg_1.length);
            _local_7 = 0;

            while (_local_7 < _palettes.length)
            {
                ...
                if (_local_5)
                {
                    ...
                    while (_local_4 < _local_5.length)
                    {
                        ...
                        {
                            _paletteIndexes[_local_7] = _local_4;
        ...
        public function selectColorIndex(_arg_1:int, _arg_2:int):AvatarEditorGridColorItem
        {
            ...
            deselectColorIndex(_paletteIndexes[_arg_2], _arg_2);
            _paletteIndexes[_arg_2] = _arg_1;
        ...
        public function getSelectedColorIds():Array
        {
            ...
            var _local_4:Array = (_palettes[0] as Array);
            ...
            while (_local_8 < _paletteIndexes.length)
            {
                _local_7 = _palettes[_local_8];

                if (!((!(_local_7)) || (_local_7.length <= _local_8)))
                {
                    if (_local_7.length > _paletteIndexes[_local_8])
                    {
                        _local_5 = (_local_7[_paletteIndexes[_local_8]] as AvatarEditorGridColorItem);
        ...
        private function getSelectedColors():Array
        {
            ...
            while (_local_2 < _paletteIndexes.length)
            {
        ...
        public function getSelectedColor(_arg_1:int):AvatarEditorGridColorItem
        {
            ...
            if (((!(_local_2)) || (_local_2.length <= _paletteIndexes[_arg_1])))
            {
                return (null);
            };

            return (_local_2[_paletteIndexes[_arg_1]] as AvatarEditorGridColorItem);
        }
        ...
        public function getPalette(_arg_1:int):Array
        {
            ...
            if (_palettes.length <= _arg_1)
            {
                return (null);
            };

            return (_palettes[_arg_1] as Array);
        }
