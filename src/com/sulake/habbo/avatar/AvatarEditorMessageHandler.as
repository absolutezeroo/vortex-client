package com.sulake.habbo.avatar
{
    ...
    public class AvatarEditorMessageHandler 
    {
        ...
        {
            if (((_arg_1 == null) || (!(_controller))))
            {
                return;
            };

            var _local_3:HabboAvatarEditor = _controller.getEditor(0);
        ...
        private function onWardrobe(_arg_1:WardrobeMessageEvent):void
        {
            ...
            var _local_2:HabboAvatarEditor = _controller.getEditor(0);
        ...
        private function onRoomAvatarEffects(_arg_1:AvatarEffectMessageEvent):void
        {
            ...
            if ((((_local_2) && (!(_controller.roomDesktop == null))) && (_arg_1.getParser().userId == _controller.roomDesktop.roomSession.ownUserRoomId)))
            {
