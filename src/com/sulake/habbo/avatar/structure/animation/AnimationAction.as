package com.sulake.habbo.avatar.structure.animation
{
    ...
    public class AnimationAction 
    {
        ...
        private var _bodyPartOffsets:Map = new Map();
        ...
        public function AnimationAction(_arg_1:XML)
        {
            ...
            for each (var _local_2:XML in _arg_1.offsets.frame)
            {
                ...
                _local_12 = new Map();
                _bodyPartOffsets[_local_5] = _local_12;
        ...
        public function getFrameBodyPartOffset(_arg_1:int, _arg_2:int, _arg_3:String):Point
        {
            var _local_8:Point;
            var _local_6:Map;
            var _local_7:int = (_arg_2 % _frameIndexes.length);
            var _local_4:int = _frameIndexes[_local_7];
            var _local_5:Map = _bodyPartOffsets[_local_4];
