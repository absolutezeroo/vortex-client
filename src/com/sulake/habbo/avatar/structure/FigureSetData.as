package com.sulake.habbo.avatar.structure
{
    ...
    public class FigureSetData implements IStructureData, IFigureSetData 
    {
        ...
        public function parse(_arg_1:XML):Boolean
        {
            ...
            {
                _palettes[String(_local_2.@id)] = new Palette(_local_2);
            };

            for each (var _local_3:XML in _arg_1.sets.settype)
            {
                _setTypes[String(_local_3.@type)] = new SetType(_local_3);
            };
        ...
        public function injectXML(_arg_1:XML):void
        {
            ...
            for each (var _local_3:XML in _arg_1.sets.settype)
            {
                _local_2 = _setTypes[String(_local_3.@type)];
        ...
        public function appendXML(_arg_1:XML):Boolean
        {
            ...
            for each (var _local_2:XML in _arg_1.colors.palette)
            {
                _local_3 = _palettes[String(_local_2.@id)];
            ...
            {
                _local_4 = _setTypes[String(_local_5.@type)];

                if (_local_4 == null)
                {
                    _setTypes[String(_local_5.@type)] = new SetType(_local_5);
                }
        ...
        public function getMandatorySetTypeIds(_arg_1:String, _arg_2:int):Array
        {
            ...
            for each (var _local_4:SetType in _setTypes)
            {
        ...
        {
            var _local_3:SetType = (_setTypes[_arg_1] as SetType);
        ...
        {
            return (_setTypes[_arg_1]);
        }

        public function getPalette(_arg_1:int):IPalette
        {
            return (_palettes[String(_arg_1)]);
        }
        ...
        public function getFigurePartSet(_arg_1:int):IFigurePartSet
        {
            ...
            for each (var _local_3:SetType in _setTypes)
            {
