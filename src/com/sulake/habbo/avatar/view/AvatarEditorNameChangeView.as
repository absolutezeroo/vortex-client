package com.sulake.habbo.avatar.view
{
    ...
    public class AvatarEditorNameChangeView 
    {
        ...
        {
            _mainView = _arg_1;
            _manager = _mainView.editor.manager;
            _window = IFrameWindow(_manager.windowManager.buildFromXML(XML(new HabboAvatarEditorCom.avatar_editor_name_change())));
            _window.x = _arg_2;

            var _local_4:int = _manager.windowManager.getDesktop(1).width;
        ...
        public function nameCheckWaitBegin():void
        {
            ...
            if (((_window) && (!(_window.disposed))))
            {
                ...
                if (_local_1)
                {
                    _local_1.caption = _manager.localization.getLocalization("help.tutorial.name.wait_while_checking");
                };
            };
        ...
        private function windowEventHandler(_arg_1:WindowEvent, _arg_2:IWindow):void
        {
            ...
            switch (_arg_2.name)
            {
                case "check_name_button":
                    _manager.handler.checkName(getName());
                    nameCheckWaitBegin();
                    return;
            };
        }
        ...
        public function setNameAvailableView():void
        {
            ...
            _manager.localization.registerParameter("help.tutorial.name.available", "name", _checkedName);
            _local_2.text = _manager.localization.getLocalization("help.tutorial.name.available");
        ...
        public function setNameNotAvailableView(_arg_1:int, _arg_2:String, _arg_3:Array):void
        {
            ...
            switch (_arg_1)
            {
                case ChangeUserNameResultMessageEvent._SafeStr_633:
                    _manager.localization.registerParameter("help.tutorial.name.taken", "name", _arg_2);
                    _local_5.text = _manager.localization.getLocalization("help.tutorial.name.taken");
                    break;
                case ChangeUserNameResultMessageEvent._SafeStr_634:
                    _manager.localization.registerParameter("help.tutorial.name.invalid", "name", _arg_2);
                    _local_5.text = _manager.localization.getLocalization("help.tutorial.name.invalid");
                    break;
                case ChangeUserNameResultMessageEvent._SafeStr_635:
                    break;
                case ChangeUserNameResultMessageEvent._SafeStr_636:
                    _local_5.text = _manager.localization.getLocalization("help.tutorial.name.long");
                    break;
                case ChangeUserNameResultMessageEvent._SafeStr_637:
                    _local_5.text = _manager.localization.getLocalization("help.tutorial.name.short");
                    break;
                case ChangeUserNameResultMessageEvent._SafeStr_638:
                    _local_5.text = _manager.localization.getLocalization("help.tutorial.name.change_not_allowed");
                    break;
                case ChangeUserNameResultMessageEvent._SafeStr_639:
                    _local_5.text = _manager.localization.getLocalization("help.tutorial.name.merge_hotel_down");
            };
            ...
            _suggestionsRenderer = new AvatarEditorNameSuggestionListRenderer(_manager);
        ...
        public function setNormalView():void
        {
            ...
            _local_2.text = _manager.localization.getLocalization("help.tutorial.name.info");
