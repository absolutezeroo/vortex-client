package com.sulake.habbo.avatar.view
{
    ...
    public class AvatarEditorNameSuggestionListRenderer 
    {
        ...
        {
            if (((_arg_1.width > _rect.width) || (_arg_1.width < 2)))
            {
                return (false);
            };
        ...
        {
            var _local_2:ITextWindow = (_manager.windowManager.buildFromXML(XML(HabboAvatarEditorCom.avatar_editor_name_change_item)) as ITextWindow);
