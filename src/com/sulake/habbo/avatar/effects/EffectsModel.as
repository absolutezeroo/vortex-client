package com.sulake.habbo.avatar.effects
{
    ...
    public class EffectsModel extends CategoryBaseModel implements IAvatarEditorCategoryModel 
    {
        ...
        private var _selectedIndex:Dictionary = new Dictionary();
        ...
        override protected function init():void
        {
            ...
            if (!_SafeStr_570)
            {
                ...
                _effectsParamView = new EffectsParamView(this, controller.manager.windowManager, controller.manager.assets);
        ...
        override public function selectPart(_arg_1:String, _arg_2:int):void
        {
            ...
            setSelectionVisual(_arg_1, _selectedIndex[_arg_1], false);
            ...
            else
            {
                if ((((_arg_2 == -1) && (_local_5 == -1)) || (_arg_2 == 0)))
                {
                    ...
                    _effectsParamView.updateView(null);
                }
            ...
            _selectedIndex[_arg_1] = _arg_2;
            setSelectionVisual(_arg_1, _arg_2, true);
            _effectsParamView.updateView(_local_3);
        }
