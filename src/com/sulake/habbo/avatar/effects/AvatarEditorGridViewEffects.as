package com.sulake.habbo.avatar.effects
{
    ...
    public class AvatarEditorGridViewEffects implements IAvatarEditorGridView 
    {
        ...
        {
            _window = _arg_1;
            _partGrid = (_window.findChildByName("thumbs") as IItemGridWindow);
            _notification = _window.findChildByName("content_notification");
            _title = _window.findChildByName("content_title");
        }
        ...
        public function initFromList(_arg_1:IAvatarEditorCategoryModel, _arg_2:String):void
        {
            ...
            var _local_3:Array = EffectsModel(_model).effects;
            ...
            else
            {
                ...
                _local_5 = new AvatarEditorGridItemEffect(null, _model.controller.manager.windowManager, _model.controller.manager.assets);
                addGridItem(_local_5);

                for each (var _local_4:IHabboAvatarEditorAvatarEffect in _local_3)
                {
                    _local_5 = new AvatarEditorGridItemEffect(_local_4, _model.controller.manager.windowManager, _model.controller.manager.assets);
                    addGridItem(_local_5);
                };
            };
        ...
        private function addGridItem(_arg_1:AvatarEditorGridItemEffect):void
        {
            ...
            _partGrid.addGridItem(_arg_1.window);
        }
        ...
        private function partEventProc(_arg_1:WindowEvent, _arg_2:IWindow):void
        {
            ...
            {
                _local_3 = _partGrid.getGridItemIndex(_arg_1.window);
                _model.selectPart(_categoryId, _local_3);
            };
        }
