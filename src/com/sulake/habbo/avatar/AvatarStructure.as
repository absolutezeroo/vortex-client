package com.sulake.habbo.avatar
{
    ...
    public class AvatarStructure extends EventDispatcherWrapper 
    {
        ...
        public function AvatarStructure(_arg_1:AvatarRenderManager)
        {
            ...
            _mandatorySetTypeIds = new Dictionary();
        }
        ...
        public function initPartSets(_arg_1:XML):Boolean
        {
            ...
            if (_partSetsData.parse(_arg_1))
            {
                _partSetsData.getPartDefinition("ri").appendToFigure = true;
                _partSetsData.getPartDefinition("li").appendToFigure = true;
                return (true);
            };
        ...
        public function initAnimation(_arg_1:XML):Boolean
        {
            ...
            return (_animationData.parse(_arg_1));
        }
        ...
        {
            return (_actionManager.getActionDefinition(_arg_1));
        }

        public function getActionDefinitionWithState(_arg_1:String):ActionDefinition
        {
            return (_actionManager.getActionDefinitionWithState(_arg_1));
        }
        ...
        {
            return (_actionManager.sortActions(_arg_1));
        }
        ...
        public function maxFrames(_arg_1:Array):int
        {
            ...
            {
                _local_2 = Math.max(_local_2, _animationData.getFrameCount(_local_3.definition));
            };
        ...
        {
            if (!_mandatorySetTypeIds[_arg_1])
            {
                _mandatorySetTypeIds[_arg_1] = new Dictionary();
            };

            if (_mandatorySetTypeIds[_arg_1][_arg_2])
            {
                return (_mandatorySetTypeIds[_arg_1][_arg_2]);
            };

            _mandatorySetTypeIds[_arg_1][_arg_2] = _figureData.getMandatorySetTypeIds(_arg_1, _arg_2);
            return (_mandatorySetTypeIds[_arg_1][_arg_2]);
        }
        ...
        {
            return (_actionManager.getCanvasOffsets(_arg_1, _arg_2, _arg_3));
        }
        ...
        public function getActiveBodyPartIds(_arg_1:IActiveActionData, _arg_2:IAvatarImage):Array
        {
                    ...
                    if (_local_8.hasAddData())
                    {
                        ...
                        for each (var _local_3:AddDataContainer in _local_8.addData)
                        {
                            ...
                            if (_local_7 != null)
                            {
                                ...
                                _local_14 = _partSetsData.addPartDefinition(_local_9);
            ...
            {
                _local_11 = _partSetsData.getActiveParts(_arg_1.definition);
        ...
        {
            var _local_5:AnimationAction = _animationData.getAction(_arg_1.definition);
        ...
        public function getParts(_arg_1:String, _arg_2:IAvatarFigureContainer, _arg_3:IActiveActionData, _arg_4:String, _arg_5:int, _arg_6:Array, _arg_7:IAvatarImage, _arg_8:Map=null):Vector.<AvatarImagePartContainer>
        {
            ...
            var _local_9:Array = _partSetsData.getActiveParts(_arg_3.definition);
            var _local_46:Array = [];
            var _local_35:Array = [0];
            var _local_38:AnimationAction = _animationData.getAction(_arg_3.definition);
                        ...
                        if (_local_17)
                        {
                            ...
                            for each (_local_18 in _local_17.parts)
                            {
                                if (_local_20.indexOf(_local_18.type) > -1)
                                {
                                    ...
                                    _local_28 = _partSetsData.getPartDefinition(_local_18.type);
                ...
                if (!_local_19)
                {
                    ...
                    else
                    {
                        if (_local_9.indexOf(_local_26) > -1)
                        {
                            ...
                            {
                                _local_28 = _partSetsData.getPartDefinition(_local_26);
                                _local_11 = false;
                                _local_12 = 1;
        ...
        public function getItemIds():Array
        {
            ...
            if (_actionManager)
            {
                _local_2 = _actionManager.getActionDefinition("CarryItem").params;
                _local_1 = [];
