package com.sulake.habbo.avatar.geometry
{
    ...
    public class GeometryBodyPart extends Node3D 
    {
        ...
        public function getDynamicParts(_arg_1:IAvatarImage):Array
        {
            ...
            if (_dynamicParts[_arg_1] !== undefined)
            {
                for each (var _local_2:GeometryItem in _dynamicParts[_arg_1])
                {
                    if (_local_2 != null)
                    {
        ...
        public function getPartIds(_arg_1:IAvatarImage):Array
        {
            ...
            if (_dynamicParts[_arg_1] !== undefined)
            {
                for each (_local_2 in _dynamicParts[_arg_1])
                {
                    if (_local_2 != null)
                    {
                        _local_3.push(_local_2.id);
        ...
        public function removeDynamicParts(_arg_1:IAvatarImage):Boolean
        {
            if (_dynamicParts[_arg_1] !== undefined)
            {
                for (var _local_2:String in _dynamicParts[_arg_1])
                {
                    delete _dynamicParts[_arg_1][_local_2];
                };

                _dynamicParts[_arg_1] = null;
                delete _dynamicParts[_arg_1];
            };
        ...
        public function addPart(_arg_1:XML, _arg_2:IAvatarImage):Boolean
        {
            ...
            if (_dynamicParts[_arg_2] === undefined)
            {
                _dynamicParts[_arg_2] = new Dictionary();
            };

            _dynamicParts[_arg_2][_local_3] = new GeometryItem(_arg_1, true);
            return (true);
        }

        public function hasPart(_arg_1:String, _arg_2:IAvatarImage):Boolean
        {
            var _local_3:GeometryItem = _parts[_arg_1];

            if (((_local_3 == null) && (!(_dynamicParts[_arg_2] === undefined))))
            {
                _local_3 = _dynamicParts[_arg_2][_arg_1];
            };
        ...
        public function getParts(_arg_1:Matrix4x4, _arg_2:Vector3D, _arg_3:Array, _arg_4:IAvatarImage):Array
        {
            ...
            for each (_local_5 in _dynamicParts[_arg_4])
            {
                if (_local_5 != null)
                {
                    _local_5.applyTransform(_arg_1);
