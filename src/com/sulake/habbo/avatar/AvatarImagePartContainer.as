package com.sulake.habbo.avatar
{
    ...
    public class AvatarImagePartContainer 
    {
        ...
        public function getFrameIndex(_arg_1:int):int
        {
            ...
            var _local_2:int = (_arg_1 % _frames.length);

            if ((_frames[_local_2] is AnimationFrame))
            {
        ...
        public function getFrameDefinition(_arg_1:int):AnimationFrame
        {
            ...
            if (((_frames) && (_frames.length > _local_2)))
            {
                if ((_frames[_local_2] is AnimationFrame))
                {
                    return (_frames[_local_2] as AnimationFrame);
                };
            };
        ...
        public function getCacheableKey(_arg_1:int):String
        {
            ...
            if (((_frames) && (_frames.length > _local_2)))
            {
                if ((_frames[_local_2] is AnimationFrame))
                {
                    _local_3 = (_frames[_local_2] as AnimationFrame);
