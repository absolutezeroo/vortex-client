package com.sulake.habbo.campaign
{
    ...
    public class HabboCampaigns extends Component implements ILinkEventTracker 
    {
        ...
        private function showProductNotification(_arg_1:String, _arg_2:String, _arg_3:String):void
        {
            ...
            if (_local_4 != null)
            {
                _calendarData.openedDays.push(_dayAttempted);
                _dayAttempted = -1;

                if (((_arg_2) && (!(_arg_2 == ""))))
                {
                    _calendarView.setReceivedProduct(_local_4, (getImageGalleryUrl() + _arg_2));
                }
                ...
                else
                {
                    if (((_arg_3) && (!(_arg_3 == ""))))
                    {
                        _calendarView.setReceivedProduct(_local_4);
                        requestIconFromRoomEngine(_calendarView, _arg_3);
                    };
                };
            };
        }
        ...
        {
            if (((!(_calendarView)) && (_calendarData)))
            {
                _calendarView = new CalendarView(this, _windowManager);
            };
        }
