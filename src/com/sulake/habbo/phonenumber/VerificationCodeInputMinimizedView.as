package com.sulake.habbo.phonenumber
{
    ...
    public class VerificationCodeInputMinimizedView 
    {
        ...
        private function createWindow():void
        {
            ...
            _window = _component.windowManager.buildFromXML(XML(_component.assets.getAssetByName("phonenumber_verify_minimized_xml").content));
        ...
        {
            _component.setVerifyViewMinimized(false);
        }
