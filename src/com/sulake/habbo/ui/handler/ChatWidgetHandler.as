package com.sulake.habbo.ui.handler
{
    ...
    public class ChatWidgetHandler implements IRoomWidgetHandler, IAvatarImageListener, IGetImageListener 
    {
        ...
        private var _tempScreenPosVector:Vector3d = new Vector3d();
        ...
        public function dispose():void
        {
            ...
            for each (var _local_2:BitmapData in _imagesWaitingForDispose)
            {
                if (_local_2 != null)
                {
                    _local_2.dispose();
        ...
        {
            _widget.addChatMessage(_arg_1.message, _arg_1.name, _arg_1.locX, getUserImage(_arg_1.figure), _arg_1.color, _arg_1.notify);
        }
        ...
        private function updateWidgetPosition():void
        {
            ...
            if (_local_6 != null)
            {
                ...
                if (_primaryCanvasScale > 0)
                {
                    _local_3 = (_local_6.scale / _primaryCanvasScale);
                };

                if (_primaryCanvasOriginPos == null)
                {
                    _tempScreenPosVector.x = 0;
                    _tempScreenPosVector.y = 0;
                    _tempScreenPosVector.z = 0;
                    _primaryCanvasOriginPos = _local_6.getScreenPoint(_tempScreenPosVector);
                    _primaryCanvasScale = (_local_6.scale - 10);
                };
                ...
                _tempScreenPosVector.y = 0;
                _tempScreenPosVector.z = 0;
                _local_1 = _local_6.getScreenPoint(_tempScreenPosVector);
                ...
                if (_local_1 != null)
                {
                    ...
                    if (((!(_local_1.x == _primaryCanvasOriginPos.x)) || (!(_local_1.y == _primaryCanvasOriginPos.y))))
                    {
                        _local_5 = PointMath.sub(_local_1, PointMath.mul(_primaryCanvasOriginPos, _local_3));
