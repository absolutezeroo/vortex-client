package com.sulake.habbo.ui.handler
{
    ...
    public class PlayListEditorWidgetHandler implements IRoomWidgetHandler 
    {
        ...
        {
            _furniListUpdateListener = new FurniListEvent(onFurniListUpdated);
            _furniListRemoveListener = new FurniListRemoveEvent(onFurniListUpdated);
            _furniListInsertListener = new FurniListAddOrUpdateEvent(onFurniListUpdated);
            _connection = _arg_1;
            _connection.addMessageEvent(_furniListUpdateListener);
            _connection.addMessageEvent(_furniListRemoveListener);
            _connection.addMessageEvent(_furniListInsertListener);
        }
        ...
        public function dispose():void
        {
            if (!_disposed)
            {
                ...
                if (_connection)
                {
                    _connection.removeMessageEvent(_furniListUpdateListener);
                    _connection.removeMessageEvent(_furniListRemoveListener);
                    _connection.removeMessageEvent(_furniListInsertListener);
                };

                _connection = null;
                _furniListUpdateListener = null;
