package com.sulake.habbo.ui.handler
{
    ...
    public class HighScoreFurniWidgetHandler implements IRoomWidgetHandler 
    {
        ...
        public function processEvent(_arg_1:Event):void
        {
            ...
            switch (_arg_1.type)
            {
                case "RETWE_REQUEST_HIGH_SCORE_DISPLAY":
                    ...
                    if (_local_2 != null)
                    {
                        ...
                        if (_local_5 != null)
                        {
                            ...
                            _widget.open(_local_4.objectId, _local_4.roomId, _local_3);
                        };

                        _cachedRequest = _local_4;
                    };
                ...
                case "RETWE_REQUEST_HIDE_HIGH_SCORE_DISPLAY":
                    ...
                    if (((_local_4.roomId == _widget.roomId) && (_local_4.objectId == _widget.roomObjId)))
                    {
                        _widget.close();
                    };
        ...
        public function update():void
        {
            ...
            if (((((_cachedRequest) && (_widget.isOpen)) && (_widget.roomId == _cachedRequest.roomId)) && (_widget.roomObjId == _cachedRequest.objectId)))
            {
                _local_1 = _container.roomEngine.getRoomObject(_cachedRequest.roomId, _cachedRequest.objectId, _cachedRequest.category);

                if (_local_1 != null)
                {
                    _local_2 = _container.roomEngine.getRoomObjectScreenLocation(_cachedRequest.roomId, _cachedRequest.objectId, _cachedRequest.category);

                    if (_local_2 != null)
                    {
                        _widget.setRelativePositionToRoomObjectAt(_local_2.x, _local_2.y);
                    };
                };
            };
        }
