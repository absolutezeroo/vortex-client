package com.sulake.habbo.ui.handler
{
    ...
    public class FurnitureCustomStackHeightWidgetHandler implements IRoomWidgetHandler 
    {
        ...
        private function onStackHeightUpdate(_arg_1:CustomStackingHeightUpdateMessageEvent):void
        {
            ...
            if (((_widget) && (validateRights())))
            {
                _widget.updateHeight(_local_2.furniId, _local_2.height);
            };
        }
        ...
        public function processEvent(_arg_1:Event):void
        {
            ...
            switch (_arg_1.type)
            {
                case "RETWE_OPEN_WIDGET":
                    ...
                    {
                        _lastFurniId = _local_3.objectId;
                        ...
                        if (((_local_2) && (validateRights(_local_2))))
                        {
                            if (_widget)
                            {
                                _widget.open(_lastFurniId, _local_2.getLocation().z);
                            };
                        };
                    };
                ...
                case "RETWE_CLOSE_WIDGET":
                    ...
                    if ((((!(_arg_1 == null)) && (!(_container.roomEngine == null))) && (!(_widget == null))))
                    {
                        if (_lastFurniId == _local_3.objectId)
                        {
                            _widget.hide();
                        };
                    };
