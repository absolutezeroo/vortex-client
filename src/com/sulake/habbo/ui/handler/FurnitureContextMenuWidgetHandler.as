    ...
    public class FurnitureContextMenuWidgetHandler implements IRoomWidgetHandler 
    {
        ...
        public function dispose():void
        {
            if (!_disposed)
            {
                ...
                if (((!(_connection == null)) && (_furniContextMenuInfoListener)))
                {
                    _connection.removeMessageEvent(_furniContextMenuInfoListener);
                    _furniContextMenuInfoListener = null;
                };
        ...
        public function set connection(_arg_1:IConnection):void
        {
            ...
            if (!_furniContextMenuInfoListener)
            {
                _furniContextMenuInfoListener = new GuildFurniContextMenuInfoMessageEvent(onGuildFurniContextMenuInfo);
                _connection.addMessageEvent(_furniContextMenuInfoListener);
            };
        }
