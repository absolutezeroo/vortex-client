package com.sulake.habbo.ui.handler
{
    ...
    public class SpamWallPostItWidgetHandler implements IRoomWidgetHandler 
    {
        ...
        {
            _spamWallPostItEditRequestListener = new RequestSpamWallPostItMessageEvent(onSpamWallPostItRequest);
            _connection = _arg_1;
            _connection.addMessageEvent(_spamWallPostItEditRequestListener);
        }
        ...
        public function dispose():void
        {
            ...
            {
                _disposed = true;
                _connection.removeMessageEvent(_spamWallPostItEditRequestListener);
                _connection = null;
            };
        }
