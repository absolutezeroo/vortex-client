package com.sulake.habbo.ui.handler
{
    ...
    public class AvatarInfoWidgetHandler implements IRoomWidgetHandler
    {
        ...
        public function dispose():void
        {
            if (!_disposed)
            {
                if (((_respectNotificationListener) && (_container.connection)))
                {
                    _container.connection.removeMessageEvent(_respectNotificationListener);
                };

                container = null;
                _widget = null;

                if (_furniListInsertListener != null)
                {
                    _furniListInsertListener.dispose();
                    _furniListInsertListener = null;
                };

                _respectNotificationListener = null;
                _disposed = true;
            };
        }
        ...
        public function set container(_arg_1:IRoomWidgetHandlerContainer):void
        {
            ...
            {
                _container.connection.removeMessageEvent(_furniListInsertListener);
            };

            if ((((_container) && (_container.connection)) && (_respectNotificationListener)))
            {
                _container.connection.removeMessageEvent(_respectNotificationListener);
            };
            ...
            if (_furniListInsertListener == null)
            {
                _furniListInsertListener = new FurniListAddOrUpdateEvent(onFurniListUpdated);
            };

            if (((!(_respectNotificationListener)) && (_container.connection)))
            {
                _respectNotificationListener = new CustomUserNotificationMessageEvent(onCustomUserNotificationMessage);
                _container.connection.addMessageEvent(_respectNotificationListener);
            };
            ...
            if (((_container) && (_container.connection)))
            {
                _container.connection.addMessageEvent(_furniListInsertListener);
            };
        }
        ...
        public function processWidgetMessage(message:RoomWidgetMessage):RoomWidgetUpdateEvent
        {
            ...
            var message:RoomWidgetMessage = message;
            ...
            switch (message.type)
            {
                ...
                case "RWUAM_COMPOST_PLANT":
                    ...
                    var localization:IHabboLocalizationManager = _widget.catalog.localization;
                    _widget.windowManager.confirm(localization.getLocalization("monsterplant.confirm.title.compost"), localization.getLocalization("monsterplant.confirm.desc.compost"), 0, (function ():Function
                    {
                        var onCompostConfirmed:Function = function (message:_SafeStr_126, _arg_2:WindowEvent):void
                        {
                            message.dispose();
            ...
            switch (_arg_1.type)
            {
                case "rsudue_user_data_updated":
                    ...
                    for each (var _local_3:IUserData in RoomSessionUserDataUpdateEvent(_arg_1).addedUsers)
                    {
                        ...
                        {
                            _widget.showUserName(_local_3, _local_3.roomObjectId);
                        };
                    };
                ...
                case "RSDE_DANCE":
                    ...
                    if ((((((_local_2) && (_widget)) && (container)) && (container.roomSession)) && (container.roomSession.userDataManager)))
                    {
                        ...
                        {
                            _widget.isDancing = (!(_local_2.danceStyle == 0));
                        };
                    };
        ...
        private function onNestBreedingSuccessEvent(_arg_1:RoomSessionNestBreedingSuccessEvent):void
        {
            if (((!(_container == null)) && (!(_container.events == null))))
            {
                _widget.showNestBreedingSuccess(_arg_1.petId, _arg_1.rarityCategory);
            };
        }
        ...
        private function activateUseProductMenuForPets(_arg_1:int, _arg_2:int, _arg_3:int, _arg_4:int, _arg_5:int, _arg_6:int=-1):void
        {
            ...
            _widget.showUseProductMenuForItems(_local_13);
        }
        ...
        private function activateBreedMenuForPets(_arg_1:int, _arg_2:int, _arg_3:int, _arg_4:int, _arg_5:int):void
        {
            ...
            _widget.showBreedPetMenuForItems(_local_11);
        }
