package com.sulake.habbo.ui.handler
{
    ...
    public class InfoStandWidgetHandler implements IRoomWidgetHandler
    {
        ...
        public function InfoStandWidgetHandler(_arg_1:IHabboMusicController)
        {
            ...
            {
                _musicController.events.addEventListener("NPE_SONG_CHANGED", onNowPlayingChanged);
        ...
        public function set container(_arg_1:IRoomWidgetHandlerContainer):void
        {
            if (_container != null)
            {
                ...
                {
                    if (_groupDetailsMessageEvent != null)
                    {
                        _container.connection.removeMessageEvent(_groupDetailsMessageEvent);
                        _groupDetailsMessageEvent.dispose();
                        _groupDetailsMessageEvent = null;
                    };

                    if (_relationshipStatusMessageEvent != null)
                    {
                        _container.connection.removeMessageEvent(_relationshipStatusMessageEvent);
                        _relationshipStatusMessageEvent.dispose();
                        _relationshipStatusMessageEvent = null;
                    };
                };
            };
            ...
            {
                _groupDetailsMessageEvent = new HabboGroupDetailsMessageEvent(onGroupDetails);
                _container.connection.addMessageEvent(_groupDetailsMessageEvent);
                _relationshipStatusMessageEvent = new RelationshipStatusInfoEvent(onRelationshipStatusEvent);
                _container.connection.addMessageEvent(_relationshipStatusMessageEvent);
            };
        }
        ...
        private function onGroupDetails(_arg_1:HabboGroupDetailsMessageEvent):void
        {
            ...
            if (_widget.furniData.groupId == _local_2.groupId)
            {
                _widget.furniView.groupBadgeId = _local_2.badgeCode;
                _widget.furniView.groupName = _local_2.groupName;
            };
        }
        ...
        public function dispose():void
        {
            ...
            {
                _local_1 = (_cachedPetImages.length - 1);

                while (_local_1 >= 0)
                {
                    _local_2 = _cachedPetImages.getWithIndex(_local_1);
            ...
            if (_musicController != null)
            {
                _musicController.events.removeEventListener("NPE_SONG_CHANGED", onNowPlayingChanged);
        ...
        public function processWidgetMessage(_arg_1:RoomWidgetMessage):RoomWidgetUpdateEvent
        {
            ...
            switch (_arg_1.type)
            {
                ...
                case "RWGOI_MESSAGE_GET_BADGE_IMAGE":
                    ...
                    if (_widget != null)
                    {
                        _widget.refreshBadge(_local_15.badgeId);
                    };
                ...
                case "RWPOM_OPEN_PRESENT":
                    ...
                    if (((!(_local_9 == null)) && (!(_widget == null))))
                    {
                        _local_10 = _widget.furniData;

                        if (((!(_local_10 == null)) && (_local_10.id == _local_9.objectId)))
                        {
                            if (_widget.isFurniViewVisible())
                            {
                                _widget.close();
                            };
                        };
        ...
        private function pickupObjectWithConfirmation(_arg_1:int, _arg_2:int):void
        {
            ...
            if (_container != null)
            {
                ...
                {
                    if (_widget.furniData.availableForBuildersClub)
                    {
        ...
        private function handleGetFurniInfoMessage(_arg_1:RoomWidgetRoomObjectMessage, _arg_2:int):void
        {
            ...
            if (((!(_local_20.extraParam == null)) && (_local_20.extraParam.length > 0)))
            {
                ...
                {
                    _local_5 = _musicController.getRoomItemPlaylist();
                ...
                if (_local_17 != -1)
                {
                    _local_18 = _musicController.getSongInfo(_local_17);
        ...
        public function processEvent(_arg_1:Event):void
        {
            ...
            switch (_arg_1.type)
            {
                case "RSUBE_BADGES":
                    ...
                    if (((!(_local_2 == null)) && (!(_widget == null))))
                    {
                        _widget.refreshBadges(_local_2.userId, _local_2.badges);
                    };
        ...
        private function onFigureUpdate(_arg_1:RoomSessionUserFigureUpdateEvent):void
        {
            ...
            _widget.updateUserData(_local_5, _arg_1.figure, _arg_1.achievementScore, _arg_1.customInfo, _local_4);
        }
        ...
        private function onPetInfo(_arg_1:RoomSessionPetInfoUpdateEvent):void
        {
            ...
            var _local_11:BitmapData = (_cachedPetImages.getValue(_local_3) as BitmapData);

            if (_local_11 == null)
            {
                _local_11 = getPetImage(_local_2, _local_7);
                _cachedPetImages.add(_local_3, _local_11);
            };
        ...
        private function onPetFigureUpdate(_arg_1:RoomSessionPetFigureUpdateEvent):void
        {
            ...
            var _local_4:BitmapData = (_cachedPetImages.getValue(_local_2) as BitmapData);

            if (_local_4 == null)
            {
                _local_4 = getPetImage(_local_2);
                _cachedPetImages.add(_local_2, _local_4);
            };
        ...
        private function onFavouriteGroupUpdated(_arg_1:RoomSessionFavouriteGroupUpdateEvent):void
        {
            if (_widget)
            {
                _widget.favouriteGroupUpdated(_arg_1.roomIndex, _arg_1.habboGroupId, _arg_1.status, _arg_1.habboGroupName);
            };
        }
        ...
        private function onNowPlayingChanged(_arg_1:NowPlayingEvent):void
        {
            ...
            if (_musicController != null)
            {
                ...
                if (_local_3 != -1)
                {
                    _local_4 = _musicController.getSongInfo(_local_3);
        ...
        private function onSongInfoReceivedEvent(_arg_1:SongInfoReceivedEvent):void
        {
            ...
            if (_musicController != null)
            {
                _local_2 = _musicController.getSongInfo(_arg_1.id);
        ...
        {
            if (((_widget) && (_widget.mainWindow.visible)))
            {
                _widget.setRelationshipStatus(_arg_1.userId, _arg_1.relationshipStatusMap);
            };
        }
        ...
        public function setObjectData(_arg_1:Map):void
        {
            ...
            {
                _container.connection.send(new SetObjectDataMessageComposer(_widget.furniData.id, _arg_1));
            };
        }
