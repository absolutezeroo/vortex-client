package com.sulake.habbo.ui.handler
{
    ...
    public class RoomToolsWidgetHandler implements IRoomWidgetHandler 
    {
        ...
        private function onRoomInfo(_arg_1:IMessageEvent):void
        {
            ...
            if (_local_4)
            {
                _widget.updateRoomData(_local_4);
            };
            ...
            if (_local_2.enterRoom)
            {
                if (_local_4)
                {
                    _local_3 = ((_local_4.showOwner) ? ((_widget.localizations.getLocalizationWithParams("room.tool.room.owner.prefix", "By") + " ") + _local_4.ownerName) : _widget.localizations.getLocalizationWithParams("room.tool.public.room", "Public room"));
                    _widget.showRoomInfo(true, _local_4.roomName, _local_3, _local_4.tags);
                    _widget.storeRoomData(_local_4);
                    _widget.enterNewRoom(_local_4.flatId);
                };
            };
        }
