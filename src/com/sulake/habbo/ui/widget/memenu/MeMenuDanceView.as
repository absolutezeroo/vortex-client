package com.sulake.habbo.ui.widget.memenu
{
    ...
    public class MeMenuDanceView implements IMeMenuView 
    {
        ...
        private function createWindow(_arg_1:String):void
        {
            ...
            var _local_6:XmlAsset = (_widget.assets.getAssetByName("memenu_dance") as XmlAsset);

            if (_local_6)
            {
                _window = (_widget.windowManager.buildFromXML((_local_6.content as XML)) as IWindowContainer);
            };
            ...
            var _local_4:XmlAsset = (_widget.assets.getAssetByName("memenu_dance_button") as XmlAsset);
            ...
            if (_local_8 != null)
            {
                ...
                while (_local_7 <= 4)
                {
                    ...
                    {
                        _local_5 = _widget.allowHabboClubDances;
                    }
                    ...
                    if (_local_5)
                    {
                        _local_2 = (_widget.windowManager.buildFromXML((_local_4.content as XML)) as IWindow);
            ...
            if (((!(_local_9 == null)) && (_widget.isHabboClubActive)))
            {
