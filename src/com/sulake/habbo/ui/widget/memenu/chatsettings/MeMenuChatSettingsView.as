package com.sulake.habbo.ui.widget.memenu.chatsettings
{
    ...
    public class MeMenuChatSettingsView implements IMeMenuView 
    {
        ...
        private function createWindow(_arg_1:String):void
        {
            ...
            var _local_3:XmlAsset = (_widget.assets.getAssetByName("memenu_chat_settings") as XmlAsset);
            ...
            _SafeStr_108(_window.findChildByName("prefer_old_chat_checkbox")).isSelected = _widget.handler.container.freeFlowChat.isDisabledInPreferences;
        }
