package com.sulake.habbo.ui.widget.uihelpbubbles
{
    ...
    public class UiHelpBubblesWidget extends RoomWidgetBase implements ILinkEventTracker 
    {
        ...
        override public function dispose():void
        {
            ...
            if (_bubbles)
            {
                for each (var _local_1:UiHelpBubble in _bubbles)
                {
                    _local_1.dispose();
                    _local_1 = null;
                };
        ...
        public function addNextBubble():void
        {
            ...
            if ((((!(_bubblesToShow)) || (_bubblesToShow.length == 0)) || (_bubblesToShow.length < (_bubbleIndex + 1))))
            {
                return;
            };

            var _local_3:HelpBubbleItem = (_bubblesToShow[_bubbleIndex] as HelpBubbleItem);
            var _local_2:Boolean = (_bubblesToShow.length > (_bubbleIndex + 1));
            var _local_6:String = _local_3.name;
            var _local_4:UiHelpBubble = new UiHelpBubble(this, _local_3, _local_2);

            if (_bubbles.hasKey(_local_6))
            {
        ...
        public function removeHelpBubble(_arg_1:String):void
        {
            ...
            var _local_2:UiHelpBubble = (_bubbles.getValue(_arg_1) as UiHelpBubble);
        ...
        private function onDesktopResized(_arg_1:WindowEvent=null):void
        {
            ...
            for each (var _local_3:UiHelpBubble in _bubbles)
            {
