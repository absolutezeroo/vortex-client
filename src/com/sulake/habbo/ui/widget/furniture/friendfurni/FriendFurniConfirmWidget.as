package com.sulake.habbo.ui.widget.furniture.friendfurni
{
    ...
    public class FriendFurniConfirmWidget extends RoomWidgetBase 
    {
        ...
        public function open(_arg_1:int, _arg_2:Boolean):void
        {
            ...
            {
                _mainWindow.findChildByName("other_locked_container").height = _otherLockedContainerHeight;
        ...
        private function createWindow():void
        {
            ...
            _otherLockedContainerHeight = _mainWindow.findChildByName("other_locked_container").height;
            _mainWindow.center();
        }
