package com.sulake.habbo.ui.widget.furniture.friendfurni
{
    ...
    public class FriendFurniEngravingWidget extends RoomWidgetBase 
    {
        ...
        public function open(_arg_1:int, _arg_2:int, _arg_3:StringArrayStuffData):void
        {
            ...
            {
                case 0:
                    _engravingView = new LoveLockEngravingView(this, _arg_3);
                    break;
                case 1:
                    break;
                case 2:
                    break;
                case 3:
                    _engravingView = new WildWestEngravingView(this, _arg_3);
                    break;
                case 4:
                    _engravingView = new HabboweenEngravingView(this, _arg_3);
                default:
            };
        ...
        {
            if (((_arg_1 == _stuffId) && (_engravingView)))
            {
                _engravingView.dispose();
                _engravingView = null;
                _stuffId = -1;
            };
        }
