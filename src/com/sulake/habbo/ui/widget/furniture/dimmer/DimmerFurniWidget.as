package com.sulake.habbo.ui.widget.furniture.dimmer
{
    ...
    public class DimmerFurniWidget extends RoomWidgetBase 
    {
        ...
        private function onDimmerState(_arg_1:RoomWidgetDimmerStateUpdateEvent):void
        {
            ...
            _effectId = _arg_1.effectId;
            _color = _arg_1.color;
            _brightness = _arg_1.brightness;
            ...
            if (!validateBrightness(_brightness, _effectId))
            {
                return;
            };

            _local_2 = new RoomWidgetDimmerPreviewMessage(_color, _brightness, (_effectId == 2));
        ...
        public function storeCurrentSetting(_arg_1:Boolean):void
        {
            ...
            var _local_5:int = _view.selectedType;
            var _local_4:uint = colors[_view.selectedColorIndex];
            var _local_3:int = _view.selectedBrightness;
        ...
        public function previewCurrentSetting():void
        {
            ...
            _local_1 = new RoomWidgetDimmerPreviewMessage(colors[_view.selectedColorIndex], _view.selectedBrightness, (_view.selectedType == 2));
        ...
        public function removePreview():void
        {
            ...
            _local_1 = new RoomWidgetDimmerPreviewMessage(_color, _brightness, (_effectId == 2));
            messageListener.processWidgetMessage(_local_1);
        }
