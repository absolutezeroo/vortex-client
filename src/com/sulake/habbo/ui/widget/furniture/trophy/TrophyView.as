package com.sulake.habbo.ui.widget.furniture.trophy
{
    ...
    public class TrophyView implements ITrophyView 
    {
        ...
        public function showInterface():Boolean
        {
            ...
            var _local_10:IAsset = _widget.assets.getAssetByName("trophy");
            ...
            if (_local_9 != null)
            {
                _local_9.color = BG_COLOR_LIST[_widget.color];
            };
            ...
            if (_local_6 != null)
            {
                _local_6.text = _widget.message.replace(/\\r/g, "\n");
            };
            ...
            if (_local_7 != null)
            {
                _local_7.text = _widget.name;
            };

            _local_5 = (_widget.assets.getAssetByName(BG_IMAGE_LIST[_widget.color]) as BitmapDataAsset);
