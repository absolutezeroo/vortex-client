package com.sulake.habbo.ui.widget.furniture.requirementsmissing
{
    ...
    public class CustomUserNotificationWidget extends RoomWidgetBase 
    {
        ...
        public function CustomUserNotificationWidget(_arg_1:IRoomWidgetHandler, _arg_2:IHabboWindowManager, _arg_3:IAssetLibrary=null)
        {
            ...
            _widgetHandler = CustomUserNotificationWidgetHandler(_arg_1);
            _widgetHandler.widget = this;
        }
        ...
        private function setText(_arg_1:String):void
        {
            ...
            var _local_2:String = _widgetHandler.container.localization.getLocalization(_local_4);
            var _local_3:String = _widgetHandler.container.config.getProperty("respect.talent.show.min.audience");
            ...
            if (_arg_1.type == "WME_CLICK")
            {
                switch (_arg_2.name)
                {
                    case "buy_vip":
                        ...
                        if (((!(_widgetHandler == null)) && (!(_widgetHandler.container == null))))
                        {
                            _widgetHandler.container.catalog.openClubCenter();
                        };

                        close();
                        break;
                    case "vip_benefits":
                        _widgetHandler.container.catalog.showVipBenefits();
                        break;
                    case "buy_costumes":
                        _local_4 = _widgetHandler.container.inventory.getAvatarEffects();
                        _local_5 = false;
                        ...
                        if (_local_5)
                        {
                            _widgetHandler.container.avatarEditor.openEditor(0, null, null, true, null, "effects");
                            _widgetHandler.container.avatarEditor.loadOwnAvatarInEditor(0);
                        }

                        else
                        {
                            _widgetHandler.container.catalog.openCatalogPage("costumes");
                        };
