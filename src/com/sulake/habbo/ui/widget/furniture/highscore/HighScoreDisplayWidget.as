package com.sulake.habbo.ui.widget.furniture.highscore
{
    ...
    public class HighScoreDisplayWidget extends RoomWidgetBase 
    {
        ...
        public function open(_arg_1:int, _arg_2:int, _arg_3:HighScoreStuffData):void
        {
            ...
            {
                _local_6 = IWindowContainer(_entryTemplate.clone());
        ...
        private function createWindow():void
        {
            ...
            _entryTemplate = IWindowContainer(_local_1.findChildByName("entry_template"));
            IItemListWindow(_local_1.findChildByName("entries")).removeListItem(_entryTemplate);
            _bubble = _local_1;
