package com.sulake.habbo.ui.widget.furniture.video
{
    ...
    public class VimeoDisplayWidget extends RoomWidgetBase
    {
        ...
        private function createWindow(_arg_1:Boolean, _arg_2:int):void
        {
            ...
            _player = new VimeoPlayer("9a106b76302cbce891b714afdc6a0c93", _arg_2, _local_3.width, _local_3.height);
            _local_3.setDisplayObject(_player);
            _player.addEventListener("mouseUp", onVideoMouseEvent);
            _player.addEventListener("mouseMove", onVideoMouseEvent);
        }
