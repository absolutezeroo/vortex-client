package com.sulake.habbo.ui.widget.furniture.contextmenu
{
    ...
    public class MonsterPlantSeedConfirmationView implements IDisposable, IGetImageListener 
    {
        ...
        {
            var _local_3:int = _widget.handler.roomSession.roomId;
            var _local_4:IRoomObject = _widget.handler.roomEngine.getRoomObject(_local_3, _arg_1, 10);

            if (_local_4 != null)
            {
                _furnitureData = _widget.handler.getFurniData(_local_4);
                _requestObjectId = _local_4.getId();
            };
            ...
            switch (_furnitureData.category)
            {
                case 19:
                    ...
                    break;
                default:
                    Logger.log(("[PlantSeedConfirmationView.open()] Unsupported furniture category: " + _furnitureData.category));
            };
        ...
        private function setWindowContent(_arg_1:int):void
        {
            ...
            _widget.localizations.registerParameter("useproduct.widget.title.plant_seed", "name", _furnitureData.localizedName);
            ...
            _widget.localizations.registerParameter("useproduct.widget.text.plant_seed", "productName", _furnitureData.localizedName);
            ...
            switch (_arg_1)
            {
                case 0:
                    ...
                    _local_3 = resolvePreviewImage(_furnitureData);
                    break;
                default:
        ...
        private function resolvePreviewImage(_arg_1:IFurnitureData):BitmapData
        {
            ...
            {
                case 19:
                    _local_3 = _widget.handler.roomEngine.getFurnitureImage(_furnitureData.id, new Vector3d(90, 0, 0), 64, this, 0, "", -1, -1, null);
                    break;
                default:
            ...
            if (_local_3 != null)
            {
                _previewCallbackId = _local_3.id;
        ...
        private function onMouseClick(_arg_1:WindowMouseEvent):void
        {
            ...
            switch (_arg_1.target.name)
            {
                ...
                case "ok_button":
                    ...
                    break;
                case "save_button":
                    _local_2 = new RoomWidgetUseProductMessage("RWUPM_MONSTERPLANT_SEED", _requestObjectId);
                    close();
            };
        ...
        public function imageReady(_arg_1:int, _arg_2:BitmapData):void
        {
            ...
            if (_previewCallbackId == _arg_1)
            {
                updatePreviewImage(_arg_2);
                _previewCallbackId = 0;
            };
        }
