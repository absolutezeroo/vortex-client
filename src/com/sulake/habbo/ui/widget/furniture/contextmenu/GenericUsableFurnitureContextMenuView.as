        ...
        override protected function buttonEventProc(_arg_1:WindowEvent, _arg_2:IWindow):void
        {
            ...
            if (_arg_1.type == "WME_CLICK")
            {
                if (_arg_2.name == "button")
                {
                    ...
                    {
                        case "use":
                            _SafeStr_1324.messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage("RWFAM_USE", _SafeStr_4065.getId(), _objectCategory));
                    };
                };
