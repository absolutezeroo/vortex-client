package com.sulake.habbo.ui.widget.furniture.mannequin
{
    ...
    public class MannequinWidget extends RoomWidgetBase 
    {
        ...
        {
            _furniId = _arg_1;
            _mannequinFigure = _arg_2;
            _mannequinGender = _arg_3;
            ...
            _mannequinClubLevel = _local_8.resolveClubLevel(_local_9, _mannequinGender, MANNEQUIN_CLOTHING_PART_TYPES);

            var _local_7:int = resolveFirstWindowContent(_local_11, _local_6.gender, _local_6.clubLevel, _arg_3, _mannequinClubLevel);
        ...
        private function setWindowContent(_arg_1:int):void
        {
            ...
            switch (_arg_1)
            {
                case 0:
                    ...
                    _local_6 = _local_5.createFigureContainer(_mannequinFigure);
                    transformAsMannequinFigure(_local_6);
                    _local_7 = createAvatarImage(_local_6.getFigureString());
                    updateClubLevelView(_mannequinClubLevel);
                ...
                case 2:
                    addClickListener("wear_button");
                    _local_6 = applyMannequinOutfit(_local_4, _mannequinFigure);
                    _local_7 = createAvatarImage(_local_6.getFigureString());
                    updateClubLevelView(_mannequinClubLevel);
                    setOutfitNameState(_local_2);
                    break;
        ...
        {
            handler.container.connection.send(new SetMannequinFigureComposer(_furniId));
        }

        private function saveOutfitName():void
        {
            var _local_1:String = getNameFromView();
            handler.container.connection.send(new SetMannequinNameComposer(_furniId, _local_1));
        ...
        private function onMouseClick(_arg_1:WindowMouseEvent):void
        {
            ...
            switch (_arg_1.target.name)
            {
                ...
                case "wear_button":
                    ...
                    if (_local_2.clubLevel < _mannequinClubLevel)
                    {
                        setWindowContent(3);
                    }
                    ...
                    {
                        if (_local_2.gender.toLowerCase() != _mannequinGender.toLowerCase())
                        {
                            setWindowContent(4);
                        }
                        ...
                        {
                            handler.container.connection.send(new UseFurnitureMessageComposer(_furniId));
                            close();
                        };
                    };
