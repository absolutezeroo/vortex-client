package com.sulake.habbo.ui.widget.chooser
{
    ...
    public class ChooserView 
    {
        ...
        public function populate(_arg_1:Array, _arg_2:Boolean):void
        {
            ...
            var _local_3:XmlAsset = XmlAsset(_widget.assets.getAssetByName("chooser_item"));
            ...
            while (_local_6 < _arg_1.length)
            {
                ...
                if (_local_4 != null)
                {
                    _local_5 = (_widget.windowManager.buildFromXML((_local_3.content as XML)) as IWindowContainer);
        ...
        {
            var _local_1:XmlAsset = XmlAsset(_widget.assets.getAssetByName("chooser_view"));
            ...
            _window = (_widget.windowManager.buildFromXML((_local_1.content as XML)) as IFrameWindow);
        ...
        private function onListItemClicked(_arg_1:WindowMouseEvent):void
        {
            ...
            _widget.choose(_local_2.id, _local_2.category);
        ...
        private function highlightItem(_arg_1:int):void
        {
            ...
            if (((((_itemList == null) || (_arg_1 < 0)) || (_arg_1 > _itemList.numListItems)) || (_arg_1 == _selectedIndex)))
            {
                return;
            };
            ...
            if (_selectedIndex != -1)
            {
                _local_2 = (_itemList.getListItemAt(_selectedIndex) as IWindowContainer);

                if (_local_2 != null)
                {
                    _local_2.color = ((_selectedIndex % 2) ? 0 : 4293848814);
                };
            };
