package com.sulake.habbo.ui.widget.chatinput
{
    ...
    public class RoomChatInputWidget extends RoomWidgetBase 
    {
        ...
        private function onReleaseTimerTick(_arg_1:TimerEvent):void
        {
            if (_visualization != null)
            {
                _visualization.updateBlockText((_releaseTimer.repeatCount - _releaseTimer.currentCount));
            };
        }
        ...
        {
            var _local_1:RoomToolsWidget = (_desktop.getWidget("RWE_ROOM_TOOLS") as RoomToolsWidget);
        ...
        public function onFloodControl(_arg_1:RoomWidgetFloodControlEvent):void
        {
            ...
            {
                _releaseTimer = new Timer(1000, _arg_1.seconds);
                _releaseTimer.addEventListener("timer", onReleaseTimerTick);
                _releaseTimer.addEventListener("timerComplete", onReleaseTimerComplete);
            };
