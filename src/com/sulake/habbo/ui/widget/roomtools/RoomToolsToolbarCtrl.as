package com.sulake.habbo.ui.widget.roomtools
{
    ...
    public class RoomToolsToolbarCtrl extends RoomToolsCtrlBase
    {
        ...
        {
            if (_roomToolsHistory)
            {
                _roomToolsHistory.dispose();
                _roomToolsHistory = null;
            };
        ...
        private function toggleHistory():void
        {
            ...
            {
                _roomToolsHistory = new RoomToolsHistory(_windowManager, _assets, handler);
                _roomToolsHistory.populate(_SafeStr_1324.visitedRooms);
                updatePosition();
            };
        }
        ...
        public function updatePosition():void
        {
            ...
            if (_roomToolsHistory)
            {
                _roomToolsHistory.window.position = new Point((right - _roomToolsHistory.window.width), (_window.position.y - _roomToolsHistory.window.height));
            };
        }
