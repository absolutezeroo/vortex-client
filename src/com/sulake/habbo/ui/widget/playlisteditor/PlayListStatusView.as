package com.sulake.habbo.ui.widget.playlisteditor
{
    ...
    public class PlayListStatusView 
    {
        ...
        {
            if (_currentView != "PLSV_NOW_PLAYING")
            {
                return;
            };

            var _local_2:IWindowContainer = _windows[_currentView];
        ...
        public function set addSongsBackgroundImage(_arg_1:BitmapData):void
        {
            ...
            var _local_2:IWindowContainer = _windows["PLSV_ADD_SONGS"];
        ...
        private function createWindows():void
        {
            ...
            _local_2 = (_widget.assets.getAssetByName("playlisteditor_playlist_subwindow_add_songs") as XmlAsset);
            _local_3 = (_widget.windowManager.buildFromXML((_local_2.content as XML)) as IWindowContainer);

            if (_local_3 != null)
            {
                _windows.add("PLSV_ADD_SONGS", _local_3);
            };

            _local_2 = (_widget.assets.getAssetByName("playlisteditor_playlist_subwindow_play_now") as XmlAsset);
            _local_3 = (_widget.windowManager.buildFromXML((_local_2.content as XML)) as IWindowContainer);

            if (_local_3 != null)
            {
                _windows.add("PLSV_START_PLAYBACK", _local_3);
                _local_4 = (_local_3.getChildByName("play_now_button") as _SafeStr_101);
                _local_4.addEventListener("WME_CLICK", onPlayPauseClicked);
            };

            _local_2 = (_widget.assets.getAssetByName("playlisteditor_playlist_subwindow_nowplaying") as XmlAsset);
            _local_3 = (_widget.windowManager.buildFromXML((_local_2.content as XML)) as IWindowContainer);

            if (_local_3 != null)
            {
                _windows.add("PLSV_NOW_PLAYING", _local_3);
        ...
        {
            _widget.sendTogglePlayPauseStateMessage();
        }
