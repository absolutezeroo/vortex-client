package com.sulake.habbo.ui.widget.roomchat.style
{
    ...
    public class ChatBubbleFactory 
    {
        ...
        public function ChatBubbleFactory(assets:IAssetLibrary, windowManager:IHabboWindowManager, config:XML)
        {
            ...
            for each (var _local_9:XML in config.child("style"))
            {
                _local_4 = _local_9.@id[0];
                _local_5 = _local_9.@assetId[0];
                _local_7 = (("roomchat_styles_" + _local_5) + "_style_xml");
                _local_6 = XML(assets.getAssetByName(_local_7).content);
                try
                {
                    _local_8 = new ChatBubbleStyle(assets, windowManager, _local_6);
