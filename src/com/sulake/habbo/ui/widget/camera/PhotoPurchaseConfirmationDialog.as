package com.sulake.habbo.ui.widget.camera
{
    ...
    internal class PhotoPurchaseConfirmationDialog 
    {
        ...
        public function PhotoPurchaseConfirmationDialog(_arg_1:CameraWidget, _arg_2:String)
        {
            _widget = _arg_1;
            _caption = _arg_2;
            _window = (_widget.getXmlWindow("photo_purchase_confirmation") as IWindowContainer);
        ...
        {
            var _local_3:IPurse = _widget.catalog.getPurse();

            if (_local_3.credits < _arg_1)
            {
                _widget.catalog.showNotEnoughCreditsAlert();
                return (false);
            };

            if (_local_3.getActivityPointsForType(0) < _arg_2)
            {
                _widget.catalog.showNotEnoughActivityPointsAlert(0);
                return (false);
            };
        ...
        private function disableButtons(_arg_1:Boolean):void
        {
            ...
            if (_arg_1)
            {
                _SafeStr_101(_window.findChildByName("cancel_button")).caption = _widget.localizations.getLocalization("generic.close");
                _window.findChildByName("status_info").caption = _widget.localizations.getLocalization("camera.purchase.pleasewait");
            };
        }
        ...
        private function setState(_arg_1:String):void
        {
            ...
            switch (_arg_1)
            {
                ...
                case "image_loaded":
                    ...
                    if (((!(_competitionSubmitted)) && (_local_3)))
                    {
                        _local_3.enable();
                    };
                ...
                case "waiting_purchase_to_complete":
                    ...
                    if (_widget.component.getBoolean("disclaimer.credit_spending.enabled"))
                    {
                        setDisclaimerAccepted(false);
                    };
        ...
        public function animateIconToToolbar():void
        {
            ...
            var _local_3:Number = (_local_6.width / _image.width);
            var _local_5:Matrix = new Matrix(_local_3, 0, 0, _local_3, 0, 0);
            _local_6.draw(_image, _local_5);
            _widget.component.toolbar.createTransitionToIcon(_local_1, _local_6, _local_4.x, _local_4.y);
            _window.findChildByName("status_info").caption = _widget.localizations.getLocalization("camera.purchase.successful");
            _window.findChildByName("buy_button").caption = _widget.localizations.getLocalization("camera.buy.another.button.text");
            _window.findChildByName("inventory_link_area").visible = true;
            _purchaseCount++;
            _window.findChildByName("purchase_count").caption = "";
            _window.findChildByName("purchase_count").caption = _purchaseCount.toString();
        ...
        public function setImageUrl(_arg_1:String):void
        {
            ...
            {
                _arg_1 = (_widget.component.context.configuration.getProperty("stories.image_url_base") + _arg_1);
            ...
            {
                setRenderingFailed();
                _widget.windowManager.alert("${generic.alert.title}", "${camera.render.count.info}", 0, null);
            };
        }
        ...
        private function onImageLoaded(_arg_1:AssetLoaderEvent):void
        {
            ...
            _window.findChildByName("status_info").caption = _widget.localizations.getLocalization("camera.confirm_phase.info");
            setState("image_loaded");
        }
        ...
        public function setRenderingFailed():void
        {
            ...
            if (_local_1 != null)
            {
                _image = new BitmapData(_local_1.width, _local_1.height, false, 0);

                if (_local_1.bitmap == null)
                {
                    _local_1.bitmap = _image;
                }

                else
                {
                    _local_1.bitmap.dispose();
                    _local_1.bitmap.draw(_image);
                };
            };
        ...
        public function publishingStatus(_arg_1:CameraPublishStatusMessageEvent):void
        {
            ...
            {
                _extraDataId = _arg_1.getParser().getExtraDataId();
                _window.findChildByName("status_info").caption = _widget.localizations.getLocalization("camera.publish.successful");
                _window.findChildByName("publish_explanation").caption = _widget.localizations.getLocalization("camera.publish.successful");
                _window.findChildByName("publish_detailed_explanation").caption = _widget.localizations.getLocalization("camera.publish.success.short.info");
                ...
                if (_publishButtonEnablerTimer != null)
                {
                    _publishButtonEnablerTimer.reset();
                };
            }
            ...
            else
            {
                ...
                _local_2 = _widget.localizations.registerParameter("camera.publish.wait", "minutes", _local_3.toString());
                _widget.windowManager.alert("${generic.alert.title}", _local_2, 0, null);
                _window.findChildByName("status_info").caption = "";

                if (_publishButtonEnablerTimer == null)
                {
                    _publishButtonEnablerTimer = new Timer((_local_4 * 1000), 1);
                    _publishButtonEnablerTimer.addEventListener("timerComplete", onPublishTimerComplete);
                }

                else
                {
                    _publishButtonEnablerTimer.reset();
                    _publishButtonEnablerTimer.delay = (_local_4 * 1000);
                };

                _publishButtonEnablerTimer.start();
            };
        ...
        private function onPublishTimerComplete(_arg_1:TimerEvent):void
        {
            ...
            _published = false;
            _publishButtonEnablerTimer = null;

            if (_state == "image_loaded")
            {
        ...
        public function competitionStatus(_arg_1:CompetitionStatusMessageEvent):void
        {
            ...
            if (_arg_1.getParser().isOk())
            {
                _window.findChildByName("status_info").caption = _widget.localizations.getLocalization("camera.competition.submitted.status");
                _window.findChildByName("competition_name").caption = _widget.localizations.getLocalization("camera.competition.submitted.info");
            }
            ...
            else
            {
                ...
                {
                    _window.findChildByName("status_info").caption = _widget.localizations.getLocalization("generic.failed");
                    _window.findChildByName("competition_name").caption = _widget.localizations.getLocalization("camera.competition.limit.info");
                }
                ...
                else
                {
                    ...
                    {
                        _competitionSubmitted = false;
                        _window.findChildByName("status_info").caption = _widget.localizations.getLocalization("generic.failed");
                        _local_2 = _widget.windowManager.confirm("${generic.alert.title}", "${camera.competition.email.not.verified}", (0x10 | 0x20), onEmailVerificationGo);
                        _local_2.setButtonCaption(16, new AlertDialogCaption(_widget.localizations.getLocalization("email.settings"), "", true));
                        _local_2.setButtonCaption(32, new AlertDialogCaption(_widget.localizations.getLocalization("groupforum.settings.cancel"), "", true));
                    };
                };
            };
        ...
        private function onEmailVerificationGo(_arg_1:_SafeStr_126, _arg_2:WindowEvent):void
        {
            ...
            {
                _local_4 = _widget.component.context.configuration.getProperty("email.verification.url");

                if (!StringUtil.isEmpty(_local_4))
                {
                    _local_3 = ((_widget.component.getInteger("spaweb", 0) == 1) ? "" : "_blank");
            ...
            switch (_arg_2.name)
            {
                ...
                case "competition_button":
                    ...
                    if (_state == "image_loaded")
                    {
                        ...
                        _widget.handler.confirmPhotoCompetitionSubmit();
                    };

                    return;
                case "buy_button":

                    if ((((_state == "image_loaded") && (_disclaimerAccepted)) && (checkPurse(_widget.handler.creditPrice, _widget.handler.ducketPrice))))
                    {
                        setState("waiting_purchase_to_complete");
                        _widget.handler.confirmPhotoPurchase();
                    };

                    return;
                case "publish_button":

                    if (((_state == "image_loaded") && (checkPurse(0, _widget.handler.publishDucketPrice))))
                    {
                        setState("waiting_publish_to_complete");
                        _widget.handler.confirmPhotoPublish();
                    };

                    return;
                case "inventory_link":
                    _widget.component.context.createLinkEvent("inventory/open/furni");
                    return;
                case "publish_link":
                    _local_3 = _widget.container.sessionDataManager.userName;
                    _local_4 = ((("/profile/" + _local_3) + "/photo/") + _extraDataId);
                    HabboWebTools.openPage(_local_4);
                    return;
                case "header_button_close":
                case "cancel_button":
                    _widget.startTakingPhoto("photoPurchaseCancel");
                    hide();
                    return;
            };
        }
        ...
        private function setDisclaimerAccepted(_arg_1:Boolean):void
        {
            ...
            _disclaimerAccepted = _arg_1;

            if (((_arg_1) && (_state == "image_loaded")))
            {
                _local_2.enable();
            }
        ...
        public function hide():void
        {
            ...
            if (_publishButtonEnablerTimer != null)
            {
                _publishButtonEnablerTimer.stop();
                _publishButtonEnablerTimer = null;
            };
        }
