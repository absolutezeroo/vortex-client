package com.sulake.habbo.ui.widget.camera
{
    ...
    public class RoomThumbnailCameraWidget extends RoomWidgetBase implements IUpdateReceiver, ILinkEventTracker 
    {
        ...
        public function update(_arg_1:uint):void
        {
            ...
            if (((_window) && (_imageWindow)))
            {
                if (_imageWindow.bitmap == null)
                {
                    _imageWindow.bitmap = new BitmapData(_imageWindow.width, _imageWindow.height, false, 0);
                };

                _imageWindow.bitmap.fillRect(_imageWindow.bitmap.rect, handler.roomDesktop.roomBackgroundColor);
                _local_2 = new Point(0, 0);
                _imageWindow.getGlobalPosition(_local_2);
                _local_3 = new Matrix();
                _local_3.translate(-(_local_2.x), -(_local_2.y));
                _local_4 = container.roomSession;
                roomEngine.snapshotRoomCanvasToBitmap(_local_4.roomId, container.getFirstCanvasId(), _imageWindow.bitmap, _local_3, false);
                _imageWindow.invalidate();
            };
        }
        ...
        private function createWindow():void
        {
            ...
            _window = IFrameWindow(windowManager.buildFromXML(XML(_component.assets.getAssetByName("iro_room_thumbnail_camera_xml").content)));
            _imageWindow = IBitmapWrapperWindow(_window.findChildByName("viewfinder"));
        ...
        public function get viewPort():Rectangle
        {
            ...
            _imageWindow.getGlobalPosition(_local_1);
            return (new Rectangle(_local_1.x, _local_1.y, _imageWindow.width, _imageWindow.height));
        }
