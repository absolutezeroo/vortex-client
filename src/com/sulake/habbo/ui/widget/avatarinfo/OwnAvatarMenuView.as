package com.sulake.habbo.ui.widget.avatarinfo
{
    ...
    public class OwnAvatarMenuView extends AvatarContextInfoButtonView 
    {
        ...
        public function updateButtons():void
        {
            ...
            {
                case 0:
                    showButton("change_name", _data.allowNameChange);
                    showButton("decorate", ((decorateModeSupported()) && ((_data.myRoomControllerLevel >= 1) || (_data.amIOwner))));
                    ...
                    showButton("handitem", (((_data.carryItemType > 0) && (_data.carryItemType < 999999)) && (widget.configuration.getBoolean("handitem.drop.enabled"))));
