package com.sulake.habbo.ui.widget.avatarinfo
{
    ...
    public class OwnPetMenuView extends AvatarContextInfoButtonView 
    {
        ...
        public function updateButtons():void
        {
            ...
            {
                case 0:
                    showButton("respect", (_data.petRespectLeft > 0));
                    showButton("train");
                    showButton("pick_up");
                ...
                case 1:
                    ...
                    if (widget.configuration.getBoolean("sharedhorseriding.enabled"))
                    {
                        ...
                        enableCheckbox("toggle_riding_permission", ((_data != null) ? (_data.accessRights == 1) : false));
                    };
                ...
                case 3:
                    ...
                    {
                        _local_2 = (_data.energy as Number);
                        _local_7 = (_data.energyMax as Number);
                        showButton("treat", true, ((_local_2 / _local_7) < 0.98));

                        if (_data.level == _data.levelMax)
                        {
                            if (_data.canBreed)
                            {
                                showButton("toggle_breeding_permission");
                                enableCheckbox("toggle_breeding_permission", _data.hasBreedingPermission);
                                showButton("breed");
                            };
                        };
                    };
            ...
            widget.localizations.registerParameter("infostand.button.petrespect", "count", _data.petRespectLeft.toString());
        ...
        override protected function buttonEventProc(_arg_1:WindowEvent, _arg_2:IWindow):void
        {
            ...
            if (_arg_1.type == "WME_CLICK")
            {
                if (_arg_2.name == "button")
                {
                    ...
                    {
                        case "respect":
                            _data.petRespectLeft = (_data.petRespectLeft - 1);
                            updateButtons();
                        ...
                        case "breed":
                            ...
                            if (_SafeStr_1493 == 0)
                            {
                                ...
                                _local_8 = new RoomWidgetPetCommandMessage("RWPCM_PET_COMMAND", _data.id, ((_data.name + " ") + _local_4));
                            }
