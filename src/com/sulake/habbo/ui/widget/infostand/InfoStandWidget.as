package com.sulake.habbo.ui.widget.infostand
{
    ...
    public class InfoStandWidget extends RoomWidgetBase 
    {
        ...
        public function getXmlWindow(name:String):IWindow
        {
            ...
            try
            {
                _local_4 = assets.getAssetByName(name);
        ...
        override public function registerUpdateEvents(eventDispatcher:IEventDispatcher):void
        {
            ...
            eventDispatcher.addEventListener("RWROUE_OBJECT_SELECTED", onRoomObjectSelected);
            eventDispatcher.addEventListener("RWROUE_OBJECT_DESELECTED", onClose);
            eventDispatcher.addEventListener("RWROUE_USER_REMOVED", onRoomObjectRemoved);
            eventDispatcher.addEventListener("RWROUE_FURNI_REMOVED", onRoomObjectRemoved);
            eventDispatcher.addEventListener("RWUIUE_OWN_USER", onUserInfo);
            eventDispatcher.addEventListener("RWUIUE_PEER", onUserInfo);
            eventDispatcher.addEventListener("RWUIUE_BOT", onBotInfo);
            eventDispatcher.addEventListener("RWFIUE_FURNI", onFurniInfo);
            eventDispatcher.addEventListener("RWRBIUE_RENTABLE_BOT", onRentableBotInfo);
            eventDispatcher.addEventListener("RWPIUE_PET_INFO", onPetInfo);
            eventDispatcher.addEventListener("RWPCUE_PET_COMMANDS", onPetCommands);
            eventDispatcher.addEventListener("RWPCUE_OPEN_PET_TRAINING", onOpenPetTraining);
            eventDispatcher.addEventListener("RWPCUE_CLOSE_PET_TRAINING", onClosePetTraining);
            eventDispatcher.addEventListener("RWSUE_PLAYING_CHANGED", onSongUpdate);
            eventDispatcher.addEventListener("RWSUE_DATA_RECEIVED", onSongUpdate);
            eventDispatcher.addEventListener("RWPIUE_PET_FIGURE_UPDATE", onPetFigureUpdate);
        ...
        override public function unregisterUpdateEvents(eventDispatcher:IEventDispatcher):void
        {
            ...
            eventDispatcher.removeEventListener("RWROUE_OBJECT_SELECTED", onRoomObjectSelected);
            eventDispatcher.removeEventListener("RWROUE_OBJECT_DESELECTED", onClose);
            eventDispatcher.removeEventListener("RWROUE_USER_REMOVED", onRoomObjectRemoved);
            eventDispatcher.removeEventListener("RWROUE_FURNI_REMOVED", onRoomObjectRemoved);
            eventDispatcher.removeEventListener("RWUIUE_OWN_USER", onUserInfo);
            eventDispatcher.removeEventListener("RWUIUE_PEER", onUserInfo);
            eventDispatcher.removeEventListener("RWUIUE_BOT", onBotInfo);
            eventDispatcher.removeEventListener("RWFIUE_FURNI", onFurniInfo);
            eventDispatcher.removeEventListener("RWPIUE_PET_INFO", onPetInfo);
            eventDispatcher.removeEventListener("RWPCUE_PET_COMMANDS", onPetCommands);
            eventDispatcher.removeEventListener("RWPCUE_OPEN_PET_TRAINING", onOpenPetTraining);
            eventDispatcher.removeEventListener("RWPCUE_CLOSE_PET_TRAINING", onClosePetTraining);
            eventDispatcher.removeEventListener("RWSUE_PLAYING_CHANGED", onSongUpdate);
            eventDispatcher.removeEventListener("RWSUE_DATA_RECEIVED", onSongUpdate);
            eventDispatcher.removeEventListener("RWPIUE_PET_FIGURE_UPDATE", onPetFigureUpdate);
        }
