package com.sulake.habbo.ui.widget.crafting.controller
{
    ...
    public class CraftingInfoController implements IGetImageListener 
    {
        ...
        {
            _widget = _arg_1;
            _progressBar = new CraftingProgressBarController(_arg_1);
        }
        ...
        public function setState(_arg_1:int, ... _args):void
        {
            ...
            var _local_3:IHabboLocalizationManager = _widget.handler.container.localization;
            switch (_arg_1)
            {
                case 0:
        ...
        private function requestIconFromRoomEngine(_arg_1:IFurnitureData):void
        {
            ...
            {
                case "s":
                    _local_2 = _widget.handler.container.roomEngine.getFurnitureIcon(_arg_1.id, this);
                    break;
                case "i":
                    _local_2 = _widget.handler.container.roomEngine.getWallItemIcon(_arg_1.id, this);
            };
        ...
        {
            _widget.handler.craftingInProgress = true;
            setButtonVisible(false);
            _progressBar.show();
        }
        ...
        {
            _widget.handler.craftingInProgress = false;
            _progressBar.hide();
            setButtonVisible(true);
        }
