package com.sulake.habbo.session
{
    ...
    public class UserDataManager implements IUserDataManager 
    {
        ...
        {
            _userDataByType = new Map();
            _userDataByRoomIndex = new Map();
            _userBadges = new Map();
        }
        ...
        {
            _connection = null;
            _userDataByType.dispose();
            _userDataByType = null;
            _userDataByRoomIndex.dispose();
            _userDataByRoomIndex = null;
            _userBadges.dispose();
            _userBadges = null;
        }
        ...
        public function getUserDataByType(_arg_1:int, _arg_2:int):IUserData
        {
            ...
            var _local_4:Map = _userDataByType.getValue(_arg_2);
        ...
        {
            return (_userDataByRoomIndex.getValue(_arg_1));
        }

        public function getUserDataByName(_arg_1:String):IUserData
        {
            for each (var _local_2:IUserData in _userDataByRoomIndex)
            {
        ...
        public function getUserBadges(_arg_1:int):Array
        {
            ...
            var _local_2:Array = (_userBadges.getValue(_arg_1) as Array);
        ...
        public function setUserData(_arg_1:IUserData):void
        {
            ...
            var _local_2:Map = _userDataByType.getValue(_arg_1.type);

            if (_local_2 == null)
            {
                _local_2 = new Map();
                _userDataByType.add(_arg_1.type, _local_2);
            };

            _local_2.add(_arg_1.webID, _arg_1);
            _userDataByRoomIndex.add(_arg_1.roomObjectId, _arg_1);
        }
        ...
        public function removeUserDataByRoomIndex(_arg_1:int):void
        {
            var _local_4:Map;
            var _local_3:IUserData;
            var _local_2:IUserData = _userDataByRoomIndex.remove(_arg_1);

            if (_local_2 != null)
            {
                _local_4 = _userDataByType.getValue(_local_2.type);
        ...
        {
            _userBadges.remove(_arg_1);
            _userBadges.add(_arg_1, _arg_2);
        }
        ...
        public function getAllUserIds():Array
        {
            ...
            for each (var _local_1:IUserData in _userDataByRoomIndex)
            {
