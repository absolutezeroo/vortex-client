package com.sulake.habbo.session.furniture
{
    ...
    public class FurnitureDataParser extends EventDispatcherWrapper 
    {
        ...
        public function FurnitureDataParser(_arg_1:Map, _arg_2:Map, _arg_3:Map, _arg_4:ICoreLocalizationManager)
        {
            ...
            _assetLib = new AssetLibrary("FurniDataParserAssetLib");
        }
        ...
        public function loadData(_arg_1:String, _arg_2:String=null, _arg_3:String=null):void
        {
            ...
            if (((_arg_2) && (_arg_3)))
            {
                _local_4 = _assetLib.loadAssetFromFile("furnidata", new URLRequest(_arg_1), "text/plain", ("furnidata_" + _arg_3.toLowerCase()), _arg_2);
            }

            else
            {
                _local_4 = _assetLib.loadAssetFromFile("furnidata", new URLRequest(_arg_1), "text/plain");
            };
        ...
        private function storeItem(_arg_1:FurnitureData):void
        {
            ...
            var _local_2:Array = _itemIds[_arg_1.className];

            if (_local_2 == null)
            {
                _local_2 = [];
                _itemIds.add(_arg_1.className, _local_2);
            };
