package com.sulake.habbo.session
{
    ...
    public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener 
    {
        ...
        {
            return ((allRequiredDependenciesInjected) && (_roomEngineReady));
        }
        ...
        override public function dispose():void
        {
            ...
            if (_sessions)
            {
                ...
                {
                    _local_4 = (_sessions.getKey(0) as String);
                    _local_2 = (_sessions.remove(_local_4) as RoomSession);
        ...
        {
            if (((initialized) && (!(_pendingSessionRequest == null))))
            {
                createSession(_pendingSessionRequest);
                _pendingSessionRequest = null;
            };
        }
        ...
        private function onRoomVisualizationSettings(_arg_1:RoomVisualizationSettingsEvent):void
        {
            ...
            if (((_gotVisualisations) || (!(_roomViewerMode))))
            {
                return;
            };

            _gotVisualisations = true;
        ...
        private function createSession(_arg_1:RoomSession):Boolean
        {
            if (!initialized)
            {
                Logger.log(((("[RoomSessionManager] Not initialized, crating pending session for room: " + _arg_1.roomId) + ". Room Engine Initialized: ") + _roomEngineReady));
                _pendingSessionRequest = _arg_1;
                return (false);
            };
        ...
        private function onRoomContentLoaded(_arg_1:Event):void
        {
            ...
            var _local_2:int = _pendingResources.indexOf(_arg_1["contentType"]);

            if (_local_2 != -1)
            {
                _pendingResources.splice(_local_2, 1);
            };
        ...
        public function startGameSession():void
        {
            ...
            _sessions.add(getRoomIdentifier(_local_1.roomId), _local_1);
        ...
        public function disposeGameSession():void
        {
            ...
            var _local_1:RoomSession = _sessions.getValue(_local_2);
        ...
        public function sessionReinitialize(_arg_1:int, _arg_2:int):void
        {
            ...
            var _local_3:RoomSession = (_sessions.remove(_local_5) as RoomSession);

            if (_local_3 != null)
            {
                _local_3.reset(_arg_2);
                _local_5 = getRoomIdentifier(_arg_2);
                _local_4 = _sessions.remove(_local_5);

                if (_local_4 != null)
                {
                };

                _sessions.add(_local_5, _local_3);
        ...
        public function getSession(_arg_1:int):IRoomSession
        {
            ...
            return (_sessions.getValue(_local_2) as IRoomSession);
        }

        public function disposeSession(_arg_1:int, _arg_2:Boolean=true):void
        {
            var _local_4:String = getRoomIdentifier(_arg_1);
            var _local_3:RoomSession = (_sessions.remove(_local_4) as RoomSession);
