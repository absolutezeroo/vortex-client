package com.sulake.habbo.session.product
{
    ...
    public class ProductDataParser extends EventDispatcherWrapper 
    {
        ...
        public function ProductDataParser(_arg_1:String, _arg_2:Dictionary, _arg_3:String=null, _arg_4:String=null)
        {
            ...
            _products = _arg_2;
            _assetLib = new AssetLibrary("ProductDataParserAssetLib");

            if (((_arg_3) && (_arg_4)))
            {
                _local_5 = _assetLib.loadAssetFromFile("productdata", new URLRequest(_arg_1), "text/plain", ("productdata_" + _arg_4.toLowerCase()), _arg_3);
            }

            else
            {
                _local_5 = _assetLib.loadAssetFromFile("productdata", new URLRequest(_arg_1), "text/plain");
            };
