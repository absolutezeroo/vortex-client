package com.sulake.habbo.session
{
    ...
    public class IgnoredUsersManager implements IDisposable 
    {
        ...
        public function IgnoredUsersManager(_arg_1:SessionDataManager)
        {
            ...
            {
                _ignoreResultMessageEvent = _sessionDataManager.communication.addHabboConnectionMessageEvent(new IgnoreResultMessageEvent(onIgnoreResult));
                _ignoredUsersMessageEvent = _sessionDataManager.communication.addHabboConnectionMessageEvent(new IgnoredUsersMessageEvent(onIgnoreList));
            };
        }
        ...
        public function dispose():void
        {
            ...
            if (_sessionDataManager.communication)
            {
                _sessionDataManager.communication.removeHabboConnectionMessageEvent(_ignoreResultMessageEvent);
                _sessionDataManager.communication.removeHabboConnectionMessageEvent(_ignoredUsersMessageEvent);
            };

            _ignoreResultMessageEvent = null;
            _ignoredUsersMessageEvent = null;
