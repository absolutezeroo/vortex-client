package com.sulake.habbo.toolbar
{
    ...
    public class ToolbarView implements ILinkEventTracker 
    {
        ...
        public function ToolbarView(toolbar:HabboToolbar, windowManager:IHabboWindowManager, assetLibrary:IAssetLibrary, eventDispatcher:IEventDispatcher, sessionDataManager:ISessionDataManager)
        {
            ...
            var _local_13:XmlAsset = (assetLibrary.getAssetByName("toolbar_view_xml") as XmlAsset);
            _window = (windowManager.buildFromXML((_local_13.content as XML), 2) as IWindowContainer);
            ...
            var _local_12:Boolean = toolbar.getBoolean("games_icon_enabled");
            ...
            var _local_10:XmlAsset = (assetLibrary.getAssetByName("new_items_label_xml") as XmlAsset);
            _newItemsNotification = (windowManager.buildFromXML((_local_10.content as XML), 2) as IWindowContainer);
            ...
            var _local_6:ILocalization = toolbar.localization.getLocalizationRaw("toolbar.new_additions.notification");
