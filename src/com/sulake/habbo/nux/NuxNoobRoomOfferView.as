package com.sulake.habbo.nux
{
    ...
    public class NuxNoobRoomOfferView 
    {
        ...
        private function show():void
        {
            ...
            var _local_3:XmlAsset = (_component.assets.getAssetByName("nux_noob_room_offer_xml") as XmlAsset);
            _frame = (_component.windowManager.buildFromXML((_local_3.content as XML)) as IFrameWindow);
        ...
        {
            _component.context.createLinkEvent("navigator/goto/predefined_noob_lobby");
        }

        private function onClose(_arg_1:WindowMouseEvent):void
        {
            _component.destroyNoobRoomOfferView();
        }
