package com.sulake.habbo.window.theme
{
    ...
    public class ThemeManager implements IThemeManager 
    {
        ...
        public function ThemeManager(_arg_1:SkinContainer):void
        {
            ...
            _themes["None"] = new Theme("None", false, 0, 0xFFFFFFFF, _local_5);

            var _local_4:int;

            while (_skinContainer.skinRendererExists(1, _local_4))
            {
                _local_4++;
            };

            _themes["Icon"] = new Theme("Icon", false, 0, _local_4, _local_5);

            var _local_2:int;

            while (((_skinContainer.skinRendererExists(30, _local_2)) && (_local_2 < 100)))
            {
                _local_2++;
            };

            _themes["Legacy border"] = new Theme("Legacy border", false, 0, _local_2, _local_5);
            _themes["Volter"] = new Theme("Volter", true, 0, 3, _local_5.clone());
            ...
            _themes["Ubuntu"] = new Theme("Ubuntu", true, 3, 5, _local_3);
            _local_3 = _local_5.clone();
            _local_3.addEnumeration("antialias_type", "advanced", ["normal", "advanced"]);
            ...
            _themes["Illumina Light"] = new Theme("Illumina Light", true, 100, 100, _local_3);
            ...
            _themes["Illumina Dark"] = new Theme("Illumina Dark", true, 200, 100, _local_3);
        }
        ...
        public function getStyle(_arg_1:String, _arg_2:uint, _arg_3:String):uint
        {
            ...
            var _local_5:Theme = _themes[_arg_1];
            ...
            while (_local_4 < _local_5.styleCount)
            {
                ...
                if (_arg_3 == _skinContainer.getIntentByTypeAndStyle(_arg_2, _local_6))
                {
                    return (_local_6);
                };
        ...
        {
            var _local_4:String = _skinContainer.getIntentByTypeAndStyle(_arg_1, _arg_2);
            ...
            for each (var _local_3:Theme in _themes)
            {
        ...
        public function getIntents(_arg_1:uint, _arg_2:String, _arg_3:uint):Array
        {
            ...
            if (_arg_2 != "None")
            {
                _local_6 = _themes[_arg_2];
                _local_5 = 0;

                while (_local_5 < _local_6.styleCount)
                {
                    _local_7 = _skinContainer.getIntentByTypeAndStyle(_arg_1, (_local_6.baseStyle + _local_5));
