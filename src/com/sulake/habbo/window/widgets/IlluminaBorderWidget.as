package com.sulake.habbo.window.widgets
{
    ...
    public class IlluminaBorderWidget implements IIlluminaBorderWidget
    {
        ...
        public function IlluminaBorderWidget(_arg_1:IWidgetWindow, _arg_2:HabboWindowManagerComponent)
        {
            ...
            _root = (_windowManager.buildFromXML((_windowManager.assets.getAssetByName("illumina_border_xml").content as XML)) as IWindowContainer);
            _canvas = (_root.getChildByName("canvas") as IBitmapWrapperWindow);
            _children = (_root.getChildByName("children") as IWindowContainer);
            borderStyle = String(_widgetWindow.getDefaultProperty("illumina_border:border_style").value);
        ...
        public function dispose():void
        {
            if (!_disposed)
            {
                ...
                if (_canvas != null)
                {
                    _canvas.removeEventListener("WE_RESIZE", onChange);
                    _canvas.removeEventListener("WE_RESIZED", onChange);
                    _canvas = null;
                };
        ...
        public function get properties():Array
        {
            ...
            _local_1.push(_widgetWindow.createProperty("illumina_border:border_style", _borderStyle));
        ...
        public function set borderStyle(_arg_1:String):void
        {
            ...
            {
                _borderPieces[_local_2] = _windowManager.assets.getAssetByName(((_borderStyle + "_border_") + _local_2));
            };
        ...
        private function refresh():void
        {
            ...
            if ((((_settingProperties) || (_resizingWidget)) || (disposed)))
            {
                return;
            };

            _root.limits.setEmpty();
            _root.width = _widgetWindow.width;
            _root.height = _widgetWindow.height;
            ...
            if (_local_2 != null)
            {
                ...
                {
                    _root.limits.minWidth = _local_3;
                    _root.limits.minHeight = _local_9;
                };
                ...
                if (_widgetWindow.testParamFlag(147456))
                {
                    _root.limits.minWidth = _local_3;
                    _root.limits.minHeight = _local_9;
                    _root.limits.maxWidth = _local_3;
                    _root.limits.maxHeight = _local_9;
                };

                _resizingWidget = false;
            };

            if ((((_drawBuffer == null) || (!(_drawBuffer.width == _root.width))) || (!(_drawBuffer.height == _root.height))))
            {
                _canvas.width = _root.width;
                _canvas.height = _root.height;
                _children.width = _root.width;
                _children.height = _root.height;
                ...
                _drawBuffer = new BitmapData(_canvas.width, _canvas.height, true, 0);
                _canvas.bitmap = _drawBuffer;
            };

            var _local_12:Rectangle = _canvas.rectangle;
            _local_12.y = (_local_12.y + topPadding);
            _local_12.height = (_local_12.height - (topPadding + bottomPadding));
            _drawBuffer.lock();
            _drawBuffer.fillRect(new Rectangle(0, 0, _canvas.width, _canvas.height), 0);
            _loop_1:

            for (var _local_5:String in _borderPieces)
            {
                ...
                if (!((_local_10 == null) || ((_landingViewMode) && (((_local_5 == "top_left") || (_local_5 == "center_left")) || (_local_5 == "bottom_left")))))
                {
                    ...
                    _drawBuffer.draw(_local_6, MATRIX, null, null, _local_4, false);
                };
            };
            ...
            for each (var _local_7:IWindow in _children.iterator)
            {
                if (((!(_local_7.name == null)) && (_local_7.name.length > 0)))
                {
                    ...
                    else
                    {
                        ...
                        {
                            case 0:
                                _local_7.x = Math.min(_sidePadding, (_canvas.width - _local_7.width));
                                break;
                            case 1:
                                _local_7.x = (Math.max((_canvas.width - _local_7.width), 0) / 2);
                                break;
                            case 2:
                                _local_7.x = Math.max(((_canvas.width - _local_7.width) - _sidePadding), 0);
                        };
                        ...
                        {
                            _local_7.y = (_canvas.height - (bottomPadding + (_local_7.height / 2)));
                        };

                        _local_7.visible = true;
                        _drawBuffer.fillRect(new Rectangle((_local_7.x - _childMargin), _local_7.y, (_local_7.width + (_childMargin * 2)), _local_7.height), 0);
                    };
                }
