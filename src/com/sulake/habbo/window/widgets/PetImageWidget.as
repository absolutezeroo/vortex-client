package com.sulake.habbo.window.widgets
{
    ...
    public class PetImageWidget implements IPetImageWidget, IGetImageListener
    {
        ...
        public function PetImageWidget(_arg_1:IWidgetWindow, _arg_2:HabboWindowManagerComponent)
        {
            ...
            _root = (_windowManager.buildFromXML((_windowManager.assets.getAssetByName("pet_image_xml").content as XML)) as IWindowContainer);
        ...
        private function refresh():void
        {
            ...
            if (_windowManager.roomEngine != null)
            {
                ...
                if (_local_2 != null)
                {
                    ...
                    _imageCallbackIds.remove(_local_5);

                    if (_local_5 > 0)
                    {
                        _imageCallbackIds.add(_local_5, _figure);
                    };
