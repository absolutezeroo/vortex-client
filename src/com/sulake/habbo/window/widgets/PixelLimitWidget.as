package com.sulake.habbo.window.widgets
{
    ...
    public class PixelLimitWidget implements IPixelLimitWidget
    {
        ...
        public function PixelLimitWidget(_arg_1:IWidgetWindow, _arg_2:HabboWindowManagerComponent)
        {
            ...
            _root = (_windowManager.buildFromXML((_windowManager.assets.getAssetByName("badge_image_xml").content as XML)) as IWindowContainer);
            _bitmap = (_root.findChildByName("bitmap") as IStaticBitmapWrapperWindow);
