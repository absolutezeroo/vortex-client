package com.sulake.habbo.window.widgets
{
    ...
    public class CountdownWidget implements ICountdownWidget, IUpdateReceiver
    {
        ...
        public function CountdownWidget(_arg_1:IWidgetWindow, _arg_2:HabboWindowManagerComponent)
        {
            ...
            _root = (_windowManager.buildFromXML((_windowManager.assets.getAssetByName("clock_base_xml").content as XML)) as IItemListWindow);
            _digitWindow = (_root.getListItemByName("counter") as IWindowContainer);
            _separatorWindow = (_root.getListItemByName("separator") as ITextWindow);
        ...
        public function dispose():void
        {
            if (!_disposed)
            {
                ...
                if (_digitWindow != null)
                {
                    _digitWindow.dispose();
                    _digitWindow = null;
                };

                if (_separatorWindow != null)
                {
                    _separatorWindow.dispose();
                    _separatorWindow = null;
                };
        ...
        public function set colorStyle(_arg_1:int):void
        {
            ...
            var _local_4:int = _root.numListItems;
            _local_3 = 0;

            while (_local_3 < _local_4)
            {
                _local_2 = (_root.getListItemAt(_local_3) as IWindowContainer);
        ...
        public function set digits(_arg_1:uint):void
        {
            ...
            if (_arg_1 != digits)
            {
                ...
                while (_local_2 < _arg_1)
                {
                    if (_local_2 != 0)
                    {
                        _root.addListItem(_separatorWindow.clone());
                    };

                    _root.addListItem(_digitWindow.clone());
                    _local_2++;
                };
        ...
        private function updateTime(_arg_1:Boolean=false):void
        {
            ...
            while (_local_5 < _local_4)
            {
                ...
                _local_3 = (_root.getListItemAt((_local_5 * 2)) as IWindowContainer);
