package com.sulake.habbo.quest
{
    ...
    public class RoomCompetitionController implements IDisposable, IGetImageListener 
    {
        ...
        private var _requiredFurniIndexByCallbackId:Map = new Map();
        ...
        public function dispose():void
        {
            ...
            if (_requiredFurniIndexByCallbackId)
            {
                _requiredFurniIndexByCallbackId.dispose();
                _requiredFurniIndexByCallbackId = null;
            };
        }
        ...
        private function setText(_arg_1:IWindow, _arg_2:String, _arg_3:String):void
        {
            ...
            else
            {
                ...
                _questEngine.localization.registerParameter(_local_5, "votes", ("" + _remainingVotes));
        ...
        {
            _remainingVotes = _arg_1.getParser().votesRemaining;
            ...
            getActionButton().visible = ((_remainingVotes > 0) && (_local_2));
        ...
        public function onCompetitionEntrySubmitResult(_arg_1:CompetitionEntrySubmitResultMessageEvent):void
        {
            ...
            _result = _arg_1.getParser().result;
        ...
        private function refreshRequiredFurnis(_arg_1:CompetitionEntrySubmitResultMessageEvent):void
        {
            ...
            while (_local_3 < _local_9.length)
            {
                ...
                else
                {
                    ...
                    if (_local_2.id != 0)
                    {
                        _requiredFurniIndexByCallbackId.add(_local_2.id, _local_3);
                    };
        ...
        {
            if (_requiredFurniIndexByCallbackId.getValue(_arg_1) != null)
            {
                setRequiredFurniImage(_requiredFurniIndexByCallbackId.getValue(_arg_1), _arg_2);
                _requiredFurniIndexByCallbackId.remove(_arg_1);
            };
        }
        ...
        {
            var _local_1:String = (("roomcompetition." + _goalCode) + ".name");
