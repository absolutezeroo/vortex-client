package com.sulake.habbo.quest
{
    ...
    public class AchievementCategories 
    {
        ...
        private var _categoryMap:Dictionary = new Dictionary();
        ...
        public function AchievementCategories(_arg_1:Array)
        {
            ...
            for each (var _local_3:AchievementData in _arg_1)
            {
                if (_local_3.category != "")
                {
                    if (_local_3.state == 2)
                    {
                        _local_5 = _categoryMap["archive"];
                    }

                    else
                    {
                        _local_5 = _categoryMap[_local_3.category];
                    };

                    if (_local_5 == null)
                    {
                        _local_5 = new AchievementCategory(_local_3.category);
                        _categoryMap[_local_3.category] = _local_5;
        ...
        public function update(_arg_1:AchievementData):void
        {
            ...
            var _local_2:AchievementCategory = _categoryMap[_arg_1.category];
