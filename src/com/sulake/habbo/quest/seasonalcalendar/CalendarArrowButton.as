package com.sulake.habbo.quest.seasonalcalendar
{
    ...
    public class CalendarArrowButton 
    {
        ...
        public function CalendarArrowButton(_arg_1:IAssetLibrary, _arg_2:IBitmapWrapperWindow, _arg_3:int, _arg_4:Function)
        {
            ...
            {
                case 0:
                    _bitmapActive = BitmapData(_arg_1.getAssetByName("arrow_back_active").content).clone();
                    _bitmapInactive = BitmapData(_arg_1.getAssetByName("arrow_back_inactive").content).clone();
                    _bitmapHilite = BitmapData(_arg_1.getAssetByName("arrow_back_hilite").content).clone();
                    break;
                case 1:
                    _bitmapActive = BitmapData(_arg_1.getAssetByName("arrow_next_active").content).clone();
                    _bitmapInactive = BitmapData(_arg_1.getAssetByName("arrow_next_inactive").content).clone();
                    _bitmapHilite = BitmapData(_arg_1.getAssetByName("arrow_next_hilite").content).clone();
                default:
            };
        ...
        private function updateWindow():void
        {
            ...
            {
                case 0:
                    _window.bitmap = _bitmapInactive;
                    break;
                case 2:
                    _window.bitmap = _bitmapHilite;
                    break;
                case 1:
                    _window.bitmap = _bitmapActive;
                default:
            };
