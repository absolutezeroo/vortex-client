package com.sulake.habbo.quest.seasonalcalendar
{
    ...
    public class CalendarBackgroundRenderer implements IDisposable 
    {
        ...
        public function getSlice(_arg_1:int, _arg_2:int):BitmapData
        {
            ...
            var _local_8:BitmapData = new BitmapData(_arg_2, _images[0].height, false, 0);
            var _local_3:int;
        ...
        public function getImageIndexForOffset(_arg_1:int):int
        {
            ...
            while (_local_3 < _images.length)
            {
                if (((_local_2 <= _arg_1) && (_arg_1 < (_local_2 + _images[_local_3].width))))
                {
                    return (_local_3);
                };

                _local_2 = (_local_2 + _images[_local_3].width);
                _local_3++;
            };
