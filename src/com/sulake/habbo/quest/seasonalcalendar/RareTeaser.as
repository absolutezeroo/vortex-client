package com.sulake.habbo.quest.seasonalcalendar
{
    ...
    public class RareTeaser implements IDisposable
    {
        ...
        {
            var _local_2:int;
            _unlockDays = parseInts("quests.seasonalcalendar.rareteaser.days");
            _furniPicks = parseStrings("quests.seasonalcalendar.rareteaser.images");
            ...
            while (_local_2 <= _unlockDays.length)
            {
                getFurniPic(_local_2).assetUri = ((_questEngine.questController.seasonalCalendarWindow.getCalendarImageGalleryHost() + _furniPicks[(_local_2 - 1)]) + ".png");
                _local_2++;
            };
        ...
        public function refresh():void
        {
            ...
            while (_local_3 <= _unlockDays.length)
            {
                _local_4 = (_unlockDays[(_local_3 - 1)] > _local_1);
                ...
                {
                    _local_2 = (_unlockDays[(_local_3 - 1)] - _local_1);
                };
        ...
        {
            if (((_arg_1.type == "WME_CLICK") && (!(_pages[_arg_2] == null))))
            {
                _questEngine.catalog.openCatalogPage(_pages[_arg_2]);
            };
        }
