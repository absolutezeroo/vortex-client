package com.sulake.habbo.quest
{
    ...
    public class ProgressBar implements IDisposable 
    {
        ...
        {
            var _local_5:Boolean = ((!(_arg_3 == _parentId)) || (!(_arg_2 == _maxAmount)));
            _maxAmount = _arg_2;
            _currentAmount = _arg_1;
            _startProgressWidth = _currentProgressWidth;
            _parentId = _arg_3;
            _scoreAtStartOfLevel = _arg_4;
        ...
        public function updateView():void
        {
            ...
            _update = (_currentProgressWidth < _local_1);

            var _local_4:IWindow = _window.findChildByName("progress_txt");
            var _local_2:int = ((_update) ? Math.round(((_currentProgressWidth / _progressBarWidth) * _maxAmount)) : _currentAmount);
            _questEngine.localization.registerParameter(_progressKey, "progress", ("" + (_local_2 + _scoreAtStartOfLevel)));
            _questEngine.localization.registerParameter(_progressKey, "limit", ("" + (_maxAmount + _scoreAtStartOfLevel)));
