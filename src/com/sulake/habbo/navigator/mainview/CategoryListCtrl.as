package com.sulake.habbo.navigator.mainview
{
    ...
    public class CategoryListCtrl implements IViewCtrl 
    {
        ...
        public function refresh():void
        {
            ...
            var _local_9:IWindowContainer = IWindowContainer(_list.getListItemAt(0));
            _local_4 = 0;
        ...
        public function refreshEntry(_arg_1:IWindowContainer, _arg_2:FlatCategory, _arg_3:int, _arg_4:int):void
        {
            ...
            _userCountRenderer.refreshUserCount(_arg_4, IWindowContainer(_arg_1.findChildByName("enter_category_button")), _arg_3, "${navigator.usercounttooltip.users}", 297, 35);
        }
        ...
        {
            _content = _arg_1;
            _list = ((_content) ? IItemListWindow(_content.findChildByName("item_list_category")) : null);
            _scrollV = ((_content) ? IScrollbarWindow(_content.findChildByName("scroller")) : null);
        }
