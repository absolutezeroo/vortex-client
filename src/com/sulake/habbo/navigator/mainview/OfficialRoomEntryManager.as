    ...
    public class OfficialRoomEntryManager implements IDisposable 
    {
        ...
        private function refreshUserCount(_arg_1:IWindowContainer, _arg_2:OfficialRoomEntryData):void
        {
            ...
            if (((_arg_2.showDetails) && (_arg_2.type == 2)))
            {
                ...
                _local_3 = 34;
                _local_5 = 13;
                _userCountRenderer.refreshUserCount(_arg_2.maxUsers, _arg_1, _arg_2.userCount, "${navigator.usercounttooltip.users}", ((_arg_1.width - _local_4) - _local_3), ((_arg_1.height - _local_4) - _local_5));
            };
        }
