package com.sulake.habbo.navigator.mainview
{
    ...
    public class OfficialRoomListCtrl implements IViewCtrl 
    {
        ...
        {
            _navigator = _arg_1;
            _promotedRoomsListCtrl = new PromotedRoomsListCtrl(_navigator);
        }

        public function dispose():void
        {
            if (_promotedRoomsListCtrl != null)
            {
                _promotedRoomsListCtrl.dispose();
                _promotedRoomsListCtrl = null;
            };
        }
        ...
        {
            _content = _arg_1;
            _list = ((_content) ? IItemListWindow(_content.findChildByName("item_list_official")) : null);
        }
        ...
        public function refresh():void
        {
            ...
            while (true)
            {
                ...
                _local_3 = IWindowContainer(_list.getListItemAt((_local_4 + 1)));
        ...
        {
            var _local_1:IWindowContainer = IWindowContainer(_list.getListItemAt(0));
            _promotedRoomsListCtrl.refresh(_local_1, _navigator.data.promotedRooms.entries);
        }
