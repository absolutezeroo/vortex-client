package com.sulake.habbo.navigator.mainview
{
    ...
    public class PopularTagsListCtrl implements IViewCtrl 
    {
        ...
        {
            _navigator = _arg_1;
            _tagRenderer = new TagRenderer(_navigator);
        }
        ...
        {
            _content = _arg_1;
            _list = ((_content) ? IItemListWindow(_content.findChildByName("item_list")) : null);
        }
        ...
        public function refresh():void
        {
            ...
            _tagRenderer.useHashTags = true;

            var _local_4:Array = _navigator.data.popularTags.tags;
            var _local_2:IWindowContainer = IWindowContainer(_list.getListItemAt(0));
            ...
            while (_local_3 < _navigator.data.popularTags.tags.length)
            {
                ...
                _tagRenderer.refreshTag(_local_2, _local_3, _local_1.tagName);
                _local_3++;
            };
