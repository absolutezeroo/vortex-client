package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
    ...
    public class MyRoomsTabPageDecorator implements ITabPageDecorator 
    {
        ...
        public function refreshCustomContent(_arg_1:IWindowContainer):void
        {
            ...
            {
                _filter = IDropMenuWindow(_local_3.findChildByName("meSubNavi"));
                prepareSubNavi();
        ...
        {
            var _local_1:int = (((_filter == null) || (_filter.disposed)) ? 0 : _filter.selection);
        ...
        public function setSubSelection(_arg_1:int):void
        {
            ...
            var _local_4:int = _filter.numMenuItems;
            _local_3 = 0;
