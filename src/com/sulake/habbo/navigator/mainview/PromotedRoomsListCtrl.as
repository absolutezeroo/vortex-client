package com.sulake.habbo.navigator.mainview
{
    ...
    public class PromotedRoomsListCtrl implements IDisposable 
    {
        ...
        {
            _navigator = _arg_1;
            _userCountRenderer = new UserCountRenderer(_navigator);
            _guestRoomListCtrl = new PromotedRoomsGuestRoomListCtrl(_navigator);
        }
        ...
        public function dispose():void
        {
            ...
            if (_userCountRenderer)
            {
                _userCountRenderer.dispose();
                _userCountRenderer = null;
            };

            if (_guestRoomListCtrl)
            {
                _guestRoomListCtrl.dispose();
                _guestRoomListCtrl = null;
            };
        }
        ...
        public function refreshEntry(_arg_1:IWindowContainer, _arg_2:PromotedRoomCategoryData):void
        {
            ...
            _userCountRenderer.refreshUserCount(_arg_2.bestRoom.maxUserCount, IWindowContainer(_arg_1.findChildByName("enter_room_button")), _arg_2.bestRoom.userCount, "${navigator.usercounttooltip.users}", 222, 35);
            ...
            if (_arg_2.open)
            {
                ...
                _guestRoomListCtrl.content = _arg_1;
                _guestRoomListCtrl.category = _arg_2;
                _guestRoomListCtrl.refresh();
            };
