package com.sulake.habbo.navigator
{
    ...
    public class TextSearchInputs 
    {
        ...
        public function TextSearchInputs(_arg_1:HabboNavigator, _arg_2:IWindowContainer)
        {
            ...
            if (_local_5)
            {
                _searchType = (_arg_2.findChildByName("search_type") as IDropMenuWindow);
                _local_4 = [];
                ...
                _searchType.populate(_local_4);
                _searchType.selection = 0;
            };
        }
            ...
            if (_searchType != null)
            {
                switch (_arg_2)
                {
                    case 8:
                        ...
                        return;
                    case 20:
                        _searchType.selection = 1;
                        return;
                    case 10:
                        _searchType.selection = 2;
                        return;
                    case 9:
                        _searchType.selection = 3;
                        return;
                    case 13:
                        _searchType.selection = 4;
                    default:
                };
            };
        }
