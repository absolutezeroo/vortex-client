    ...
    public class TagRenderer 
    {
        ...
        public function refreshTag(_arg_1:IWindowContainer, _arg_2:int, _arg_3:String):void
        {
            ...
            else
            {
                ...
                _local_4.text = (((_useHashTags) ? "#" : "") + _arg_3);
            ...
            else
            {
                ...
                else
                {
                    if (_arg_1.type == "WME_CLICK")
                    {
                        ...
                        _local_4 = ((_useHashTags) ? _local_3.text.substr(1, (_local_3.text.length - 1)) : _local_3.text);
                        Logger.log(("TAG CLICKED: " + _local_4));
                        _navigator.performTagSearch(_local_4);

                        if (_tagClickProc != null)
                        {
                            (_tagClickProc());
                        };
                    };
