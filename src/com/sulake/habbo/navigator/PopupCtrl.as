package com.sulake.habbo.navigator
{
    ...
    public class PopupCtrl 
    {
        ...
        private var _displayTimer:Timer = new Timer(500, 1);
        ...
        public function PopupCtrl(_arg_1:HabboNavigator, _arg_2:int, _arg_3:int, _arg_4:String)
        {
            _navigator = _arg_1;
            _xmlFileName = _arg_4;
            _popupIndentRight = _arg_2;
            _popupIndentLeft = _arg_3;
            _displayTimer.addEventListener("timer", onDisplayTimer);
        ...
        public function dispose():void
        {
            ...
            if (_displayTimer)
            {
                _displayTimer.removeEventListener("timer", onDisplayTimer);
                _displayTimer.reset();
                _displayTimer = null;
            };
        ...
        public function showPopup(_arg_1:IWindow):void
        {
            ...
            _popup.x = ((_local_2.x + _popupIndentRight) + _arg_1.width);
            ...
            {
                _popup.x = ((-(_popup.width) + _local_2.x) + _popupIndentLeft);
