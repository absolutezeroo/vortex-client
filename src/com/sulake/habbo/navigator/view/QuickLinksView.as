package com.sulake.habbo.navigator.view
{
    ...
    public class QuickLinksView 
    {
        ...
        public function setQuickLinks(_arg_1:Vector.<SavedSearch>):void
        {
            ...
            {
                _local_4 = IRegionWindow(_template.clone());
                ...
                _linkSearches.push(new SearchContext(_arg_1[_local_2].searchCode, _arg_1[_local_2].filter));
                _searchIds.push(_arg_1[_local_2].id);
        ...
        private function listItemProcedure(_arg_1:WindowEvent, _arg_2:IWindow):void
        {
            if (_arg_1.type == "WME_CLICK")
            {
                ...
                {
                    if (_linkSearches.length > _arg_2.id)
                    {
                        _navigator.performSearchByContext(_linkSearches[_arg_2.id]);
                        _navigator.trackEventLog("savedsearch.execute", "SavedSearch", HabboNewNavigator.getEventLogExtraStringFromSearch(_linkSearches[_arg_2.id].searchCode, _linkSearches[_arg_2.id].filtering));
                    };
                }
                ...
                else
                {
                    ...
                    {
                        _navigator.deleteSavedSearch(_searchIds[_arg_2.parent.id]);
                    };
                };
            }
