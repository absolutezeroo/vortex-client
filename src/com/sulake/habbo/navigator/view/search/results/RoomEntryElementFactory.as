package com.sulake.habbo.navigator.view.search.results
{
    ...
    public class RoomEntryElementFactory 
    {
        ...
        {
            var _local_3:IWindowContainer = IWindowContainer(_tileEntryTemplate.clone());
        ...
        private function updateCommonEntryElements(_arg_1:IWindowContainer, _arg_2:GuestRoomData, _arg_3:Boolean):void
        {
            ...
            _arg_1.findChildByName("room_name").caption = ((ViewMode.isEventViewMode(_viewMode)) ? _arg_2.roomAdName : _arg_2.roomName);
        ...
        {
            return (_tileContainerTemplate.clone() as IItemListWindow);
        }
