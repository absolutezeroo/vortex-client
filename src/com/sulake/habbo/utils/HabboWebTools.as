package com.sulake.habbo.utils
{
    ...
    public class HabboWebTools 
    {
        ...
        public static function openWebPage(url:String, targetWindow:String=""):void
        {
            ...
            {
                targetWindow = "habboMain";
            };

            if (!ExternalInterface.available)
            {
                public::navigateToURL(url, targetWindow);
            }
            ...
            else
            {
                try
                {
                    ...
                    {
                        ExternalInterface.call("window.open", url, targetWindow);
                    }
                    ...
                    else
                    {
                        ...
                        {
                            ExternalInterface.call((((("function setWMWindow() {window.open('" + url) + "', '") + targetWindow) + "');}"));
                        }
        ...
        public static function openPage(pageUrl:String):void
        {
            try
            {
                ...
                {
                    public::navigateToURL(pageUrl, "habboMain");
        ...
        public static function openWebPageAndMinimizeClient(pageUrl:String):void
        {
            try
            {
                if (ExternalInterface.available)
                {
                    ...
                    {
                        public::navigateToURL(((_SafeStr_3305 + "/") + pageUrl), "habboMain");
        ...
        public static function openMinimail(target:String):void
        {
            try
            {
                if (ExternalInterface.available)
                {
                    ...
                    {
                        openWebHabblet("minimail", target);
                    };
                }
