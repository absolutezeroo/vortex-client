package com.sulake.habbo.room.object.visualization.data
{
    public class AnimationFrameSequenceData 
    {
        ...
        {
            return (_frameIndexes.length * _loopCount);
        }
        ...
        public function initialize():void
        {
            ...
            var _local_1:int = 1;
            var _local_2:int = -1;
            _local_3 = (_frameIndexes.length - 1);

            while (_local_3 >= 0)
            {
                if (_frameIndexes[_local_3] == _local_2)
                {
                    _local_1++;
                }
                ...
                {
                    _local_2 = _frameIndexes[_local_3];
                    _local_1 = 1;
                };

                _frameRepeats[_local_3] = _local_1;
                _local_3--;
            };
        }
        ...
        public function addFrame(_arg_1:int, _arg_2:int, _arg_3:int, _arg_4:int, _arg_5:int, _arg_6:DirectionalOffsetData):void
        {
            ...
            if (_frames.length > 0)
            {
                _local_8 = _frames[(_frames.length - 1)];
            ...
            _frames.push(_local_9);
            _frameIndexes.push((_frames.length - 1));
            _frameRepeats.push(1);
        }

        public function getFrame(_arg_1:int):AnimationFrameData
        {
            if ((((_frames.length == 0) || (_arg_1 < 0)) || (_arg_1 >= frameCount)))
            {
                return (null);
            };

            _arg_1 = _frameIndexes[(_arg_1 % _frameIndexes.length)];
            return (_frames[_arg_1] as AnimationFrameData);
        }
        ...
        public function getFrameIndex(_arg_1:int):int
        {
            ...
            if (_isRandom)
            {
                _arg_1 = int((Math.random() * _frameIndexes.length));

                if (_arg_1 == _frameIndexes.length)
                {
                    _arg_1--;
                };
            };
        ...
        public function getRepeats(_arg_1:int):int
        {
            ...
            return (_frameRepeats[(_arg_1 % _frameRepeats.length)]);
        }
