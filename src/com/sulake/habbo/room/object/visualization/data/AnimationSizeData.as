    ...
    public class AnimationSizeData extends SizeData
    {
        ...
        override public function dispose():void
        {
            ...
            if (_animations != null)
            {
                ...
                while (_local_1 < _animations.length)
                {
                    _local_2 = (_animations.getWithIndex(_local_1) as AnimationData);
        ...
        public function defineAnimations(_arg_1:XML):Boolean
        {
            ...
            while (_local_6 < _local_9.length())
            {
                ...
                _animations.add(_local_14, _local_2);

                if (!_local_13)
                {
                    _animationIds.push(_local_14);
                };
        ...
        {
            if (_animations.getValue(_arg_1) != null)
            {
                return (true);
            };
        ...
        public function getAnimationId(_arg_1:int):int
        {
            ...
            {
                return (_animationIds[(_arg_1 % _local_2)]);
            };
        ...
        {
            var _local_3:AnimationData = (_animations.getValue(_arg_1) as AnimationData);
        ...
        public function getFrame(_arg_1:int, _arg_2:int, _arg_3:int, _arg_4:int):AnimationFrame
        {
            ...
            var _local_5:AnimationData = (_animations.getValue(_arg_1) as AnimationData);
        ...
        public function getFrameFromSequence(_arg_1:int, _arg_2:int, _arg_3:int, _arg_4:int, _arg_5:int, _arg_6:int):AnimationFrame
        {
            ...
            var _local_7:AnimationData = (_animations.getValue(_arg_1) as AnimationData);
