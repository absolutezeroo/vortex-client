package com.sulake.habbo.room.object.visualization.furniture
{
    ...
    public class FurniturePlanetSystemVisualizationPlanetObject 
    {
        ...
        private var _positionVector:Vector3d = new Vector3d(0, 0, 0);
        ...
        public function FurniturePlanetSystemVisualizationPlanetObject(_arg_1:String, _arg_2:int, _arg_3:Number, _arg_4:Number, _arg_5:Number, _arg_6:Number)
        {
            ...
            _index = _arg_2;
            _radius = _arg_3;
            _arcSpeed = (((_arg_4 * 3.14159265358979) * 2) / 360);
        ...
        public function update(_arg_1:Array, _arg_2:Vector3d, _arg_3:Number):void
        {
            ...
            var _local_5:int;
            _position = (_position + (_arcSpeed / 30));
            ...
            while (_local_5 < _children.length)
            {
                ...
                _local_4.update(_arg_1, _positionVector, _arg_3);
                _local_5++;
            };
        }
        ...
        public function getPositionVector(_arg_1:Vector3d, _arg_2:Number):Vector3d
        {
            ...
            var _local_5:Number = _height;
            _positionVector.x = ((_local_3 - _local_4) * (_arg_2 / 2));
            _positionVector.y = ((((_local_4 + _local_3) * (_arg_2 / 2)) * 0.5) - (_height * (_arg_2 / 2)));
            _positionVector.z = -((4 * (_local_3 + _local_4)) - 0.7);

            if (_arg_1 != null)
            {
                _positionVector.add(_arg_1);
            };
