package com.sulake.habbo.room.object.visualization.furniture
{
    ...
    public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle 
    {
        ...
        public function reset():void
        {
            ...
            _emittedParticles = 0;
            _hasIgnited = false;
            this.init(0, 0, 0, _direction, _force, _timeStep, _fuseTime, true);
        }

        public function copyStateFrom(_arg_1:FurnitureParticleSystemEmitter, _arg_2:Number):void
        {
            super.copy(_arg_1, _arg_2);
            _force = _arg_1._force;
            _direction = _arg_1._direction;
            _gravity = _arg_1._gravity;
            _airFriction = _arg_1._airFriction;
            _explosionShape = _arg_1._explosionShape;
            _fuseTime = _arg_1._fuseTime;
            _energy = _arg_1._energy;
            _burstPulse = _arg_1._burstPulse;
            _timeStep = _arg_1._timeStep;
        ...
        public function configureParticle(_arg_1:int, _arg_2:Boolean, _arg_3:Array, _arg_4:Boolean):void
        {
            ...
            _particleConfigurations.push(_local_5);
        }
        ...
        private function releaseParticles(_arg_1:FurnitureParticleSystemParticle, _arg_2:Vector3D=null):void
        {
            ...
            while (_local_7 < _particlesPerFrame)
            {
                ...
                _local_8.init(_arg_1.x, _arg_1.y, _arg_1.z, _local_9, _energy, _timeStep, _local_10, _local_4, _local_6, _local_5);
        ...
        {
            var _local_1:int = int(Math.floor((Math.random() * _particleConfigurations.length)));
            return (_particleConfigurations[_local_1]);
        }
        ...
        public function verlet():void
        {
            ...
            if (((isAlive) || (_emittedParticles < _maxNumberOfParticles)))
            {
                ...
                this.y = ((((2 - _airFriction) * this.y) - ((1 - _airFriction) * this.lastY)) + ((_gravity * _timeStep) * _timeStep));
            ...
            for each (_local_5 in _particles)
            {
                ...
                _local_5.y = ((((2 - _airFriction) * _local_5.y) - ((1 - _airFriction) * _local_5.lastY)) + ((_gravity * _timeStep) * _timeStep));
