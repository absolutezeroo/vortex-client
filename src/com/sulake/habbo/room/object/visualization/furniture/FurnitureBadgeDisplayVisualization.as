    ...
    public class FurnitureBadgeDisplayVisualization extends AnimatedFurnitureVisualization 
    {
        ...
        override protected function updateModel(_arg_1:Number):Boolean
        {
            ...
            if (!isNaN(object.getModel().getNumber("furniture_badge_image_status")))
            {
                ...
                if (((_local_2) && (_badgeAssetNameNormalScale == "")))
                {
                    _badgeAssetNameNormalScale = object.getModel().getString("furniture_badge_asset_name");

                    if (_badgeAssetNameSmallScale == "")
                    {
                        _badgeAssetNameSmallScale = (_badgeAssetNameNormalScale + "_32");
                    };

                    if (object.getModel().hasNumber("furniture_badge_visible_in_state"))
                    {
                        _badgeVisibleInState = object.getModel().getNumber("furniture_badge_visible_in_state");
                    };
        ...
        override protected function getSpriteAssetName(_arg_1:int, _arg_2:int):String
        {
            ...
            if (((!(_local_3 == "BADGE")) || ((!(_badgeVisibleInState == -1)) && (!(object.getState(0) == _badgeVisibleInState)))))
            {
            ...
            if (_arg_1 == 32)
            {
                return (_badgeAssetNameSmallScale);
            };

            return (_badgeAssetNameNormalScale);
        }
        ...
        override protected function getSpriteXOffset(_arg_1:int, _arg_2:int, _arg_3:int):int
        {
            ...
            {
                _local_5 = getAsset(((_arg_1 == 32) ? _badgeAssetNameSmallScale : _badgeAssetNameNormalScale), _arg_3);
