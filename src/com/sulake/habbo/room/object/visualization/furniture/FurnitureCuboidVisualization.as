    ...
    public class FurnitureCuboidVisualization extends RoomObjectSpriteVisualization 
    {
        ...
        override public function dispose():void
        {
            ...
            if (_planes != null)
            {
                ...
                {
                    _local_1 = (_planes[_local_2] as FurniturePlane);
        ...
        override public function update(_arg_1:IRoomGeometry, _arg_2:int, _arg_3:Boolean, _arg_4:Boolean):void
        {
            ...
            if (_assetLibrary == null)
            {
                _assetLibrary = new AssetLibrary(("furniture cuboid visualization - " + _local_5.getInstanceId()));
            };
        ...
        protected function updatePlanes(_arg_1:IRoomGeometry, _arg_2:int):void
        {
            ...
            if (((_arg_1 == null) || (_assetLibrary == null)))
            {
                return;
            };
            ...
            while (_local_6 < _planes.length)
            {
                _local_7 = false;
                _local_13 = ((("plane " + _local_6) + " ") + _arg_1.scale);
                _local_14 = (_assetLibrary.getAssetByName(_local_13) as BitmapDataAsset);

                if (_local_14 == null)
                {
                    _local_14 = new BitmapDataAsset(_assetLibrary.getAssetTypeDeclarationByClass(BitmapDataAsset));
                    _assetLibrary.setAsset(_local_13, _local_14);
                };

                _local_3 = (_planes[_local_6] as FurniturePlane);
                ...
                if (_local_12 != null)
                {
                    ...
                    if (_local_7)
                    {
                        _local_12.assetName = ((((_local_13 + "_") + _local_10.getInstanceId()) + "_") + _assetUpdateCounter);
                    };
