    ...
    public class FurnitureVisualizationData implements IRoomObjectVisualizationData 
    {
        ...
        public function dispose():void
        {
            ...
            if (_sizeDatas != null)
            {
                ...
                while (_local_2 < _sizeDatas.length)
                {
                    _local_1 = (_sizeDatas.getWithIndex(_local_2) as SizeData);
        ...
        protected function defineVisualizations(_arg_1:XML):Boolean
        {
            ...
            while (_local_7 < _local_10.length())
            {
                ...
                if (_sizeDatas.getValue(String(_local_3)) != null)
                {
                    return (false);
                };
                ...
                _sizeDatas.add(String(_local_3), _local_11);
                _sizes.push(_local_3);
                _sizes.sort(16);
                _local_7++;
            };
        ...
        public function getSize(_arg_1:int):int
        {
            ...
            {
                _local_3 = _sizes[_local_2];
            };

            _lastSizeScale = _arg_1;
            _lastSize = _local_3;
            return (_local_3);
        }
        ...
        {
            if (_arg_1 == _lastSizeDataScale)
            {
                return (_lastSizeData);
            };
            ...
            if (_local_2 < _sizes.length)
            {
                _lastSizeData = (_sizeDatas.getValue(String(_sizes[_local_2])) as SizeData);
            }
