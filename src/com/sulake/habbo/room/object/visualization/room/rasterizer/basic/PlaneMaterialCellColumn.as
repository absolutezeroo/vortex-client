    ...
    public class PlaneMaterialCellColumn 
    {
        ...
        public function render(height:int, normal:IVector3d, offsetX:int, offsetY:int):BitmapData
        {
            ...
            if (isStatic)
            {
                if (_cachedBitmapData != null)
                {
                    if (((((_cachedBitmapData.height == height) && (Vector3d.isEqual(_cachedBitmapNormal, normal))) && (_cachedBitmapDataOffsetX == offsetX)) && (_cachedBitmapDataOffsetY == offsetY)))
                    {
            ...
            else
            {
                if (_cachedBitmapData != null)
                {
                    if (_cachedBitmapData.height == height)
                    {
            ...
            if (_cachedBitmapData == null)
            {
                try
                {
                    _cachedBitmapData = new BitmapData(_width, height, true, 0xFFFFFF);
                }
            ...
            _cachedBitmapDataOffsetX = offsetX;
            _cachedBitmapDataOffsetY = offsetY;
        ...
        private function renderCells(_arg_1:Array, _arg_2:int, _arg_3:Boolean, _arg_4:IVector3d, _arg_5:int=0, _arg_6:int=0):int
        {
            ...
            if ((((_arg_1 == null) || (_arg_1.length == 0)) || (_cachedBitmapData == null)))
            {
                return (_arg_2);
            };
            ...
            while (_local_8 < _arg_1.length)
            {
                ...
                if (_local_9 != null)
                {
                    ...
                    if (_local_7 != null)
                    {
                        ...
                        _cachedBitmapData.copyPixels(_local_7, _local_7.rect, new Point(0, _arg_2), _local_7, null, true);
                        ...
                        if ((((_arg_3) && (_arg_2 >= _cachedBitmapData.height)) || ((!(_arg_3)) && (_arg_2 <= 0))))
                        {
                            return (_arg_2);
                        };
                    };
        ...
        {
            if (((_cells.length == 0) || (_cachedBitmapData == null)))
            {
                return;
            };
        ...
        private function renderRepeatAll(_arg_1:IVector3d, _arg_2:int, _arg_3:int):void
        {
            ...
            if (_local_5 > _cachedBitmapData.height)
            {
            };

            while (_local_4 < _cachedBitmapData.height)
            {
        ...
        private function renderRepeatBorders(_arg_1:IVector3d):void
        {
            ...
            var _local_4:int = ((_cachedBitmapData.height - _local_2) >> 1);
            ...
            if (_local_8 != null)
            {
                ...
                while (_local_7 < _cachedBitmapData.height)
                {
        ...
        private function renderRepeatCenter(_arg_1:IVector3d):void
        {
            ...
            var _local_13:int;
            var _local_2:int;
            var _local_15:int = _cachedBitmapData.height;

            if ((_local_10 + _local_12) > _cachedBitmapData.height)
            {
                _local_13 = ((_local_10 + _local_12) - _cachedBitmapData.height);
            ...
            if (_local_13 == 0)
            {
                ...
                if (_local_5 != null)
                {
                    ...
                    if (_local_16 > 0)
                    {
                        _local_7 = (_cachedBitmapData.height - (_local_10 + _local_12));
        ...
        private function renderRepeatFirst(_arg_1:IVector3d):void
        {
            ...
            var _local_3:int = _cachedBitmapData.height;
        ...
        private function renderRepeatLast(_arg_1:IVector3d):void
        {
            ...
            if (_local_4 != null)
            {
                ...
                while (_local_3 < _cachedBitmapData.height)
                {
