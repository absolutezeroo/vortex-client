    ...
    public class PlaneRasterizer implements IPlaneRasterizer 
    {
        ...
        public function dispose():void
        {
            ...
            if (_planes != null)
            {
                ...
                {
                    _local_1 = (_planes.getWithIndex(_local_2) as Plane);
            ...
            if (_geometries != null)
            {
                ...
                while (_local_2 < _geometries.length)
                {
                    _local_3 = _geometries.getWithIndex(_local_2);
        ...
        public function clearCache():void
        {
            ...
            while (_local_3 < _planes.length)
            {
                _local_1 = (_planes.getWithIndex(_local_3) as Plane);
        ...
        private function resetTextures():void
        {
            ...
            {
                _local_1 = (_textures.getWithIndex(_local_2) as PlaneTexture);
        ...
        {
            return (_textures.getValue(_arg_1) as PlaneTexture);
        }
        ...
        {
            return (_planes.getValue(_arg_1));
        }
        ...
        protected function addPlane(_arg_1:String, _arg_2:Plane):Boolean
        {
            ...
            if (_planes.getValue(_arg_1) == null)
            {
                _planes.add(_arg_1, _arg_2);
                return (true);
            };
        ...
        private function parseTextures(_arg_1:XML, _arg_2:IGraphicAssetCollection):void
        {
            ...
            while (_local_7 < _local_5.length())
            {
                ...
                if (XmlUtil.checkRequiredAttributes(_local_6, ["id"]))
                {
                    ...
                    if (_textures.getValue(_local_16) == null)
                    {
                        ...
                        _textures.add(_local_16, _local_4);
                    };
                };
        ...
        protected function getGeometry(_arg_1:int, _arg_2:Number, _arg_3:Number):IRoomGeometry
        {
            ...
            var _local_4:IRoomGeometry = _geometries.getValue(_local_5);

            if (_local_4 == null)
            {
                _local_4 = new RoomGeometry(_arg_1, new Vector3d(_arg_2, _arg_3), new Vector3d(-10, 0, 0));
                _geometries.add(_local_5, _local_4);
            };
