    ...
    public class PlaneMaskManager 
    {
        ...
        public function dispose():void
        {
            ...
            if (_masks != null)
            {
                ...
                {
                    _local_2 = (_masks.getWithIndex(_local_1) as PlaneMask);
        ...
        private function parseMasks(_arg_1:XML, _arg_2:IGraphicAssetCollection):void
        {
            ...
            while (_local_5 < _local_6.length())
            {
                ...
                if (XmlUtil.checkRequiredAttributes(_local_16, _local_10))
                {
                    ...
                    if (_masks.getValue(_local_14) == null)
                    {
                        ...
                        _masks.add(_local_14, _local_15);
                    };
                };
        ...
        public function updateMask(_arg_1:BitmapData, _arg_2:String, _arg_3:Number, _arg_4:IVector3d, _arg_5:int, _arg_6:int):Boolean
        {
            ...
            var _local_16:PlaneMask = (_masks.getValue(_arg_2) as PlaneMask);
        ...
        {
            return (_masks.getValue(_arg_1) as PlaneMask);
        }
