package com.sulake.habbo.room.object.visualization.room.rasterizer.animated
{
    ...
    public class LandscapeRasterizer extends PlaneRasterizer 
    {
        ...
        {
            var _local_15:LandscapePlane = (getPlane(id) as LandscapePlane);
            ...
            var _local_14:BitmapData = _local_15.render(canvas, width, height, scale, normal, useTexture, offsetX, offsetY, maxX, maxY, timeSinceStartMs);
            ...
            if (((!(_local_15.isStatic(scale))) && (true)))
            {
                _local_13 = new PlaneBitmapData(_local_14, ((Math.round((timeSinceStartMs / 500)) * 500) + 500));
            }
