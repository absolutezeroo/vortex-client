package com.sulake.habbo.room.object
{
    ...
    public class RoomWallData 
    {
        ...
        {
            if (((_addDuplicates) || (checkIsNotDuplicate(_arg_1, _arg_2, _arg_3, _arg_4, _arg_5))))
            {
                _corners.push(_arg_1);
                _directions.push(_arg_2);
                _lengths.push(_arg_3);
                _borders.push(_arg_4);
                _leftTurns.push(_arg_5);
                _hideWalls.push(false);
                _manuallyLeftCut.push(false);
                _manuallyRightCut.push(false);
                _count++;
            };
        }
        ...
        private function checkIsNotDuplicate(_arg_1:Point, _arg_2:int, _arg_3:int, _arg_4:Boolean, _arg_5:Boolean):Boolean
        {
            ...
            {
                if (((((((_corners[_local_6].x == _arg_1.x) && (_corners[_local_6].y == _arg_1.y)) && (_directions[_local_6] == _arg_2)) && (_lengths[_local_6] == _arg_3)) && (_borders[_local_6] == _arg_4)) && (_leftTurns[_local_6] == _arg_5)))
                {
                    return (false);
                };
        ...
        public function getEndPoint(_arg_1:int):Point
        {
            ...
            return (_endPoints[_arg_1]);
        }

        public function getLength(_arg_1:int):int
        {
            return (_lengths[_arg_1]);
        }
        ...
        {
            if (_arg_2 < _lengths[_arg_1])
            {
                _lengths[_arg_1] = _arg_2;
                _manuallyRightCut[_arg_1] = true;
            };
        }
        ...
        public function moveCorner(_arg_1:int, _arg_2:int):void
        {
            ...
            if (((_arg_2 > 0) && (_arg_2 < _lengths[_arg_1])))
            {
                ...
                var _local_5:int = (_lengths[_local_4] - _arg_2);
                _lengths[_local_4] = _local_5;
                _manuallyLeftCut[_arg_1] = true;
            };
        }
