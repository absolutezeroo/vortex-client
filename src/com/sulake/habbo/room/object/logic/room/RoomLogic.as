        ...
        private function updatePlaneMasks(_arg_1:RoomObjectRoomMaskUpdateMessage, _arg_2:IRoomObjectModelController):void
        {
            ...
            switch (_arg_1.type)
            {
                case "RORMUM_ADD_MASK":
                    ...
                    _roomPlaneBitmapMaskParser.addMask(_arg_1.maskId, _arg_1.maskType, _arg_1.maskLocation, _local_7);
                    _local_3 = true;
                    break;
                case "RORMUM_ADD_MASK":
                    _local_3 = _roomPlaneBitmapMaskParser.removeMask(_arg_1.maskId);
            };

            if (_local_3)
            {
                _local_6 = _roomPlaneBitmapMaskParser.getXML();
