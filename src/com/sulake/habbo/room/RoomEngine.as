package com.sulake.habbo.room
{
        ...
        public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver, IRoomContentListener
    {
        ...
        override protected function initComponent():void
        {
            ...
            _roomMessageHandler = new RoomMessageHandler(this);
        ...
        private function onConfigurationComplete(_arg_1:Event):void
        {
            ...
            if (((_roomMessageHandler) && (_communication)))
            {
                _roomMessageHandler.connection = _communication.connection;
            };
        ...
        override public function dispose():void
        {
            ...
            {
                _imageCallbacks.dispose();
            };

            if (_thumbnailCallbacks != null)
            {
                _thumbnailCallbacks.dispose();
            };
            ...
            if (_roomMessageHandler != null)
            {
                _roomMessageHandler.dispose();
                _roomMessageHandler = null;
            };
            ...
            if (_roomInstanceDatas != null)
            {
                _local_2 = 0;

                while (_local_2 < _roomInstanceDatas.length)
                {
                    _local_1 = (_roomInstanceDatas.getWithIndex(_local_2) as RoomInstanceData);
                ...
                _roomInstanceDatas.dispose();
                _roomInstanceDatas = null;
            };

            if (_badgeListenerObjects != null)
            {
                _badgeListenerObjects.dispose();
                _badgeListenerObjects = null;
            };
        ...
        private function getRoomInstanceData(_arg_1:int):RoomInstanceData
        {
            ...
            if (_roomInstanceDatas != null)
            {
                _local_3 = (_roomInstanceDatas.getValue(_local_2) as RoomInstanceData);

                if (_local_3 == null)
                {
                    _local_3 = new RoomInstanceData(_arg_1);
                    _roomInstanceDatas.add(_local_2, _local_3);
                };
            };
        ...
        private function createRoomFurniture():void
        {
            ...
            for each (var _local_2:RoomInstanceData in _roomInstanceDatas)
            {
                _local_4 = 0;
                _local_3 = null;
                _local_9 = false;
        ...
        private function updateRoomCameras(_arg_1:uint):void
        {
            ...
            while (_local_8 < _roomInstanceDatas.length)
            {
                _local_3 = (_roomInstanceDatas.getWithIndex(_local_8) as RoomInstanceData);
                _local_7 = null;
                _local_9 = 0;
                ...
                if (_local_7 != null)
                {
                    ...
                    if (_local_10 != null)
                    {
                        if (((!(_local_9 == _SafeStr_418)) || (!(_activeRoomIsDragged))))
                        {
            ...
            if (_local_5 != null)
            {
                if (_activeRoomIsDragged)
                {
                    _local_5.screenOffsetX = (_local_5.screenOffsetX + _activeRoomDragX);
                    _local_5.screenOffsetY = (_local_5.screenOffsetY + _activeRoomDragY);
                    _activeRoomDragX = 0;
                    _activeRoomDragY = 0;
                };
            };
        ...
        private function onRoomSessionEvent(_arg_1:RoomSessionEvent):void
        {
            switch (_arg_1.type)
            {
                case "RSE_STARTED":
                    ...
                    if (_roomMessageHandler)
                    {
                        _roomMessageHandler.setCurrentRoom(_arg_1.session.roomId);
                    };
                ...
                case "RSE_ENDED":
                    ...
                    if (_roomMessageHandler)
                    {
                        _roomMessageHandler.resetCurrentRoom();
        ...
        public function roomManagerInitialized(_arg_1:Boolean):void
        {
            ...
            if (_arg_1)
            {
                ...
                while (_local_3 < _roomDatas.length)
                {
                    _local_2 = (_roomDatas.getWithIndex(_local_3) as RoomData);
        ...
        public function initializeRoom(_arg_1:int, _arg_2:XML):void
        {
            ...
            if (!_isInitialized)
            {
                _local_5 = _roomDatas.remove(_local_3);
                ...
                _roomDatas.add(_local_3, _local_5);
        ...
        public function updateObjectRoom(_arg_1:int, _arg_2:String=null, _arg_3:String=null, _arg_4:String=null, _arg_5:Boolean=false):Boolean
        {
            ...
            if (_local_10 == null)
            {
                ...
                _local_8 = _roomDatas.getValue(_local_6);

                if (_local_8 == null)
                {
                    _local_8 = new RoomData(_arg_1, null);
                    _roomDatas.add(_local_6, _local_8);
                };
        ...
        public function disposeRoom(_arg_1:int):void
        {
            ...
            var _local_3:RoomInstanceData = _roomInstanceDatas.remove(_local_2);
        ...
        public function getRoomCanvasScale(_arg_1:int=-1000, _arg_2:int=-1):Number
        {
            ...
            if (_arg_2 == -1)
            {
                _arg_2 = _activeRoomActiveCanvas;
            };
        ...
        private function handleRoomDragging(_arg_1:IRoomRenderingCanvas, _arg_2:int, _arg_3:int, _arg_4:String, _arg_5:Boolean, _arg_6:Boolean, _arg_7:Boolean):Boolean
        {
            ...
            var _local_9:int = (_arg_2 - _activeRoomActiveCanvasMouseX);
            var _local_8:int = (_arg_3 - _activeRoomActiveCanvasMouseY);

            if (_arg_4 == "mouseDown")
            {
                if (((((!(_arg_5)) && (!(_arg_6))) && (!(_arg_7))) && (!(isDecorateMode))))
                {
                    _activeRoomIsDragged = true;
                    _activeRoomWasDragged = false;
                    _activeRoomDragStartX = _activeRoomActiveCanvasMouseX;
                    _activeRoomDragStartY = _activeRoomActiveCanvasMouseY;
                    _mouseEventsDisabledLeftToXWas = _mouseEventsDisabledLeftToX;
            ...
            else
            {
                if (_arg_4 == "mouseUp")
                {
                    if (_activeRoomIsDragged)
                    {
                        _activeRoomIsDragged = false;

                        if (_activeRoomWasDragged)
                        {
                            _local_10 = getRoomInstanceData(_SafeStr_418);
                    ...
                    if (_mouseEventsDisabledLeftToXWas != 0)
                    {
                        _mouseEventsDisabledLeftToX = _mouseEventsDisabledLeftToXWas;
                        _mouseEventsDisabledLeftToXWas = 0;
                    };
                }
                ...
                else
                {
                    if (_arg_4 == "mouseMove")
                    {
                        if (_activeRoomIsDragged)
                        {
                            if (!_activeRoomWasDragged)
                            {
                                _local_9 = (_arg_2 - _activeRoomDragStartX);
                                _local_8 = (_arg_3 - _activeRoomDragStartY);

                                if (((((_local_9 <= -(15)) || (_local_9 >= 15)) || (_local_8 <= -(15))) || (_local_8 >= 15)))
                                {
                                    _activeRoomWasDragged = true;
                            ...
                            {
                                _activeRoomDragX = (_activeRoomDragX + _local_9);
                                _activeRoomDragY = (_activeRoomDragY + _local_8);
        ...
        public function handleRoomCanvasMouseEvent(_arg_1:int, _arg_2:int, _arg_3:int, _arg_4:String, _arg_5:Boolean, _arg_6:Boolean, _arg_7:Boolean, _arg_8:Boolean):void
        {
            ...
            if (_local_9 != null)
            {
                if (((((_sessionDataManager.isPerkAllowed("MOUSE_ZOOM")) && (_arg_4 == "click")) && (_arg_6)) && (_arg_5)))
                {
                    ...
                    setRoomCanvasScale(activeRoomId, _activeRoomActiveCanvas, _local_12, new Point(_arg_2, _arg_3));
                    return;
                };
                ...
                _activeRoomActiveCanvas = _arg_1;
                _activeRoomActiveCanvasMouseX = _arg_2;
                _activeRoomActiveCanvasMouseY = _arg_3;
            };
        }
        ...
        public function setObjectMoverIconSprite(_arg_1:int, _arg_2:int, _arg_3:Boolean, _arg_4:String=null, _arg_5:IStuffData=null, _arg_6:int=-1, _arg_7:int=-1, _arg_8:String=null):void
        {
            ...
            if (_local_9 != null)
            {
                ...
                if (_local_11 != null)
                {
                    _local_11.x = (_activeRoomActiveCanvasMouseX - (_local_15.data.width / 2));
                    _local_11.y = (_activeRoomActiveCanvasMouseY - (_local_15.data.height / 2));
                };
            };
        }
        ...
        public function disposeObjectFurniture(_arg_1:int, _arg_2:int, _arg_3:int=-1, _arg_4:Boolean=false):void
        {
            ...
            if ((((_sessionDataManager) && (_arg_3 == _sessionDataManager.userId)) && (!(FurniId.isBuilderClubId(_arg_2)))))
            {
                ...
                if (_local_14)
                {
                    _local_12 = getRoomObjectScreenLocation(_arg_1, _arg_2, 10, _activeRoomActiveCanvas);
        ...
        public function disposeObjectWallItem(_arg_1:int, _arg_2:int, _arg_3:int=-1):void
        {
            ...
            if ((((_sessionDataManager) && (_arg_3 == _sessionDataManager.userId)) && (!(FurniId.isBuilderClubId(_arg_2)))))
            {
                ...
                {
                    _local_6 = getRoomObjectScreenLocation(_arg_1, _arg_2, 20, _activeRoomActiveCanvas);
        ...
        public function getGenericRoomObjectThumbnail(_arg_1:String, _arg_2:String, _arg_3:IGetImageListener, _arg_4:String=null, _arg_5:IStuffData=null):_SafeStr_147
        {
            ...
            {
                _local_9 = _thumbnailCallbacks.getValue(_local_10);

                if (_local_9 == null)
                {
                    _local_9 = new Vector.<IGetImageListener>(0);
                    _thumbnailCallbacks.add(_local_10, _local_9);
        ...
        public function getGenericRoomObjectImage(_arg_1:String, _arg_2:String, _arg_3:IVector3d, _arg_4:int, _arg_5:IGetImageListener, _arg_6:uint=0, _arg_7:String=null, _arg_8:IStuffData=null, _arg_9:int=-1, _arg_10:int=-1, _arg_11:String=null, _arg_12:int=-1):_SafeStr_147
        {
            ...
            var _local_21:int = _imageObjectIdBank.reserveNumber();
            ...
            {
                _imageCallbacks.add(_local_21, _arg_5);
            ...
            {
                _local_16.disposeObject(_local_21, _local_22);
                _imageObjectIdBank.freeNumber((_local_21 - 1));
                _local_17.id = 0;
            };
        ...
        public function getRoomObjectScreenLocation(_arg_1:int, _arg_2:int, _arg_3:int, _arg_4:int=-1):Point
        {
            ...
            if (_arg_4 == -1)
            {
                _arg_4 = _activeRoomActiveCanvas;
            };
        ...
        {
            return (getRoomCanvas(_SafeStr_418, _activeRoomActiveCanvas));
        }
        ...
        public function iconLoaded(id:int, assetName:String, success:Boolean):void
        {
            ...
            _SafeStr_421.freeNumber((id - 1));

            var _local_5:Vector.<IGetImageListener> = _thumbnailCallbacks.getValue(assetName);

            if (_local_5 != null)
            {
                _thumbnailCallbacks.remove(assetName);
                _local_7 = (assets.getAssetByName(assetName) as BitmapDataAsset);
                    ...
                    for each (var _local_6:IGetImageListener in _local_5)
                    {
                        if (_local_6 != null)
                        {
                            try
                            {
                                ...
                                {
                                    _local_6.imageReady(id, _local_4.clone());
                                }
        ...
        public function contentLoaded(_arg_1:String, _arg_2:Boolean):void
        {
            ...
            while (_local_6 >= 0)
            {
                ...
                if ((((!(_local_14 == null)) && (!(_local_14.getModel() == null))) && (_local_14.getType() == _arg_1)))
                {
                    ...
                    _imageObjectIdBank.freeNumber((_local_11 - 1));
                    _local_5 = (_imageCallbacks.remove(String(_local_11)) as IGetImageListener);
        ...
        public function objectInitialized(_arg_1:String, _arg_2:int, _arg_3:int):void
        {
            ...
            Logger.log("[RoomEngine] objectInitialized room=" + _arg_1 + " objId=" + _arg_2 + " category=" + _arg_3 + " found=" + (_local_9 != null));

            if ((((!(_local_9 == null)) && (!(_local_9.getModel() == null))) && (!(_local_9.getEventHandler() == null))))
            {
                _local_9.getEventHandler().processUpdateMessage(new RoomObjectUpdateMessage(_local_9.getLocation(), _local_9.getDirection()));
        ...
        public function requestBadgeImageAsset(_arg_1:int, _arg_2:int, _arg_3:int, _arg_4:String, _arg_5:Boolean=true):void
        {
            ...
            if (!_local_7)
            {
                ...
                _badgeListenerObjects[_arg_4] = _local_6;
            }
        ...
        private function onBadgeLoaded(_arg_1:BadgeImageReadyEvent):void
        {
            ...
            var _local_2:Array = (_badgeListenerObjects.getValue(_arg_1.badgeId) as Array);
            ...
            _badgeListenerObjects.remove(_arg_1.badgeId);
