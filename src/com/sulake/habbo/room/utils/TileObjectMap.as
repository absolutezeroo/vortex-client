package com.sulake.habbo.room.utils
{
        ...
        public class TileObjectMap 
    {
        ...
        public function TileObjectMap(_arg_1:int, _arg_2:int)
        {
            var _local_3:int;
            super();
            _tileObjectMap = new Vector.<Vector.<IRoomObject>>(_arg_2, true);
            _local_3 = 0;

            while (_local_3 < _arg_2)
            {
                _tileObjectMap[_local_3] = new Vector.<IRoomObject>(_arg_1, true);
                _local_3++;
            };
        ...
        public function clear():void
        {
            ...
            for each (var _local_1:Vector.<IRoomObject> in _tileObjectMap)
            {
                _local_2 = 0;
        ...
        public function getObjectIntTile(_arg_1:int, _arg_2:int):IRoomObject
        {
            ...
            {
                return (_tileObjectMap[_arg_2][_arg_1]);
            };
        ...
        public function setObjectInTile(_arg_1:int, _arg_2:int, _arg_3:IRoomObject):void
        {
            ...
            if (((((_arg_1 >= 0) && (_arg_1 < _width)) && (_arg_2 >= 0)) && (_arg_2 < _height)))
            {
                _tileObjectMap[_arg_2][_arg_1] = _arg_3;
            };
        }
        ...
        public function toString():String
        {
            ...
            while (_local_3 < _height)
            {
                _local_2 = 0;

                while (_local_2 < _width)
                {
                    _local_4 = _tileObjectMap[_local_3][_local_2];
