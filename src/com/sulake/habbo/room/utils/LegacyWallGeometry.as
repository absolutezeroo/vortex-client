        ...
        public class LegacyWallGeometry implements IDisposable 
    {
        ...
        private function reset():void
        {
            ...
            if (_heightMap != null)
            {
                ...
                while (_local_2 < _heightMap.length)
                {
                    _local_1 = (_heightMap[_local_2] as Array);
                    _local_2++;
                };
        ...
        public function setTileHeight(_arg_1:int, _arg_2:int, _arg_3:Number):Boolean
        {
            ...
            var _local_4:Array = (_heightMap[_arg_2] as Array);
        ...
        public function getTileHeight(_arg_1:int, _arg_2:int):Number
        {
            ...
            var _local_3:Array = (_heightMap[_arg_2] as Array);
        ...
        public function getLocationOldFormat(_arg_1:Number, _arg_2:Number, _arg_3:String):IVector3d
        {
            ...
            {
                if (((_local_7 >= 0) && (_local_7 < _height)))
                {
        ...
        {
            return (((((_arg_1 >= 0) && (_arg_1 < _width)) && (_arg_2 >= 0)) && (_arg_2 < _height)) && (_heightMap[_arg_2][_arg_1] >= 0));
        }
