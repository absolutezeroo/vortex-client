package com.sulake.habbo.room.utils
{
        ...
        public class RoomCamera 
    {
        ...
        {
            if (((!(_targetLoc == null)) && (!(_location == null))))
            {
                return (true);
            };
        ...
        public function set target(_arg_1:IVector3d):void
        {
            ...
            if (_targetLoc == null)
            {
                _targetLoc = new Vector3d();
            };

            if ((((!(_targetLoc.x == _arg_1.x)) || (!(_targetLoc.y == _arg_1.y))) || (!(_targetLoc.z == _arg_1.z))))
            {
                _targetLoc.assign(_arg_1);
                _local_2 = Vector3d.dif(_targetLoc, _location);
                _moveDistance = _local_2.length;
                _maintainPreviousMoveSpeed = true;
            };
        }
        ...
        public function update(_arg_1:uint, _arg_2:Number):void
        {
            ...
            if ((((_followDuration > 0) && (!(_targetLoc == null))) && (!(_location == null))))
            {
                if (_scaleChanged)
                {
                    _scaleChanged = false;
                    _location = _targetLoc;
                    _targetLoc = null;
                    return;
                };

                _local_4 = Vector3d.dif(_targetLoc, _location);

                if (_local_4.length > _moveDistance)
                {
                    _moveDistance = _local_4.length;
                };
                ...
                {
                    _local_5 = Math.sin(((3.14159265358979 * _local_4.length) / _moveDistance));
                    _local_6 = (_arg_2 * 0.5);
                    _local_3 = (_moveDistance / 12);
                    _local_7 = (_local_6 + ((_local_3 - _local_6) * _local_5));

                    if (_maintainPreviousMoveSpeed)
                    {
                        if (_local_7 < _previousMoveSpeed)
                        {
                            _local_7 = _previousMoveSpeed;
                        ...
                        {
                            _maintainPreviousMoveSpeed = false;
                        };
                    };

                    _previousMoveSpeed = _local_7;
