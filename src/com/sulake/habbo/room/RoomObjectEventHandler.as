package com.sulake.habbo.room
{
        ...
        public class RoomObjectEventHandler implements IRoomRenderingCanvasMouseListener
    {
                    ...
                    else
                    {
                        ...
                        if (_arg_2 != _selectedObjectId)
                        {
                            ...
                            if (((!(_local_5 == null)) && (!(_local_5.getEventHandler() == null))))
                            {
                                ...
                                _selectedObjectId = _arg_2;
                                _selectedObjectCategory = _arg_3;
                            };
                        };
                    };
        ...
        private function deselectObject(_arg_1:int):void
        {
            ...
            {
                _local_2 = (_roomEngine.getRoomObject(_arg_1, _selectedObjectId, _selectedObjectCategory) as IRoomObjectController);
        ...
        {
            var _local_4:Map = (_eventIds.getValue(String(_arg_1)) as Map);

            if (_local_4 == null)
            {
                _local_4 = new Map();
                _eventIds.add(_arg_1, _local_4);
            };
        ...
        public function setSelectedAvatar(_arg_1:int, _arg_2:int, _arg_3:Boolean):void
        {
            ...
            var _local_7:IRoomObjectController = (_roomEngine.getRoomObject(_arg_1, _selectedAvatarId, _local_6) as IRoomObjectController);
        ...
        private function placeObject(_arg_1:int, _arg_2:Boolean, _arg_3:Boolean):void
        {
            ...
            if (((!(_roomEngine == null)) && (!(_roomEngine.connection == null))))
            {
                ...
                if (_local_6 != null)
                {
                    ...
                    if ((((_roomEngine.catalog == null) || (_roomEngine.catalog.catalogType == "NORMAL")) || (!(_objectPlacementSource == "catalog"))))
                    {
