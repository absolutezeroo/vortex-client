package com.sulake.habbo.communication.messages.parser.talent
{
        ...
        public class TalentTrack 
    {
        ...
        public function get totalProgress():Number
        {
            ...
            if (_levels.length > 0)
            {
                _local_1 = _levels[_currentLevelIndex].levelProgress;
                return (_SafeStr_25.clamp(((_currentLevelIndex * progressPerLevel) + (_local_1 * progressPerLevel))));
            };
        ...
        public function get progressForCurrentLevel():Number
        {
            if (_levels.length > 0)
            {
                return (_currentLevelIndex * progressPerLevel);
            };
        ...
        {
            _levels.shift();
            _currentLevelIndex = Math.max(0, (_currentLevelIndex - 1));
        }
