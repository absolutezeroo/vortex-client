package com.sulake.habbo.inventory.pets
{
    ...
    public class PetsView implements IInventoryView, IGetImageListener 
    {
        ...
        public function addPet(_arg_1:PetData):void
        {
            ...
            var _local_2:PetsGridItem = new PetsGridItem(this, _arg_1, _windowManager, _assetLibrary, _model.isUnseen(_arg_1.id));
        ...
        {
            _model.placePetToRoom(_arg_1, _arg_2);
        }
        ...
        public function getPetImage(_arg_1:PetData, _arg_2:int, _arg_3:Boolean, _arg_4:PetsGridItem=null, _arg_5:int=64, _arg_6:String=null):BitmapData
        {
            ...
            if (_local_12 != null)
            {
                ...
                else
                {
                    if (_arg_3)
                    {
                        _previewImageDownloadId = _local_12.id;
                    };
                };
            };
        ...
        {
            if (_arg_1 == _previewImageDownloadId)
            {
                updatePreview(_selectedGridItem);
                return;
            };
        ...
        private function updateGrid():void
        {
            ...
            var _local_2:Array = ((_model.pets) ? _model.pets.getKeys() : []);
            _grid.lock();
            ...
            for each (_local_4 in _local_2)
            {
                ...
                {
                    addPet(_model.pets.getValue(_local_4));
                };
        ...
        private function startPlacingHandler(_arg_1:WindowMouseEvent):void
        {
            ...
            var _local_2:PetData = _selectedGridItem.pet;
        ...
        {
            if (_model.controller.currentCategoryId != "pets")
            {
                return;
            };
        ...
        private function updatePreview(_arg_1:PetsGridItem=null):void
        {
            ...
            var _local_10:IBitmapWrapperWindow = (_view.findChildByName("preview_image") as IBitmapWrapperWindow);
            ...
            var _local_6:ITextWindow = (_view.findChildByName("preview_text") as ITextWindow);
            ...
            _local_6 = (_view.findChildByName("preview_description") as ITextWindow);
            ...
            {
                _local_12 = _model.roomSession.arePetsAllowed;
                _local_13 = _model.roomSession.isRoomOwner;
            };
            ...
            var _local_9:_SafeStr_101 = (_view.findChildByName("place_button") as _SafeStr_101);
        ...
        private function init():void
        {
            ...
            _view = _model.controller.view.getView("pets");
            _view.visible = false;
