package com.sulake.habbo.inventory.trading
{
    ...
    public class TradingModel implements IInventoryModel, IGetImageListener
    {
        ...
        public function TradingModel(_arg_1:HabboInventory, _arg_2:IHabboWindowManager, _arg_3:IHabboCommunicationManager, _arg_4:IAssetLibrary, _arg_5:IRoomEngine, _arg_6:IHabboLocalizationManager, _arg_7:IHabboSoundManager)
        {
            ...
            _tradingView = new TradingView(this, _arg_2, _arg_4, _arg_5, _arg_6, _arg_7);
        }
        ...
        public function dispose():void
        {
            if (!_disposed)
            {
                if (((_tradingView) && (!(_tradingView.disposed))))
                {
        ...
        public function startTrading(_arg_1:int, _arg_2:String, _arg_3:Boolean, _arg_4:int, _arg_5:String, _arg_6:Boolean):void
        {
            ...
            _running = true;
            state = 1;
            _tradingView.setup(_arg_1, _arg_3, _arg_4, _arg_6);
            _tradingView.updateItemList(_ownUserId);
            _tradingView.updateItemList(_otherUserId);
            _tradingView.updateUserInterface();
            _tradingView.clearItemLists();
        ...
        public function close():void
        {
            ...
            _tradingView.setMinimized(false);
        }

        public function categorySwitch(_arg_1:String):void
        {
            _tradingView.setMinimized((!(_arg_1 == "furni")));
        ...
        {
            _tradingView.startConfirmCountdown();
        }

        public function cancelConfirmCountdown():void
        {
            _tradingView.cancelConfirmCountdown();
        }
        ...
        {
            _tradingView.updateItemImage(_arg_1, _arg_2);
        }
        ...
        public function handleMessageEvent(_arg_1:IMessageEvent):void
        {
            ...
            if ((_arg_1 is TradeOpenFailedEvent))
            {
                ...
                {
                    _tradingView.alertPopup(2);
                }

                else
                {
                    _tradingView.alertTradeOpenFailed(TradeOpenFailedEvent(_arg_1));
                };
            }
                        ...
                        else
                        {
                            if ((_arg_1 is TradingCloseEvent))
                            {
                                ...
                                if (_local_2.getParser().reason == 1)
                                {
                                    ...
                                    {
                                        _tradingView.windowManager.simpleAlert("${inventory.trading.notification.title}", "${inventory.trading.notification.commiterror.caption}", "${inventory.trading.notification.commiterror.info}");
                                    };
                                }
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        _tradingView.showOtherUserNotification("${inventory.trading.warning.others_account_disabled}");
                                    }
                                    ...
                                    else
                                    {
                                        ...
                                        {
                                            _tradingView.showOwnUserNotification("${inventory.trading.warning.own_account_disabled}");
                                        }
