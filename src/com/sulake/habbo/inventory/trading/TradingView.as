package com.sulake.habbo.inventory.trading
{
    ...
    public class TradingView implements IInventoryView, IGetImageListener
    {
        ...
        public function TradingView(_arg_1:TradingModel, _arg_2:IHabboWindowManager, _arg_3:IAssetLibrary, _arg_4:IRoomEngine, _arg_5:IHabboLocalizationManager, _arg_6:IHabboSoundManager)
        {
            ...
            var _local_8:IAsset = _assetLibrary.getAssetByName("item_popup_xml");
            ...
            _popupCtrl = new ItemPopupCtrl(_local_9, _assetLibrary, _windowManager, _tradingModel);
        ...
        public function dispose():void
        {
            if (!_disposed)
            {
                if (((_windowFull) && (!(_windowFull.disposed))))
                {
                    _windowFull.dispose();
                    _windowFull = null;
                };
                ...
                if (_timer)
                {
                    _timer.removeEventListener("timer", timerEventHandler);
                    _timer.stop();
                    _timer = null;
                };
        ...
        public function getWindowContainer():IWindowContainer
        {
            if (_windowFull == null)
            {
                _windowFull = createNormalWindow();
        ...
        public function updateItemList(_arg_1:int):void
        {
            ...
            var _local_8:uint;
            var _local_11:Boolean = (_arg_1 == _tradingModel.otherUserId);
            var _local_10:Map = ((_local_11) ? _tradingModel.otherUserItems : _tradingModel.ownUserItems);
        ...
        public function updateUserInterface():void
        {
            ...
            {
                updateActionState();
                _local_3 = (_windowFull.findChildByTag("OTHER_USER_NAME") as ITextWindow);

                if (_local_3)
                {
                    _local_3.text = _tradingModel.otherUserName;
                };

                _windowFull.findChildByTag("OWN_USER_ACCEPTED").visible = _tradingModel.ownUserAccepts;
                _local_2 = (_windowFull.findChildByTag("OWN_USER_LOCK") as IStaticBitmapWrapperWindow);

                if (_local_2)
                {
                    _local_2.assetUri = ((_tradingModel.ownUserAccepts) ? "talent_locked_achievement" : "inventory_trading_trading_unlocked_icon");
                };

                _windowFull.findChildByTag("OTHER_USER_ACCEPTED").visible = _tradingModel.otherUserAccepts;
                _local_2 = (_windowFull.findChildByTag("OTHER_USER_LOCK") as IStaticBitmapWrapperWindow);

                if (_local_2)
                {
                    _local_2.assetUri = ((_tradingModel.otherUserAccepts) ? "talent_locked_achievement" : "inventory_trading_trading_unlocked_icon");
                };
            };
        }
        ...
        public function updateActionState():void
        {
            ...
            if (_windowFull)
            {
                _local_1 = _windowFull.findChildByName("button_accept");
                ...
                if (_tradingModel.getInventory().getBoolean("trading.warning.enabled"))
                {
                    if (_tradingModel.isCreditFurniPresent())
                    {
                ...
                showOwnOfferInfo(_tradingModel.ownUserNumItems, _tradingModel.ownUserNumCredits);
                showOtherOfferInfo(_tradingModel.otherUserNumItems, _tradingModel.otherUserNumCredits);
                switch (_tradingModel.state)
                {
                    case 0:

                        if (((_tradingModel.otherUserItems.length > 0) || (_tradingModel.ownUserItems.length > 0)))
                        {
                            _local_1.enable();
                        }
                    ...
                    case 1:
                        ...
                        _local_1.caption = ((_tradingModel.ownUserAccepts) ? "${inventory.trading.modify}" : "${inventory.trading.accept}");
                    ...
                    case 6:
                        return;
                    default:
                        throw (new Error((('Unknown trading progress state: "' + _tradingModel.state) + '"')));
                };
            };
        }
        ...
        {
            var _local_2:ITextWindow = (_windowFull.findChildByName("help_text") as ITextWindow);
        ...
        private function showHighlightInfo(_arg_1:String):void
        {
            ...
            var _local_3:IWindow = _windowFull.findChildByName("info_border_highlighted");
            ...
            var _local_2:ITextWindow = (_windowFull.findChildByName("info_text_highlighted") as ITextWindow);
        ...
        private function showOfferInfo(_arg_1:String, _arg_2:int, _arg_3:String, _arg_4:int, _arg_5:Boolean):void
        {
            ...
            _local_6 = (_windowFull.findChildByName(_arg_1) as ITextWindow);
            ...
            _local_6 = (_windowFull.findChildByName(_arg_3) as ITextWindow);
        ...
        {
            var _local_3:ITextWindow = (_windowFull.findChildByName("info_text_0") as ITextWindow);
            _local_3.text = _arg_1;
            _local_3.visible = true;

            var _local_2:IItemGridWindow = (_windowFull.findChildByName("item_grid_0") as IItemGridWindow);
        ...
        {
            var _local_2:ITextWindow = (_windowFull.findChildByName("info_text_0") as ITextWindow);
            _local_2.visible = false;

            var _local_1:IItemGridWindow = (_windowFull.findChildByName("item_grid_0") as IItemGridWindow);
        ...
        {
            var _local_3:ITextWindow = (_windowFull.findChildByName("info_text_1") as ITextWindow);
            _local_3.text = _arg_1;
            _local_3.visible = true;

            var _local_2:IItemGridWindow = (_windowFull.findChildByName("item_grid_1") as IItemGridWindow);
        ...
        {
            var _local_2:ITextWindow = (_windowFull.findChildByName("info_text_1") as ITextWindow);
            _local_2.visible = false;

            var _local_1:IItemGridWindow = (_windowFull.findChildByName("item_grid_1") as IItemGridWindow);
    ...
    _arg_1.dispose();
        ...
        public function startConfirmCountdown():void
        {
            if (_timer == null)
            {
                ...
                _timer.addEventListener("timer", timerEventHandler);
            };

            _timer.reset();
            _timer.repeatCount = 3;
            _timer.start();
        ...
        public function imageReady(_arg_1:int, _arg_2:BitmapData):void
        {
            ...
            var _local_5:uint;
            _local_6 = _tradingModel.ownUserItems;
            _local_3 = false;
            _local_5 = 0;
            ...
            if (_local_3)
            {
                updateItemList(_tradingModel.ownUserId);
            };

            _local_6 = _tradingModel.otherUserItems;
            _local_3 = false;
            _local_5 = 0;
            ...
            if (_local_3)
            {
                updateItemList(_tradingModel.otherUserId);
            };
        }
        ...
        {
            return (_windowFull.findChildByTag("OWN_USER_GRID") as IItemGridWindow);
        }

        protected function getOtherUsersItemGrid():IItemGridWindow
        {
            return (_windowFull.findChildByTag("OTHER_USER_GRID") as IItemGridWindow);
        }
        ...
        {
            var _local_1:XML = (XmlAsset(_assetLibrary.getAssetByName("inventory_thumb_xml")).content as XML);
        ...
        protected function selectOwnTradeItem(_arg_1:uint):void
        {
            ...
            if (((_tradingModel == null) || (_tradingModel.ownUserItems == null)))
            {
                return;
            };

            if (_arg_1 < _tradingModel.ownUserItems.length)
            {
                _local_2 = (_tradingModel.ownUserItems.getWithIndex(_arg_1) as GroupItem);
                setSelection(_local_2);

                if (_local_2)
                {
                    _tradingModel.getFurniInventoryModel().displayItemInfo(_local_2);
                };
            };
        }
        ...
        protected function selectOthersTradeItem(_arg_1:uint):void
        {
            ...
            if (((_tradingModel == null) || (_tradingModel.otherUserItems == null)))
            {
                return;
            };

            if (_arg_1 < _tradingModel.otherUserItems.length)
            {
                _local_2 = (_tradingModel.otherUserItems.getWithIndex(_arg_1) as GroupItem);
                setSelection(_local_2);
        ...
        private function createNormalWindow():IWindowContainer
        {
            ...
            var _local_1:XML = (XmlAsset(_assetLibrary.getAssetByName("inventory_trading_xml")).content as XML);
        ...
        {
            var _local_1:XML = (XmlAsset(_assetLibrary.getAssetByName("inventory_trading_minimized_xml")).content as XML);
            ...
            if (_arg_1.type == "WME_CLICK")
            {
                switch (_arg_2.name)
                {
                    case "button_continue":
                        _tradingModel.requestFurniViewOpen();
                        return;
                    case "button_cancel":
                        _tradingModel.requestCancelTrading();
                        return;
                };
            };
        }
                    ...
                    case "button_accept":
                        switch (_tradingModel.state)
                        {
                            case 1:
                                ...
                                if (((_tradingModel.otherUserItems.length == 0) && (!(_tradingModel.ownUserAccepts))))
                                {
                                    alertPopup(0);
                                };

                                if (_tradingModel.ownUserAccepts)
                                {
                                    _tradingModel.requestUnacceptTrading();
                                }

                                else
                                {
                                    _tradingModel.requestAcceptTrading();
                                };

                                break;
                            case 3:
                                _arg_2.disable();
                                _tradingModel.requestConfirmAcceptTrading();
                            default:
                        };
                    ...
                    case "button_cancel":
                        switch (_tradingModel.state)
                        {
                            case 1:
                                ...
                                break;
                            case 3:
                                _tradingModel.requestConfirmDeclineTrading();
                            default:
                        };
        ...
        private function thumbEventProc(_arg_1:WindowEvent, _arg_2:IWindow, _arg_3:Boolean):void
        {
            ...
            {
                _tradingModel.requestRemoveItemFromTrading(_arg_2.id);
            };
            ...
            if (_arg_1.type == "WME_OVER")
            {
                if (_arg_3)
                {
                    _local_8 = _tradingModel.ownUserItems.getWithIndex(_arg_2.id);
                }

                else
                {
                    _local_8 = _tradingModel.otherUserItems.getWithIndex(_arg_2.id);
                };
                ...
                {
                    _popupCtrl.updateContent((_arg_2 as IWindowContainer), _local_4.getItemTooltipText(), _local_4.getItemIcon(), null, 2, false);
                    _popupCtrl.show();
                    return;
                };
                ...
                _local_6 = _tradingModel.getItemImage(_local_5);
                ...
                _popupCtrl.updateContent((_arg_2 as IWindowContainer), _local_7, _local_6, _local_8.peek().stuffData, 2, isExternalImagetype(_local_5));
                _popupCtrl.show();
            }
        ...
        {
            if (!_tradingModel.getInventory())
            {
                return (false);
            };

            var _local_2:IFurnitureData = _tradingModel.getInventory().getFurnitureData(_arg_1.type, "i");
        ...
        {
            _windowManager.registerLocalizationParameter("inventory.trading.countdown", "counter", String((3 - _timer.currentCount)));

            if (_timer.currentCount == 3)
            {
                _tradingModel.confirmCountdownReady();
                _timer.reset();
            };
        }
        ...
        private function onSongInfoReceivedEvent(_arg_1:SongInfoReceivedEvent):void
        {
            ...
            if (_waitingSongInfo.length > 0)
            {
                ...
                {
                    if ((((_local_8) && (_tradingModel.ownUserItems.getWithIndex(_local_7) == _local_6)) || ((!(_local_8)) && (_tradingModel.otherUserItems.getWithIndex(_local_7) == _local_6))))
                    {
                        _local_4 = getTraxSongFurniName(_local_6, "", false);
                        _local_5 = _tradingModel.getItemImage(_local_3);
                        _local_2 = ((_local_8) ? getOwnUsersItemGrid().getGridItemAt(_local_7) : getOtherUsersItemGrid().getGridItemAt(_local_7));
                        _popupCtrl.updateContent((_local_2 as IWindowContainer), _local_4, _local_5);
                    };
                }
