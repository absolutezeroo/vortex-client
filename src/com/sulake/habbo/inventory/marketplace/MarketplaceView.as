package com.sulake.habbo.inventory.marketplace
{
    ...
    public class MarketplaceView implements IGetImageListener
    {
        ...
        public function showMakeOffer(_arg_1:FurnitureItem):void
        {
            ...
            if (((((!(_arg_1)) || (!(_localization))) || (!(_roomEngine))) || (!(_model))))
            {
                return;
            };
            ...
            var _local_2:ITextFieldWindow = (_view.findChildByName("price_input") as ITextFieldWindow);
            ...
            var _local_3:ITextWindow = (_view.findChildByName("average_price") as ITextWindow);
            ...
            {
                _local_7 = IWidgetWindow(_view.findChildByName("unique_item_overlay_widget"));
            ...
            {
                _local_10 = IWidgetWindow(_view.findChildByName("rarity_item_overlay_widget"));
        ...
        {
            if (((_arg_1 == null) || (_view == null)))
            {
                return;
            };

            var _local_5:IBitmapWrapperWindow = (_view.findChildByName("furni_image") as IBitmapWrapperWindow);
        ...
        private function setText(_arg_1:String, _arg_2:String):void
        {
            ...
            var _local_3:ITextWindow = (_view.findChildByName(_arg_1) as ITextWindow);
        ...
        private function showConfirmation():void
        {
            ...
            _localization.registerParameter("inventory.marketplace.confirm_offer.info", "price", calculateFinalPrice(_askingPrice).toString());
        ...
        private function createWindow(_arg_1:String):IWindow
        {
            ...
            var _local_2:XmlAsset = (_assetLibrary.getAssetByName(_arg_1) as XmlAsset);
            ...
            if (_arg_1.type == "WME_CLICK")
            {
                switch (_arg_2.name)
                {
                    ...
                    case "make_offer_button":
                        _local_3 = (_view.findChildByName("price_input") as ITextFieldWindow);

                        if (_local_3 != null)
                        {
                            _askingPrice = parseInt(_local_3.text);
                            showConfirmation();
                        };
        ...
        {
            HabboWebTools.openWebPageAndMinimizeClient(_habboInventory.getProperty("web.shop.relativeUrl"));
        }

        private function calculateFinalPrice(_arg_1:int):int
        {
            var _local_2:int = int(Math.ceil((Math.round((1000 * (_arg_1 * ((_model.sellingFeePercentage / 100) + ((0.5 * _arg_1) / _model.halfTaxLimit))))) / 1000)));
        ...
        private function checkPrice():void
        {
            ...
            if (_local_3 > _model.offerMaxPrice)
            {
                _local_2.text = _model.offerMaxPrice.toString();
                _local_3 = _model.offerMaxPrice;
            };

            var _local_4:int = calculateFinalPrice(_local_3);
            var _local_1:_SafeStr_101 = (_view.findChildByName("make_offer_button") as _SafeStr_101);
            var _local_5:ITextWindow = (_view.findChildByName("final_price") as ITextWindow);
            ...
            if (_local_3 < _model.offerMinPrice)
            {
                _localization.registerParameter("shop.marketplace.invalid.price", "minPrice", _model.offerMinPrice.toString());
                _localization.registerParameter("shop.marketplace.invalid.price", "maxPrice", _model.offerMaxPrice.toString());
        ...
        public function updateAveragePrice(_arg_1:int, _arg_2:int):void
        {
            ...
            var _local_6:int = int(Math.floor((_arg_1 / (1 + (_model.commission * 0.01)))));
