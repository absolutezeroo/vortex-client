package com.sulake.habbo.inventory.effects
{
    ...
    public class EffectsModel implements IInventoryModel 
    {
        ...
        public function EffectsModel(_arg_1:HabboInventory, _arg_2:IHabboWindowManager, _arg_3:IHabboCommunicationManager, _arg_4:IAssetLibrary, _arg_5:IHabboLocalizationManager)
        {
            ...
            _activeEffectsProxy = new EffectListProxy(this, 1);
        ...
        public function dispose():void
        {
            if (!_disposed)
            {
                ...
                if (_activeEffectsProxy != null)
                {
                    _activeEffectsProxy.dispose();
                    _activeEffectsProxy = null;
                };
        ...
        private function getEffect(_arg_1:int):Effect
        {
            ...
            while (_local_3 < _effects.length)
            {
                _local_2 = _effects[_local_3];
        ...
        {
            _controller.communication.connection.send(new AvatarEffectActivatedComposer(_arg_1));
        }
        ...
        public function useEffect(_arg_1:int):void
        {
            ...
            {
                _local_2.isInUse = true;
                _controller.communication.connection.send(new AvatarEffectSelectedComposer(_arg_1));
        ...
        public function stopUsingEffect(_arg_1:int, _arg_2:Boolean=false):void
        {
            ...
            if (_local_3 != null)
            {
                if (_local_3.isInUse == true)
                {
                    ...
                    if (_arg_2)
                    {
                        _controller.communication.connection.send(new AvatarEffectSelectedComposer(-1));
        ...
        public function stopUsingAllEffects(_arg_1:Boolean=true, _arg_2:Boolean=true, _arg_3:Boolean=false):void
        {
            ...
            while (_local_5 < _effects.length)
            {
                _local_4 = _effects[_local_5];
        ...
        public function getEffects(_arg_1:int=-1):Array
        {
            ...
            while (_local_4 < _effects.length)
            {
                _local_3 = _effects[_local_4];
        ...
        {
            return ((_view) ? _view.getWindowContainer() : null);
        }
