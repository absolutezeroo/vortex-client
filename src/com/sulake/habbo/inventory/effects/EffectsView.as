package com.sulake.habbo.inventory.effects
{
    ...
    public class EffectsView implements IInventoryView
    {
        ...
        public function EffectsView(_arg_1:EffectsModel, _arg_2:IHabboWindowManager, _arg_3:IAssetLibrary, _arg_4:IHabboLocalizationManager, _arg_5:IThumbListDataProvider, _arg_6:IThumbListDataProvider)
        {
            ...
            var _local_9:IAsset = _assetLibrary.getAssetByName("inventory_effects_xml");
            var _local_7:XmlAsset = XmlAsset(_local_9);
            _view = IWindowContainer(_windowManager.buildFromXML(XML(_local_7.content)));
            _view.visible = false;
            _view.procedure = windowEventProc;
            _listManagerActive = new ThumbListManager(_assetLibrary, _arg_5, "thumb_bg_png", "thumb_bg_selected_png", getActiveThumbListImageWidth(), getActiveThumbListImageHeight());
            _listManagerInactive = new ThumbListManager(_assetLibrary, _arg_6, "thumb_bg_png", "thumb_bg_selected_png", getActiveThumbListImageWidth(), getActiveThumbListImageHeight());

            var _local_10:IBitmapWrapperWindow = (_view.findChildByName("active_items_image") as IBitmapWrapperWindow);
            _local_10.procedure = activeThumbListEventProc;

            var _local_8:IBitmapWrapperWindow = (_view.findChildByName("inactive_items_image") as IBitmapWrapperWindow);
        ...
        public function dispose():void
        {
            if (!_disposed)
            {
                ...
                if (_listManagerActive != null)
                {
                    _listManagerActive.dispose();
                    _listManagerActive = null;
                };

                if (_listManagerInactive != null)
                {
                    _listManagerInactive.dispose();
                    _listManagerInactive = null;
                };
        ...
        {
            var _local_1:IBitmapWrapperWindow = (_view.findChildByName("active_items_image") as IBitmapWrapperWindow);
        ...
        {
            var _local_1:IBitmapWrapperWindow = (_view.findChildByName("inactive_items_image") as IBitmapWrapperWindow);
        ...
        public function updateListViews():void
        {
            ...
            _listManagerInactive.updateImageFromList();
            _listManagerActive.updateImageFromList();

            var _local_2:IBitmapWrapperWindow = (_view.findChildByName("inactive_items_image") as IBitmapWrapperWindow);
            var _local_4:BitmapData = _listManagerInactive.getListImage();
            _local_2.bitmap = _local_4;
            _local_2.width = _local_4.width;
            _local_2.height = _local_4.height;
            _local_2.invalidate();

            var _local_3:IBitmapWrapperWindow = (_view.findChildByName("active_items_image") as IBitmapWrapperWindow);
            var _local_1:BitmapData = _listManagerActive.getListImage();
        ...
        public function updateActionView():void
        {
            ...
            var _local_2:_SafeStr_101 = (_view.findChildByName("activateEffect_button") as _SafeStr_101);
            var _local_3:ITextWindow = (_view.findChildByName("effectDescriptionText") as ITextWindow);
            ...
            var _local_1:Effect = _model.getSelectedEffect(-1);
        ...
        private function setEffectDescriptionImage(_arg_1:BitmapData):void
        {
            ...
            var _local_3:IBitmapWrapperWindow = (_view.findChildByName("effectDescriptionImage") as IBitmapWrapperWindow);
        ...
        private function activeThumbListEventProc(_arg_1:WindowEvent, _arg_2:IWindow):void
        {
            ...
            if (_arg_1.type == "WME_CLICK")
            {
                ...
                _local_5 = _listManagerActive.resolveIndexFromImageLocation(_local_3);
                _local_4 = _model.getItemInIndex(_local_5, 1);

                if (_local_4 != null)
                {
                    _model.toggleEffectSelected(_local_4.type);
                };
            };
        }
        ...
        private function inactiveThumbListEventProc(_arg_1:WindowEvent, _arg_2:IWindow):void
        {
            ...
            {
                _local_3 = new Point(WindowMouseEvent(_arg_1).localX, WindowMouseEvent(_arg_1).localY);
                _local_5 = _listManagerInactive.resolveIndexFromImageLocation(_local_3);
                _local_4 = _model.getItemInIndex(_local_5, 0);
        ...
        private function windowEventProc(_arg_1:WindowEvent, _arg_2:IWindow):void
        {
            ...
            if (_arg_1.type == "WME_CLICK")
            {
                ...
                {
                    _local_3 = _model.getSelectedEffect(0);

                    if (_local_3 != null)
                    {
                        _model.requestEffectActivated(_local_3.type);
                    };
                };
            };
        }
