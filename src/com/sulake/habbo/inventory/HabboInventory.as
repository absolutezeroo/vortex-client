package com.sulake.habbo.inventory
{
    ...
    public class HabboInventory extends Component implements IHabboInventory, ILinkEventTracker
    {
        ...
        override public function dispose():void
        {
            ...
            {
                _purseTimer.stop();
                _purseTimer.removeEventListener("timer", onPurseTimer);
                _purseTimer = null;
            };

            if (_inventories)
            {
                _local_4 = _inventories.getKeys();
                _local_1 = 0;

                while (_local_1 < _local_4.length)
                {
                    _local_3 = _local_4[_local_1];
                    _local_2 = (_inventories.getValue(_local_3) as IInventoryModel);
        ...
        public function getModel(_arg_1:String):IInventoryModel
        {
            ...
            return (_inventories.getValue(_arg_1));
        }
        ...
        {
            return (_purse.clubDays);
        }

        public function get clubPeriods():int
        {
            return (_purse.clubPeriods);
        }

        public function get clubPastPeriods():int
        {
            return (_purse.clubPastPeriods);
        }

        public function get clubHasEverBeenMember():Boolean
        {
            return (_purse.clubHasEverBeenMember);
        }

        public function get clubIsExpiring():Boolean
        {
            return (_purse.clubIsExpiring);
        }

        public function get citizenshipVipIsExpiring():Boolean
        {
            return (_purse.citizenshipVipIsExpiring);
        }

        public function get clubMinutesUntilExpiration():int
        {
            return (_purse.minutesUntilExpiration);
        }
        ...
        {
            _purse.clubPeriods = _arg_1;
            _purse.clubDays = _arg_2;
            _purse.clubHasEverBeenMember = _arg_3;
            _purse.isVIP = _arg_4;
            _purse.clubIsExpiring = _arg_5;
            _purse.citizenshipVipIsExpiring = _arg_6;
            _purse.minutesUntilExpiration = _arg_7;
            _purse.minutesSinceLastModified = _arg_8;

            if (((_arg_7 > 0) && (_arg_7 < 86400000)))
            {
                if (_purseTimer == null)
                {
                    _purseTimer = new Timer(60000, 0);
                    _purseTimer.addEventListener("timer", onPurseTimer);
                };

                if (!_purseTimer.running)
                {
                    _purseTimer.start();
                };
            }
        ...
        private function init():void
        {
            ...
            _inventories.add("marketplace", _local_6);
        ...
        public function toggleInventoryPage(_arg_1:String, _arg_2:String=null, _arg_3:Boolean=false):void
        {
            ...
            if (_local_4)
            {
                ...
                if (_arg_2 != null)
                {
                    IInventoryModel(_inventories.getValue(_currentCategoryId)).selectItemById(_arg_2);
                };
            };
        ...
        public function toggleInventorySubPage(_arg_1:String):void
        {
            ...
            while (_local_2 < _inventories.length)
            {
                _local_3 = (_inventories.getWithIndex(_local_2) as IInventoryModel);
        ...
        public function closingInventoryView():void
        {
            ...
            if (_inventories)
            {
                ...
                while (_local_1 < _inventories.length)
                {
                    _local_2 = (_inventories.getWithIndex(_local_1) as IInventoryModel);
        ...
        public function setInventoryCategoryInit(_arg_1:String, _arg_2:Boolean=true):void
        {
            ...
            if (_arg_2)
            {
                if (_initedInventoryCategories.indexOf(_arg_1) == -1)
                {
                    _initedInventoryCategories.push(_arg_1);
                };
            }

            else
            {
                _local_3 = _initedInventoryCategories.indexOf(_arg_1);

                if (_local_3 >= 0)
                {
                    _initedInventoryCategories.splice(_local_3, 1);
                };
        ...
        {
            return (_initedInventoryCategories.indexOf(_arg_1) >= 0);
        }
        ...
        {
            var _local_2:IInventoryModel = (_inventories.getValue(_arg_1) as IInventoryModel);
        ...
        {
            var _local_4:FurniModel = _inventories.getValue(_arg_1);
        ...
        {
            var _local_2:BadgesModel = _inventories.getValue("badges");
            var _local_4:Array = [];

            if (((_local_2.getBadges().length == 0) && (!(_externalBadgesInitializationRequested))))
            {
                badgesModel.requestInitialization();
                _externalBadgesInitializationRequested = true;
            };
