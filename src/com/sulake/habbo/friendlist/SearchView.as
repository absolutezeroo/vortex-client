package com.sulake.habbo.friendlist
{
    ...
    public class SearchView implements ITabView, ISearchView 
    {
        ...
        {
            _searchStr = ITextFieldWindow(_arg_1.findChildByName("search_str"));
        ...
        private function refreshShading():void
        {
            ...
            {
                _list.getListItemAt(_local_1).color = _friendList.laf.getRowShadingColor(3, ((_local_1 % 2) == 1));
                _local_1++;
            };
        }
        ...
        {
            var _local_9:IWindowContainer = (_list.getListItemAt(_arg_2) as IWindowContainer);
        ...
        private function findIndexFor(_arg_1:int):int
        {
            ...
            while (_local_2 < _list.numListItems)
            {
                if (_list.getListItemAt(_local_2).id == _arg_1)
                {
                    return (_local_2);
                };
        ...
        private function onSearchStrInput(_arg_1:WindowKeyboardEvent):void
        {
            ...
            {
                _local_2 = 25;
                _local_4 = _searchStr.text;

                if (_local_4.length > _local_2)
                {
                    _searchStr.text = _local_4.substring(0, _local_2);
                };
            };
        }
        ...
        {
            var _local_1:String = _searchStr.text;
