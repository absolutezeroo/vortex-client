package com.sulake.habbo.groups.badge
{
    ...
    public class BadgeEditorCtrl implements IDisposable 
    {
        ...
        {
            _manager = _arg_1;
            _manager.events.addEventListener("HGE_EDIT_INFO", onHabboGroupsEditorData);
            _badgeSelectPartCtrl = new BadgeSelectPartCtrl(_manager, this);
            _layers = new Vector.<BadgeLayerCtrl>();
            _layers.push(new BadgeLayerCtrl(_manager, this, 0));
            _layers.push(new BadgeLayerCtrl(_manager, this, 1));
            _layers.push(new BadgeLayerCtrl(_manager, this, 2));
            _layers.push(new BadgeLayerCtrl(_manager, this, 3));
            _layers.push(new BadgeLayerCtrl(_manager, this, 4));
        }
        ...
        {
            return ((!(_window == null)) && (!(_badgeInitData == null)));
        }
        ...
        public function dispose():void
        {
            if (!_disposed)
            {
                ...
                {
                    for each (var _local_2:IBitmapWrapperWindow in _badgePreviewImages)
                    {
                        _local_2.dispose();
                    };
        ...
        public function createWindow(_arg_1:IWindowContainer, _arg_2:Array):void
        {
            ...
            if (_arg_1 != null)
            {
                _parentWindow = _arg_1;
            };

            if (_arg_2 != null)
            {
                _badgeInitData = _arg_2;
            };

            if (((((_parentWindow == null) || (_badgeInitData == null)) || (_manager == null)) || (_manager.guildEditorData == null)))
            {
                return;
            };

            _window = (_manager.getXmlWindow("badge_editor") as IWindowContainer);

            var _local_4:IWindowContainer = (_window.findChildByName("guild_badge") as IWindowContainer);
            _badgePreviewImages = new Vector.<IBitmapWrapperWindow>();
            _badgePreviewImages.push((_local_4.findChildByName("layer_0") as IBitmapWrapperWindow));
            _badgePreviewImages.push((_local_4.findChildByName("layer_1") as IBitmapWrapperWindow));
            _badgePreviewImages.push((_local_4.findChildByName("layer_2") as IBitmapWrapperWindow));
            _badgePreviewImages.push((_local_4.findChildByName("layer_3") as IBitmapWrapperWindow));
            _badgePreviewImages.push((_local_4.findChildByName("layer_4") as IBitmapWrapperWindow));
            ...
            resetLayerOptions(_badgeInitData);
            _parentWindow.addChild(_window);
        }
        ...
        {
            var _local_3:int;
            var _local_2:GuildBadgeSettings = (_badgeInitData[_arg_1] as GuildBadgeSettings);
            ...
            while (_local_3 < _manager.guildEditorData.badgeColors.length)
            {
                if (_manager.guildEditorData.badgeColors[_local_3].id == _local_2.colorId)
                {
            ...
            if (_arg_1 == BadgeLayerCtrl.BASE_LAYER_INDEX)
            {
                ...
                while (_local_3 < _manager.guildEditorData.baseParts.length)
                {
                    if (_manager.guildEditorData.baseParts[_local_3].id == _local_2.partId)
                    {
            ...
            else
            {
                ...
                while (_local_3 < _manager.guildEditorData.layerParts.length)
                {
                    if (_manager.guildEditorData.layerParts[_local_3].id == _local_2.partId)
                    {
                        _local_4.partIndex = _local_3;
                        break;
                    };
        ...
        public function updatePreviewImage(_arg_1:BadgeLayerOptions):void
        {
            ...
            if (_local_2 != null)
            {
                _badgePreviewImages[_arg_1.layerIndex].bitmap = _local_2.clone();
                _badgePreviewImages[_arg_1.layerIndex].visible = true;
            }

            else
            {
                _badgePreviewImages[_arg_1.layerIndex].visible = false;
            };
        }
        ...
        private function getLayerPartId(_arg_1:BadgeLayerOptions):int
        {
            ...
            {
                if (_arg_1.partIndex >= _manager.guildEditorData.baseParts.length)
                {
                    return (-1);
                };

                return (_manager.guildEditorData.baseParts[_arg_1.partIndex].id);
            };

            if (_arg_1.partIndex >= _manager.guildEditorData.layerParts.length)
            {
                return (-1);
            };

            return (_manager.guildEditorData.layerParts[_arg_1.partIndex].id);
        }

        private function getLayerColorId(_arg_1:BadgeLayerOptions):int
        {
            if (((_arg_1.colorIndex < 0) || (_arg_1.colorIndex >= _manager.guildEditorData.badgeColors.length)))
            {
                return (-1);
            };

            return (_manager.guildEditorData.badgeColors[_arg_1.colorIndex].id);
        }
