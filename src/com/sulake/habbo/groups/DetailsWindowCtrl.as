package com.sulake.habbo.groups
{
    ...
    public class DetailsWindowCtrl implements IDisposable 
    {
        ...
        {
            _manager = _arg_1;
            _groupDetailsCtrl = new GroupDetailsCtrl(_arg_1, true);
        }
        ...
        public function onGroupDetails(_arg_1:HabboGroupDetailsData):void
        {
            if (((((!(_window == null)) && (_window.visible)) && (_arg_1.groupId == _groupId)) || (_arg_1.openDetails)))
            {
                ...
                prepareWindow();
                _groupDetailsCtrl.onGroupDetails(IWindowContainer(_window.findChildByName("group_cont")), _arg_1);
        ...
        private function prepareWindow():void
        {
            ...
            _window = IFrameWindow(_manager.getXmlWindow("group_info_window"));
