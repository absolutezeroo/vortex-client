package com.sulake.habbo.roomevents.userdefinedroomevents.actiontypes
{
    ...
    public class GiveReward extends DefaultActionType
    {
        ...
        override public function readIntParamsFromForm(_arg_1:IWindowContainer):Array
        {
            ...
            _local_2.push(((getPrizeLimitCheckBox(_arg_1).isSelected) ? _prizeLimitSlider.getValue() : 0));
        ...
        override public function onInit(_arg_1:IWindowContainer, _arg_2:HabboUserDefinedRoomEvents):void
        {
            ...
            var _local_4:IWindowContainer;
            _roomEvents = _arg_2;
            _prizeLimitSlider = new SliderWindowController(_arg_2, getPrizeLimitSliderContainer(_arg_1), _arg_2.assets, 1, 1000, 1);
            _prizeLimitSlider.addEventListener("change", onSliderChange);
            _prizeLimitSlider.setValue(1);
        ...
        override public function onEditStart(_arg_1:IWindowContainer, _arg_2:Triggerable):void
        {
            ...
            if (_local_4 > 0)
            {
                _prizeLimitSlider.setValue(_local_4);
        ...
        private function refreshPrizeLimit(_arg_1:IWindowContainer):void
        {
            ...
            setPrizeLimitAmount(((_local_2) ? ("" + _prizeLimitSlider.getValue()) : ""));
        }
        ...
        private function setEntryVisibilities(_arg_1:IWindowContainer):void
        {
            ...
            while (_local_4 < 20)
            {
                ...
                _local_3.visible = (_local_4 < _displayedRewards);
                _local_4++;
            };
