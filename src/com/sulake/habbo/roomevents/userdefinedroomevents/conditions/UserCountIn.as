package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
    ...
    public class UserCountIn extends DefaultConditionType 
    {
        ...
        {
            var _local_2:Array = [];
            _local_2.push(_minSlider.getValue());
            _local_2.push(_maxSlider.getValue());
            return (_local_2);
        }
        ...
        {
            _roomEvents = _arg_2;
            _minSlider = new SliderWindowController(_arg_2, getMinInput(_arg_1), _arg_2.assets, 1, 50, 1);
            _minSlider.addEventListener("change", onMinSliderChange);
            _minSlider.setValue(1);
            _maxSlider = new SliderWindowController(_arg_2, getMaxInput(_arg_1), _arg_2.assets, 1, 50, 1);
            _maxSlider.addEventListener("change", onMaxSliderChange);
            _maxSlider.setValue(50);
        }
        ...
        override public function onEditStart(_arg_1:IWindowContainer, _arg_2:Triggerable):void
        {
            ...
            _minSlider.setValue(_local_3);
            _maxSlider.setValue(_local_4);
        }
