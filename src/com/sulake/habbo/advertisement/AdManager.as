package com.sulake.habbo.advertisement
{
    ...
    public class AdManager extends Component implements IAdManager 
    {
        ...
        override protected function initComponent():void
        {
            ...
            _interstitialMessageEvent = _communicationManager.addHabboConnectionMessageEvent(new InterstitialMessageEvent(onInterstitial));
        ...
        override public function dispose():void
        {
            ...
            {
                _communicationManager.removeHabboConnectionMessageEvent(_interstitialMessageEvent);
                _interstitialMessageEvent = null;
            };

            if (_roomAdWarningImageLeft)
            {
                _roomAdWarningImageLeft.dispose();
                _roomAdWarningImageLeft = null;
            };

            if (_roomAdWarningImageRight)
            {
                _roomAdWarningImageRight.dispose();
                _roomAdWarningImageRight = null;
            };
        ...
        private function adWarningLeftReady(_arg_1:AssetLoaderEvent):void
        {
            ...
            if (_local_2 != null)
            {
                _roomAdWarningImageLeft = emulateBackgroundTransparency(_local_2.bitmapData);
            };
        }
        ...
        private function adWarningRightReady(_arg_1:AssetLoaderEvent):void
        {
            ...
            if (_local_2 != null)
            {
                _roomAdWarningImageRight = emulateBackgroundTransparency(_local_2.bitmapData);
            };
        }
