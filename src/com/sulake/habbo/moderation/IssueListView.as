package com.sulake.habbo.moderation
{
    ...
    public class IssueListView 
    {
        ...
        public function IssueListView(_arg_1:IssueManager, _arg_2:IssueBrowser, _arg_3:IItemListWindow)
        {
            ...
            _list = _arg_3;
            _listItem = (_arg_3.getListItemAt(0) as IWindowContainer);
            _arg_3.removeListItems();
            _issueListLimit = _arg_1.issueListLimit;
        }
        ...
        public function update(_arg_1:Array):void
        {
            ...
            var _local_13:int = _list.numListItems;
            var _local_5:int = _arg_1.length;

            if (_local_5 > _issueListLimit)
            {
                _local_5 = _issueListLimit;
            };
            ...
            else
            {
                if (_local_13 > _local_5)
                {
                    ...
                    {
                        _local_3 = _list.removeListItemAt(0);
                        _local_3.dispose();
                        _local_9++;
                    };
                };
            ...
            {
                if (_local_9 > _issueListLimit) break;

                if (((_local_12 == null) || (_listItem == null)))
                {
                    return;
                };

                _local_2 = (_list.getListItemAt((_local_9 - 1)) as IWindowContainer);
                ...
                if (_local_8 != null)
                {
                    ...
                    _local_11 = (_issueBrowser.assets.getAssetByName(_local_10) as BitmapDataAsset);
        ...
        private function onPick(_arg_1:WindowMouseEvent):void
        {
            ...
            _issueManager.pickBundle(_arg_1.window.id, "pick button");
        }
        ...
        private function onHandle(_arg_1:WindowMouseEvent):void
        {
            ...
            _issueManager.handleBundle(_arg_1.window.id);
        }
        ...
        private function onRelease(_arg_1:WindowMouseEvent):void
        {
            ...
            _issueManager.releaseBundle(_arg_1.window.id);
        }
