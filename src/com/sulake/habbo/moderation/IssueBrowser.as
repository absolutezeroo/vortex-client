    ...
    public class IssueBrowser 
    {
        ...
        private function createMainFrame():void
        {
            ...
            if (_window == null)
            {
                ...
                _myIssuesView = new MyIssuesView(issueManager, this, (_window.findChildByName("my_issues_prototype") as IWindowContainer));
                _openIssuesView = new OpenIssuesView(issueManager, this, (_window.findChildByName("open_issues_prototype") as IWindowContainer));
                _pickedIssuesView = new PickedIssuesView(issueManager, this, (_window.findChildByName("picked_issues_prototype") as IWindowContainer));
            };
        ...
        private function selectView(_arg_1:String):void
        {
            ...
            _selectedView.view.width = _tabContext.container.width;
            _selectedView.view.height = _tabContext.container.height;
            _selectedView.visible = true;
            _selectedView.update();
        }
        ...
        private function getView(_arg_1:String):IIssueBrowserView
        {
            ...
            {
                case "my_issues":
                    return (_myIssuesView);
                case "open_issues":
                    return (_openIssuesView);
                case "picked_issues":
                    return (_pickedIssuesView);
                default:
                    return (null);
            };
        }
