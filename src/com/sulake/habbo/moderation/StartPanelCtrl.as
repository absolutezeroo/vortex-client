package com.sulake.habbo.moderation
{
    ...
    public class StartPanelCtrl implements IDisposable 
    {
        ...
        {
            _main.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(((_isGuestRoom) ? 0 : 1), _roomId), _main, 4, _roomId), _frame, false, false, true);
        }

        private function onUserinfoButton(_arg_1:WindowEvent):void
        {
            _main.windowTracker.show(new UserInfoFrameCtrl(_main, _userId), _frame, false, false, true);
        }
