package com.sulake.habbo.notifications.singular
{
    ...
    public class HabboNotificationItemView implements IUpdateReceiver 
    {
        ...
        public function HabboNotificationItemView(_arg_1:IAsset, _arg_2:IHabboWindowManager, _arg_3:Map, _arg_4:Map, _arg_5:HabboNotificationItem)
        {
            ...
            _windowMinHeight = _window.height;
            _verticalPosition = 4;
            _blend = 0;
            _state = 0;
            showItem(_arg_5);
        ...
        {
            if (_arg_1.badgeId != _item.style.iconSrc)
            {
                return;
            };
        ...
        public function update(_arg_1:uint):void
        {
            ...
            switch (_state)
            {
                case 0:
                    return;
                case 1:
                    _fadeInStart = (_fadeInStart + _arg_1);
                    _local_2 = (_fadeInStart / _viewConfig["time_fade_in"]);

                    if (_fadeInStart > _viewConfig["time_fade_in"])
                    {
                        startDisplay();
                    };
                    ...
                    return;
                case 2:
                    _displayStart = (_displayStart + _arg_1);

                    if (((_displayStart > _viewConfig["time_display"]) && (!(_hovering))))
                    {
                        startFadeOut();
                    };
                    ...
                    return;
                case 3:
                    _fadeOutStart = (_fadeOutStart + _arg_1);
                    _local_3 = (1 - (_fadeOutStart / _viewConfig["time_fade_out"]));
                    adjustBlend(_local_3);

                    if (_fadeOutStart > _viewConfig["time_fade_in"])
                    {
                        startIdling();
                    };
        ...
        private function setNotificationText(_arg_1:String):void
        {
            ...
            if (_window.height < _windowMinHeight)
            {
                _window.height = _windowMinHeight;
            };
        }
