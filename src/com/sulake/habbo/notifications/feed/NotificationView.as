package com.sulake.habbo.notifications.feed
{
    ...
    public class NotificationView 
    {
        ...
        public function dispose():void
        {
            ...
            if (_views)
            {
                for each (var _local_1:IDisposable in _views)
                {
                    _local_1.dispose();
                };
        ...
        {
            return (_component.windowManager);
        }

        public function get assets():IAssetLibrary
        {
            return (_component.assets);
        }

        public function get localization():IHabboLocalizationManager
        {
            return (_component.localization);
        }
        ...
        private function setupUserInterface():void
        {
            ...
            _window = (_component.windowManager.buildFromXML((_component.assets.getAssetByName("feed_display_xml").content as XML)) as IWindowContainer);
            ...
            _views = new Map();
            _views.add("pane_notifications", new NotificationsPane("pane_notifications", this, (_window.findChildByName("pane_notifications") as IWindowContainer)));
            _views.add("pane_stream", new StreamPane("pane_stream", this, (_window.findChildByName("pane_stream") as IWindowContainer)));
            _views.add("pane_info", new InfoPane("pane_info", this, (_window.findChildByName("pane_info") as IWindowContainer)));
            _views.add("pane_settings", new SettingsPane("pane_settings", this, (_window.findChildByName("pane_settings") as IWindowContainer)));
            _views.add("pane_status", new StatusPane("pane_status", this, (_window.findChildByName("pane_status") as IWindowContainer)));
        }
        ...
        public function setVisibilityState(_arg_1:int):void
        {
            ...
            var _local_3:int = _stateController.requestState(_arg_1);
            switch (_local_3)
            {
                case 0:
        ...
        {
            _stateController.setEnabled(_arg_1);
            setVisibilityState(_stateController.currentState());
        }

        public function setGameMode(_arg_1:Boolean):void
        {
            _stateController.setGameMode(_arg_1);
            setVisibilityState(_stateController.currentState());
        }

        public function switchToPane(_arg_1:String):void
        {
            var _local_2:IPane = _views.getValue(_arg_1);
        ...
        {
            for each (var _local_2:AbstractPane in _views)
            {
        ...
        {
            (_views.getValue("pane_notifications") as NotificationsPane).addItem(_arg_1, _arg_2);
        }

        public function addStreamFeedItem(_arg_1:IFeedEntity):void
        {
            (_views.getValue("pane_stream") as StreamPane).addItem(_arg_1);
        }
        ...
        {
            var _local_2:IPane = (_views.getValue("pane_settings") as IPane);
        ...
        {
            var _local_2:IPane = (_views.getValue("pane_info") as IPane);
