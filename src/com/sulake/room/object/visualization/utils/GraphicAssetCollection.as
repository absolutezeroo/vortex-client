package com.sulake.room.object.visualization.utils
{
    ...
    public class GraphicAssetCollection implements IGraphicAssetCollection 
    {
        ...
        public function GraphicAssetCollection()
        {
            _assets = new Map();
            _palettes = new Map();
            _paletteXMLs = new Map();
            _paletteAssetNames = [];
            _lazyAssetTable = new Dictionary();
        }
        ...
        public function dispose():void
        {
            ...
            if (_palettes != null)
            {
                for (_local_2 in _palettes)
                {
                    _local_1 = _palettes[_local_2];
            ...
            if (_lazyAssetTable)
            {
                for (var _local_4:String in _lazyAssetTable)
                {
                    delete _lazyAssetTable[_local_4];
                };
            };
        ...
        private function defineAssetsLazy(_arg_1:XMLList):void
        {
            ...
            for each (_local_2 in _arg_1)
            {
                ...
                {
                    _lazyAssetTable[_local_3] = _local_2;
                };
            };
        }
        ...
        private function defineAssets(_arg_1:XMLList):void
        {
            ...
            while (_local_3 < _local_14)
            {
                ...
                if (_local_10.length > 0)
                {
                    ...
                    _local_13 = _library.getAssetByName(_local_4);
        ...
        private function definePalettes(_arg_1:XMLList):void
        {
            ...
            for each (var _local_5:XML in _arg_1)
            {
                if (XmlUtil.checkRequiredAttributes(_local_5, PALETTE_ATTRIBUTES))
                {
                    ...
                    if (_palettes[_local_6] == null)
                    {
                        _local_8 = _library.getAssetByName(_local_7);
                        ...
                        else
                        {
                            ...
                            _palettes[_local_6] = _local_4;
                            _paletteXMLs[_local_6] = _local_5;
                        };
                    };
                };
            };
        ...
        public function getAsset(_arg_1:String):IGraphicAsset
        {
            ...
            var _local_5:XML = _lazyAssetTable[_arg_1];
            ...
            if (_local_5)
            {
                ...
                _local_11 = _library.getAssetByName(_local_7);
        ...
        public function getAssetWithPalette(_arg_1:String, _arg_2:String):IGraphicAsset
        {
            ...
            if (_local_9 == null)
            {
                ...
                _paletteAssetNames.push(_local_8);
        ...
        public function addAsset(_arg_1:String, _arg_2:BitmapData, _arg_3:Boolean, _arg_4:int=0, _arg_5:int=0, _arg_6:Boolean=false, _arg_7:Boolean=false):Boolean
        {
            ...
            if (_local_8 == null)
            {
                _local_8 = new BitmapDataAsset(_library.getAssetTypeDeclarationByClass(BitmapDataAsset));
                _library.setAsset(_arg_1, _local_8);
        ...
        {
            return (_library.getAssetByName(_arg_1) as BitmapDataAsset);
        }
        ...
        private function addLibraryAsset(_arg_1:String, _arg_2:BitmapData):BitmapDataAsset
        {
            ...
            if (_local_3 == null)
            {
                _local_3 = new BitmapDataAsset(_library.getAssetTypeDeclarationByClass(BitmapDataAsset));
                _library.setAsset(_arg_1, _local_3);
        ...
        private function disposePaletteAssets(_arg_1:Boolean=true):void
        {
            if (_paletteAssetNames != null)
            {
                if (((_arg_1) || (_paletteAssetNames.length > 10)))
                {
                    for each (var _local_2:String in _paletteAssetNames)
                    {
