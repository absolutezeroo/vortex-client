        ...
        public class RoomObjectCache 
    {
        ...
        public function dispose():void
        {
            ...
            if (_data != null)
            {
                ...
                {
                    _local_1 = (_data.getWithIndex(_local_2) as RoomObjectCacheItem);
        ...
        {
            var _local_2:RoomObjectCacheItem = (_data.getValue(_arg_1) as RoomObjectCacheItem);

            if (_local_2 == null)
            {
                _local_2 = new RoomObjectCacheItem(_roomObjectVariableAccurateZ);
        ...
        {
            var _local_2:RoomObjectCacheItem = (_data.remove(_arg_1) as RoomObjectCacheItem);
        ...
        public function getSortableSpriteList():Vector.<RoomObjectSpriteData>
        {
            ...
            var _local_5:Array = _data.getValues();
        ...
        {
            var _local_3:Array = [];
            var _local_4:Array = _data.getValues();
