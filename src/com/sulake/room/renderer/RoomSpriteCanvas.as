package com.sulake.room.renderer {
    ...
    public class RoomSpriteCanvas implements IRoomRenderingCanvas {
        ...
        private var _mouseActiveObjects:Map = new Map();
        ...
        public function RoomSpriteCanvas(_arg_1:IRoomSpriteCanvasContainer, _arg_2:int, _arg_3:int, _arg_4:int, _arg_5:int) {
            ...
            _flipHorizontalMatrix = new Matrix();
        ...
        public function set useMask(_arg_1:Boolean):void {
            if (((_arg_1) && (!(_useMask)))) {
                ...
                if (((!(_spriteMask == null)) && (!(_displayObject.contains(_spriteMask))))) {
                    _displayObject.addChild(_spriteMask);
                    _display.mask = _spriteMask;
                }
                ;
            }
                ...
                if (((!(_arg_1)) && (_useMask))) {
                    ...
                    if (((!(_spriteMask == null)) && (_displayObject.contains(_spriteMask)))) {
                        _displayObject.removeChild(_spriteMask);
                        _display.mask = null;
                    }
                    ;
                }
        ...
        public function dispose():void {
            ...
            if (_mouseActiveObjects != null) {
                _mouseActiveObjects.dispose();
                _mouseActiveObjects = null;
            }
            ;
            ...
            if (_spritePool != null) {
                ...
                while (_local_1 < _spritePool.length) {
                    cleanSprite((_spritePool[_local_1] as ExtendedSprite), true);
                    _local_1++;
                }
                ;
        ...
        public function initialize(_arg_1:int, _arg_2:int):void {
            ...
            if (_spriteMask != null) {
                _spriteMask.graphics.clear();
            }

            else {
                _spriteMask = new Sprite();
                _spriteMask.name = "mask";
            ...
            _spriteMask.graphics.beginFill(0);
            _spriteMask.graphics.drawRect(0, 0, _arg_1, _arg_2);
            _wd = _arg_1;
            _ht = _arg_2;
        }
        ...
        public function render(_arg_1:int, _arg_2:Boolean = false):void {
            ...
            if (((!(_wd == _renderedWd)) || (!(_ht == _renderedHt)))) {
                _arg_2 = true;
            }
            ;
            ...
            _sortableSpriteList.sortOn("z", 16);
            _sortableSpriteList.reverse();

            if (_local_5 < _sortableSpriteList.length) {
                _sortableSpriteList.splice(_local_5);
            }
            ;
            ...
            while (_local_4 < _local_5) {
                _local_3 = (_sortableSpriteList[_local_4] as SortableSprite);
        ...
        private function calculateUpdateInterval(_arg_1:int):void {
            ...
            if (_renderTimeStamp > 0) {
                _local_3 = (_arg_1 - _renderTimeStamp);

                if (_local_3 > (60 * 3)) {
                    Logger.log((("Really slow frame update " + _local_3) + "ms"));
                    _previousSlowFrameUpdateMs = _local_3;
                }
                ;
                ...
                if (_local_3 <= 1000) {
                    ...
                    if (_updateCounter == (50 + 1)) {
                        _averageUpdateInterval = _local_3;
                        _averageRenderMs = _previousRenderMs;
                    }

                    else {
                        if (_updateCounter > (50 + 1)) {
                            _local_2 = (_updateCounter - 50);
                            _averageUpdateInterval = (((_averageUpdateInterval * (_local_2 - 1)) / _local_2) + (_local_3 / _local_2));
                            _averageRenderMs = (((_averageRenderMs * (_local_2 - 1)) / _local_2) + (_previousRenderMs / _local_2));

                            if (_updateCounter > (50 + 50)) {
                                _updateCounter = 50;

                                if (((!(_runningSlow)) && (_averageUpdateInterval > 60))) {
                                    _runningSlow = true;
                                    Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                                }

                                else {
                                    if (((_runningSlow) && (_averageUpdateInterval < 50))) {
                                        _runningSlow = false;
        ...
        private function renderObject(_arg_1:IRoomObject, _arg_2:String, _arg_3:int, _arg_4:Boolean, _arg_5:int):int {
            ...
            if (((!(_local_7.needsUpdate(_local_8.getInstanceId(), _local_8.getUpdateID()))) && (!(_arg_4)))) {
                var _cachedCount:int = _local_7.spriteCount;
                var _ci:int = 0;
                while (_ci < _cachedCount) {
                    var _cachedSS:SortableSprite = _local_7.getSprite(_ci);
                    if (_cachedSS != null && _sortableSpriteList.indexOf(_cachedSS) == -1) {
                        _sortableSpriteList.push(_cachedSS);
                    }
                    _ci++;
                }
            ...
            _local_16 = int((_local_16 + int((_wd / 2))));
            _local_15 = int((_local_15 + int((_ht / 2))));
                    ...
                    if (_local_11 != null) {
                        ...
                        if (rectangleVisible(_local_21, _local_22, _local_11.width, _local_11.height)) {
                            ...
                            if (_local_18 == null) {
                                ...
                                _sortableSpriteList.push(_local_18);
                                _local_18.name = _arg_2;
                            } else if (_sortableSpriteList.indexOf(_local_18) == -1) {
                                _sortableSpriteList.push(_local_18);
                            }
                            ;
        ...
        private function rectangleVisible(_arg_1:int, _arg_2:int, _arg_3:int, _arg_4:int):Boolean {
            if (_noSpriteVisibilityChecking) {
                return (true);
            }
            ;
            ...
            if ((((_arg_1 < _wd) && ((_arg_1 + _arg_3) >= 0)) && ((_arg_2 < _ht) && ((_arg_2 + _arg_4) >= 0)))) {
        ...
        private function rectangleVisibleWithExclusion(_arg_1:int, _arg_2:int, _arg_3:int, _arg_4:int):Boolean {
            ...
            if ((_arg_1 + _arg_3) >= _wd) {
                _arg_3 = (_arg_3 - ((_wd + 1) - (_arg_1 + _arg_3)));
            }
            ;

            if ((_arg_2 + _arg_4) >= _ht) {
                _arg_4 = (_arg_4 - ((_ht + 1) - (_arg_2 + _arg_4)));
            }
            ;

            for each (var _local_5:Rectangle in _excludedRectangles) {
        ...
        protected function getSprite(_arg_1:int):ExtendedSprite {
            if (((_arg_1 < 0) || (_arg_1 >= _spriteCount))) {
                return (null);
            }
            ;
        ...
        private function createSprite(_arg_1:SortableSprite, _arg_2:int = -1):void {
            ...
            if (_spritePool.length > 0) {
                _local_4 = (_spritePool.pop() as ExtendedSprite);
            }
            ;
            ...
            if (((_arg_2 < 0) || (_arg_2 >= _spriteCount))) {
        ...
        private function getSortableSprite(_arg_1:int):SortableSprite {
            if (((_arg_1 < 0) || (_arg_1 >= _sortableSpriteList.length))) {
                return (null);
            }
            ;

            return (_sortableSpriteList[_arg_1] as SortableSprite);
        }
        ...
        private function getFlippedBitmapData(_arg_1:BitmapData, _arg_2:String, _arg_3:Boolean = false, _arg_4:Boolean = true, _arg_5:Boolean = false):ExtendedBitmapData {
            ...
            if (_local_7 == null) {
                ...
                _flipHorizontalMatrix.identity();

                if (_arg_4) {
                    _flipHorizontalMatrix.scale(-1, 1);
                    _flipHorizontalMatrix.translate(_arg_1.width, 0);
                }
                ;

                if (_arg_5) {
                    _flipHorizontalMatrix.scale(1, -1);
                    _flipHorizontalMatrix.translate(0, _arg_1.height);
                }
                ;

                _local_7.draw(_arg_1, _flipHorizontalMatrix);
        ...
        private function getColoredBitmapData(_arg_1:BitmapData, _arg_2:String, _arg_3:int, _arg_4:Boolean = false):ExtendedBitmapData {
            ...
            if (_local_9 == null) {
                ...
                _colorTransform.redMultiplier = _local_11;
                _colorTransform.greenMultiplier = _local_8;
                _colorTransform.blueMultiplier = _local_12;
                _local_9.colorTransform(_local_9.rect, _colorTransform);
        ...
        public function handleMouseEvent(_arg_1:int, _arg_2:int, _arg_3:String, _arg_4:Boolean, _arg_5:Boolean, _arg_6:Boolean, _arg_7:Boolean):Boolean {
            ...
            if (((_mouseCheckCount > 0) && (_arg_3 == "mouseMove"))) {
                return (_mouseSpriteWasHit);
            }
            ;

            _mouseSpriteWasHit = checkMouseHits((_arg_1 / _scale), (_arg_2 / _scale), _arg_3, _arg_4, _arg_5, _arg_6, _arg_7);
            _mouseCheckCount++;
            return (_mouseSpriteWasHit);
        }
        ...
        protected function createMouseEvent(_arg_1:int, _arg_2:int, _arg_3:int, _arg_4:int, _arg_5:String, _arg_6:String, _arg_7:Boolean, _arg_8:Boolean, _arg_9:Boolean, _arg_10:Boolean):RoomSpriteMouseEvent {
            var _local_13:Number = (_arg_1 - (_wd / 2));
            var _local_14:Number = (_arg_2 - (_ht / 2));
            var _local_11:String = ("canvas_" + _id);
            var _local_12:RoomSpriteMouseEvent;
            _local_12 = new RoomSpriteMouseEvent(_arg_5, ((_local_11 + "_") + _eventId), _local_11, _arg_6, _local_13, _local_14, _arg_3, _arg_4, _arg_8, _arg_7, _arg_9, _arg_10);
            return (_local_12);
        }
        ...
        private function checkMouseHits(_arg_1:int, _arg_2:int, _arg_3:String, _arg_4:Boolean = false, _arg_5:Boolean = false, _arg_6:Boolean = false, _arg_7:Boolean = false):Boolean {
                ...
                if (((!(_local_14 == null)) && (_local_14.hitTestPoint((_arg_1 - _local_14.x), (_arg_2 - _local_14.y))))) {
                    if (!((_local_14.clickHandling) && ((_arg_3 == "click") || (_arg_3 == "doubleClick")))) {
                        ...
                        if (_local_15.indexOf(_local_18) < 0) {
                            ...
                            _local_8 = (_mouseActiveObjects.getValue(_local_18) as ObjectMouseData);
                            ...
                            if (_local_8 == null) {
                                ...
                                _mouseActiveObjects.add(_local_18, _local_8);
                            }
                            ;

                            _local_8.spriteTag = _local_12;

                            if ((((!(_arg_3 == "mouseMove")) || (!(_arg_1 == _mouseOldX))) || (!(_arg_2 == _mouseOldY)))) {
                                bufferMouseEvent(_local_17, _local_18);
                            }
                            ;
            ...
            var _local_9:Array = _mouseActiveObjects.getKeys();
            _local_10 = 0;
            ...
            while (_local_10 < _local_9.length) {
                ...
                if (_local_18 != null) {
                    _local_8 = (_mouseActiveObjects.remove(_local_18) as ObjectMouseData);
                ...
                if (((!(_local_5 == null)) && (!(_local_4 == null)))) {
                    ...
                    if (_local_6 != null) {
                        if (_mouseListener != null) {
                            _mouseListener.processRoomCanvasMouseEvent(_local_4, _local_6, geometry);
                        }
